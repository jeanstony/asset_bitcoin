...
{
    union {
        QJsonPrivate::qle_VCfield<0, 20> line;
        QJsonPrivate::qle_VCfield<20, 12> column;
    };
...
struct RegExp
{
    ...
    union {
        QJsonPrivate::qle_VCfield<0, 4> flags;
        QJsonPrivate::qle_VCfield<4, 28> stringIndex;
    };
...
struct Lookup
{
    ...
    union {
        QJsonPrivate::qle_VCfield<0, 4> type_and_flags;
        QJsonPrivate::qle_VCfield<4, 28> nameIndex;
    };
...
{
    union {
        QJsonPrivate::qle_VCfield<0, 31> nameOffset;
        QJsonPrivate::qle_VCfield<31, 1> isAccessor;
    };
...
struct Q_QML_PRIVATE_EXPORT Binding
{
    ...
    union {
        QJsonPrivate::qle_VCfield<0, 16> flags;
        QJsonPrivate::qle_VCfield<16, 16> type;
    };
...
struct Property
{
    ...
    LEUInt32 nameIndex;
    union {
        QJsonPrivate::qle_VCfield<0, 31> type;
        QJsonPrivate::qle_VCfield<31, 1> flags; // readonly
    };
...
struct Alias {
    ...
    union {
        QJsonPrivate::qle_VCfield<0, 29> nameIndex;
        QJsonPrivate::qle_VCfield<29, 3> flags;
    };
    union {
        LEUInt32 idIndex; // string index
        QJsonPrivate::qle_VCfield<0, 31> targetObjectId; // object id index (in QQmlContextData::idValues)
        QJsonPrivate::qle_VCfield<31, 1> aliasToLocalAlias;
    };
    union {
...
struct Object
{
    ...
    union {
        QJsonPrivate::qle_VCfield<0, 15> flags;
        QJsonPrivate::qle_VCfield<15, 1> defaultPropertyIsAlias;
        QJsonPrivate::qle_signedVCfield<16, 16> id;
    };
