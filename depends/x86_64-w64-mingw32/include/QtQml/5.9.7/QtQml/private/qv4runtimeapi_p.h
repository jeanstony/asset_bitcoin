...
#define FOR_EACH_RUNTIME_METHOD(F) \
    ...
    F(ReturnedValue, VCOr, (const Value &left, const Value &right)) \
    F(ReturnedValue, VCXor, (const Value &left, const Value &right)) \
    F(ReturnedValue, VCAnd, (const Value &left, const Value &right)) \
