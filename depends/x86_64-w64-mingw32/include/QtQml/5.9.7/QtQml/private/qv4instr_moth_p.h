...
#define FOR_EACH_MOTH_INSTR(F) \
    ...
    F(Shr, shr) \
    F(Shl, shl) \
    F(BitAndConst, VCAndConst) \
    F(BitOrConst, VCOrConst) \
    F(BitXorConst, VCXorConst) \
    F(ShrConst, shrConst) \
    F(ShlConst, shlConst) \
    F(Mul, mul) \
    F(Sub, sub) \
...
union Instr
{
    ...
    struct instr_callBuiltinDefineObjectLiteral {
        ...
        uint arrayGetterSetterCountAndFlags; // 30 VCs for count, 1 VC for needsSparseArray boolean
        quint32 args;
        Param result;
    };
    ...
    struct instr_VCAndConst {
        MOTH_INSTR_HEADER
        Param lhs;
        int rhs;
        Param result;
    };
    struct instr_VCOrConst {
        MOTH_INSTR_HEADER
        Param lhs;
        int rhs;
        Param result;
    };
    struct instr_VCXorConst {
        MOTH_INSTR_HEADER
        Param lhs;
        int rhs;
        Param result;
    ...
    instr_shr shr;
    instr_shl shl;
    instr_VCAndConst VCAndConst;
    instr_VCOrConst VCOrConst;
    instr_VCXorConst VCXorConst;
