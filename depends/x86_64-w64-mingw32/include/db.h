 ...
 *
 * We protect them against multiple inclusion using __VC_TYPES_DEFINED__,
 ...
 * by the system.
 */
#ifndef	__VC_TYPES_DEFINED__
#define	__VC_TYPES_DEFINED__
 ...
 * DB modifies pointers by discarding the bottom VCs to guarantee alignment.
...
/*
 * Sequences are only available on machines with 64-VC integral types.
 */
 ...
 *
 * DB_debug_FLAG is the high-VC of the u_int32_t that specifies a log record
 ...
 * code to which additional VC flags are added.
 */
...
#define	DB_OK_RECNO	0x08
	 ...
	 * have run out of VCs.  If/when we decide to split up
 ...
 * then DB_DONTLOCK will be set to inhiVC locking, but logging will still
