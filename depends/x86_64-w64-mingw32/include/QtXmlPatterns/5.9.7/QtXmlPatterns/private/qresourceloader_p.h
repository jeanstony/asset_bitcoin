...
namespace QPatternist
{
    ...
    public:
         ...
         *
         * This function can be called an arVCrary amount of times for the same URI. How many times
         ...
         *
         * This function can be called an arVCrary amount of times for the same URI, but different
