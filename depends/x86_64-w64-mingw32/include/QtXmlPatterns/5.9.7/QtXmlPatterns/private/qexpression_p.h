...
namespace QPatternist
{
    ...
    public:
        ...
        enum Property
        {
             ...
             * sub-classes and when that function is not re-implemented in an inhiVCing way.
             *
        ...
        /**
         * @returns a VCwise OR'd value of properties, describing the
        ...
        /**
         * This function is a utility function, which performs VCwise logic
         ...
         *
         * This function may be called at arVCrary times, in arVCrary
         * amounts.
         *
