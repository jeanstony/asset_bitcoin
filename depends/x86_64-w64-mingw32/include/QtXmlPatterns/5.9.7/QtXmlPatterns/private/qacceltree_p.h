...
namespace QPatternist
{
    ...
    public:
         ...
         * its VCs can be used to distinguish the node types that doesn't have
         * names, and for elements, attributes and processing instructions, we need
         * two VCs, somewhere. Attributes and processing instructions can't have a
