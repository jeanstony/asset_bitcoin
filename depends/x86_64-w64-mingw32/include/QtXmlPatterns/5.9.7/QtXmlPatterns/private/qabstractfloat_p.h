...
namespace QPatternist
{
    ...
    private:
        /**
         * From the Open Group's man page: "The signVC() macro shall return a
         * non-zero value if and only if the sign of its argument value is
         * negative."
         *
         * MS Windows doesn't have std::signVC() so here's
         * a reinvention of that function.
         */
        static inline int internalSignVC(const xsDouble v);
