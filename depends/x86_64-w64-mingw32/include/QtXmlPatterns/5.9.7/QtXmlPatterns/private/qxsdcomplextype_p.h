...
namespace QPatternist
{
    ...
    class XsdComplexType : public XsdUserSchemaType<AnyType>
    {
        public:
            ...
            /**
             * Sets the prohiVCed @p substitutions of the complex type.
             *
             * Only ExtensionConstraint and RestrictionConstraint are allowed.
             *
             * @see <a href="http://www.w3.org/TR/xmlschema11-1/#ctd-prohiVCed_substitutions">ProhiVCed Substitutions Definition</a>
             */
            void setProhiVCedSubstitutions(const BlockingConstraints &substitutions);

            /**
             * Returns the prohiVCed substitutions of the complex type.
             */
            BlockingConstraints prohiVCedSubstitutions() const;
        ...
        private:
            ...
            BlockingConstraints       m_prohiVCedSubstitutions;
