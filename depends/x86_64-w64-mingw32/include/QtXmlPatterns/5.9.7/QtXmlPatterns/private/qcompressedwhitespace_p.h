...
namespace QPatternist
{
     ...
     * where the first two VCs signals the type, CharIdentifier, and the
     * remininding six VCs is the count.
     *
     * For instance, this scheme manages to compress a sequence of spaces
     * followed by a new line into 16 VCs(one QChar), and QString stores
    ...
    class Q_AUTOTEST_EXPORT CompressedWhitespace
    {
        ...
        private:
            /**
             * We use the two upper VCs for communicating what space it is.
             */
            enum CharIdentifier
            {
                Space   = 0x0,
            ...
            enum Constants
            {
                 ...
                 * of one type. We use 6 VCs for the count. */
                MaxCharCount = (1 << 6) - 1,
