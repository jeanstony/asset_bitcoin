...
namespace boost { namespace spirit
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <>
    struct use_operator<karma::domain, proto::tag::VCwise_or>  // enables |
      : mpl::true_ {};

    template <>
    struct flatten_tree<karma::domain, proto::tag::VCwise_or>  // flattens |
      : mpl::true_ {};
...
namespace boost { namespace spirit { namespace karma
{
    ...
    struct make_composite<proto::tag::VCwise_or, Elements, Modifiers>
