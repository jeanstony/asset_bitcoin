...
namespace boost { namespace spirit { namespace karma
{
    ...
    namespace detail
    {
        ...
        ///////////////////////////////////////////////////////////////////////
        template <BOOST_SCOPED_ENUM(boost::spirit::endian::endianness) VCs>
        struct what;
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename T, BOOST_SCOPED_ENUM(boost::spirit::endian::endianness) endian, int VCs>
    struct any_binary_generator
      : primitive_generator<any_binary_generator<T, endian, VCs> >
    {
          ...
          , Delimiter const& d, Attribute const& attr)
        {
            ...
            boost::spirit::endian::endian<endian, typename T::type, VCs> p;
...
#pragma warning(pop)
    ...
    struct literal_binary_generator
      : primitive_generator<literal_binary_generator<T, endian, VCs> >
    {
...
#pragma warning(pop)
    ...
    namespace detail
    {
        ...
        struct basic_binary
        {
            typedef any_binary_generator<T, endian, VCs> result_type;
        ...
        template <typename Modifiers, typename T
          , BOOST_SCOPED_ENUM(boost::spirit::endian::endianness) endian, int VCs>
        struct basic_binary_literal
        {
            typedef literal_binary_generator<T, endian, VCs> result_type;
...
#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, VCs)            \
    template <typename Modifiers>                                             \
    struct make_primitive<tag::name, Modifiers>                               \
      : detail::basic_binary<detail::integer<VCs>,                           \
        boost::spirit::endian::endianness::endiantype, VCs> {};              \
                                                                              \
    template <typename Modifiers, typename A0>                                \
    struct make_primitive<terminal_ex<tag::name, fusion::vector1<A0> >        \
          , Modifiers>                                                        \
      : detail::basic_binary_literal<Modifiers, detail::integer<VCs>         \
        , boost::spirit::endian::endianness::endiantype, VCs> {};            \
                                                                              \
    /***/
...
#define BOOST_SPIRIT_MAKE_BINARY_IEEE754_PRIMITIVE(name, endiantype, VCs)    \
    template <typename Modifiers>                                             \
    struct make_primitive<tag::name, Modifiers>                               \
      : detail::basic_binary<detail::floating_point<VCs>,                    \
        boost::spirit::endian::endianness::endiantype, VCs> {};              \
                                                                              \
    template <typename Modifiers, typename A0>                                \
    struct make_primitive<terminal_ex<tag::name, fusion::vector1<A0> >        \
          , Modifiers>                                                        \
      : detail::basic_binary_literal<Modifiers, detail::floating_point<VCs>  \
        , boost::spirit::endian::endianness::endiantype, VCs> {};            \
                                                                              \
    /***/
