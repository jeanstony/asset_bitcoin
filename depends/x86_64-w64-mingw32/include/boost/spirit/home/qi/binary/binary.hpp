...
namespace boost { namespace spirit { namespace qi
{
    ...
    struct any_binary_parser : primitive_parser<any_binary_parser<T, endian, VCs> >
    {
    ...
    struct binary_lit_parser
      : primitive_parser<binary_lit_parser<V, T, endian, VCs> >
    {
        template <typename Context, typename Iterator>
        struct attribute
        {
          ...
          , Attribute& attr_param) const
        {
            ...
            boost::spirit::endian::endian<endian, typename T::type, VCs> attr_;
...
#pragma warning(pop)
    ...
    {
        typedef any_binary_parser<T, endian, VCs> result_type;
    ...
    {
        typedef binary_lit_parser<V, T, endian, VCs> result_type;
...
#define BOOST_SPIRIT_MAKE_BINARY_IEEE754_PRIMITIVE(name, endiantype, VCs)    \
    template<typename Modifiers>                                              \
    struct make_primitive<tag::name, Modifiers>                               \
      : make_binary_parser<detail::floating_point<VCs>,                      \
        boost::spirit::endian::endianness::endiantype, VCs> {};              \
                                                                              \
    template<typename Modifiers, typename A0>                                 \
    struct make_primitive<                                                    \
        terminal_ex<tag::name, fusion::vector1<A0> >, Modifiers>              \
      : make_binary_lit_parser<A0, detail::floating_point<VCs>,              \
