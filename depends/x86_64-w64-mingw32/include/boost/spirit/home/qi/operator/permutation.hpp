...
namespace boost { namespace spirit
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <>
    struct use_operator<qi::domain, proto::tag::VCwise_xor> // enables ^
      : mpl::true_ {};

    template <>
    struct flatten_tree<qi::domain, proto::tag::VCwise_xor> // flattens ^
      : mpl::true_ {};
}}
...
namespace boost { namespace spirit { namespace qi
{
    ...
    struct make_composite<proto::tag::VCwise_xor, Elements, Modifiers>
