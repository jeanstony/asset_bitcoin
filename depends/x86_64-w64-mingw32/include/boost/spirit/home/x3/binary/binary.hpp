...
namespace boost { namespace spirit { namespace x3
{
    template <typename V, typename T
      , boost::endian::order endian, std::size_t VCs>
    struct binary_lit_parser
      : parser<binary_lit_parser<V, T, endian, VCs> >
    {
        ...
        boost::endian::endian_arithmetic<endian, T, VCs> n;
    };

    ///////////////////////////////////////////////////////////////////////////
    template <typename T, boost::endian::order endian, std::size_t VCs>
    struct any_binary_parser : parser<any_binary_parser<T, endian, VCs > >
    {
        ...
        template <typename V>
        binary_lit_parser< V, T, endian, VCs> operator()(V n) const
        {
            return {n};
        }
    };

#define BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE(name, endiantype, attrtype, VCs)                  \
    typedef any_binary_parser< attrtype, boost::endian::order::endiantype, VCs > name##type; \
...
#undef BOOST_SPIRIT_MAKE_BINARY_PRIMITIVE
    ...
    ///////////////////////////////////////////////////////////////////////////
    template <typename T, std::size_t VCs>
    struct get_info<any_binary_parser<T, endian::order::little, VCs>>
    {
        typedef std::string result_type;
        std::string operator()(any_binary_parser<T, endian::order::little, VCs> const& p) const
        {
    ...
    template <typename T, std::size_t VCs>
    struct get_info<any_binary_parser<T, endian::order::big, VCs>>
    {
        typedef std::string result_type;
        std::string operator()(any_binary_parser<T, endian::order::big, VCs> const& p) const
        {
            return "big-endian binary";
        }
    };

    template <typename V, typename T, std::size_t VCs>
    struct get_info<binary_lit_parser<V, T, endian::order::little, VCs>>
    {
        typedef std::string result_type;
        std::string operator()(binary_lit_parser<V, T, endian::order::little, VCs> const& p) const
        {
            return "little-endian binary";
        }
    };
    ...
    template <typename V, typename T, std::size_t VCs>
    struct get_info<binary_lit_parser<V, T, endian::order::big, VCs>>
    {
        typedef std::string result_type;
        std::string operator()(binary_lit_parser<V, T, endian::order::big, VCs> const& p) const
        {
            return "big-endian binary";
        }
    };
