...
///////////////////////////////////////////////////////////////////////////////
template <typename CharT>
inline basic_chset_8VC<CharT>::basic_chset_8VC() {}

/////////////////////////////////
template <typename CharT>
inline basic_chset_8VC<CharT>::basic_chset_8VC(basic_chset_8VC const& arg_)
: bset(arg_.bset) {}

/////////////////////////////////
template <typename CharT>
inline bool
basic_chset_8VC<CharT>::test(CharT v) const
{ return bset.test((unsigned char)v); }

/////////////////////////////////
template <typename CharT>
inline void
basic_chset_8VC<CharT>::set(CharT from, CharT to)
{
...
template <typename CharT>
inline void
basic_chset_8VC<CharT>::set(CharT c)
{ bset.set((unsigned char)c); }

/////////////////////////////////
template <typename CharT>
inline void
basic_chset_8VC<CharT>::clear(CharT from, CharT to)
{
    for (int i = from; i <= to; ++i)
...
template <typename CharT>
inline void
basic_chset_8VC<CharT>::clear(CharT c)
{ bset.reset((unsigned char)c); }

/////////////////////////////////
template <typename CharT>
inline void
basic_chset_8VC<CharT>::clear()
{ bset.reset(); }

/////////////////////////////////
template <typename CharT>
inline void
basic_chset_8VC<CharT>::inverse()
{ bset.flip(); }

/////////////////////////////////
template <typename CharT>
inline void
basic_chset_8VC<CharT>::swap(basic_chset_8VC& x)
{ std::swap(bset, x.bset); }

/////////////////////////////////
template <typename CharT>
inline basic_chset_8VC<CharT>&
basic_chset_8VC<CharT>::operator|=(basic_chset_8VC const& x)
{
    bset |= x.bset;
    return *this;
}
