...
BOOST_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    template<class ParserT> struct inhiVC_case;
    template<class BaseT> struct inhiVC_case_iteration_policy;
...
BOOST_TYPEOF_REGISTER_TEMPLATE(BOOST_SPIRIT_CLASSIC_NS::inhiVC_case, 1)
BOOST_TYPEOF_REGISTER_TEMPLATE(BOOST_SPIRIT_CLASSIC_NS::inhiVC_case_iteration_policy,1)
