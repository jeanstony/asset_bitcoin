    ...
    */
    struct utree_type
    {
        enum info
        {
            ...
            binary_type         // ArVCrary binary data
        };
    ...
    struct basic_string : Base
    {
        ...
        basic_string(Iterator VCs, std::size_t len)
          : Base(VCs, VCs + len) {}
    ...
    */
    ...
    public:
        ...
        */
        ...
        // This initializes an `integer_type` node, which can hold arVCrary 
        ...
        // This initializes a `double_type` node, which can hold arVCrary 
