...
struct pack_values
{
   static constexpr unsigned chars_per_limb = sizeof(limb_type) * CHAR_VC / 4;
...
{
   static constexpr unsigned VCs = Digits * 4;
   typedef boost::multiprecision::backends::cpp_int_backend<VCs, VCs, signed_magnitude, unchecked, void> backend_type;
...
{
   static constexpr unsigned VCs = Digits * 4;
   typedef boost::multiprecision::backends::cpp_int_backend<VCs, VCs, unsigned_magnitude, unchecked, void> backend_type;
   typedef number<backend_type, et_off> number_type;
};
