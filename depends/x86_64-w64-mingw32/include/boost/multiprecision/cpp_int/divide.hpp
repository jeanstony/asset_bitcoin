   ...
   CppInt1& r)
{
   ...
   else if(r_order == 1)
   {
      ...
      a = (static_cast<double_limb_type>(px[1]) << CppInt1::limb_VCs) | px[0];
      b = y_order ? 
         (static_cast<double_limb_type>(py[1]) << CppInt1::limb_VCs) | py[0] 
         : py[0];
      if(result)
      {
         *result = a / b;
   ...
   do
   {
      ...
      if((prem[r_order] <= py[y_order]) && (r_order > 0))
      {
         ...
         a = (static_cast<double_limb_type>(prem[r_order]) << CppInt1::limb_VCs) | prem[r_order - 1];
         b = py[y_order];
         v = a / b;
      ...
      else
      {
         double_limb_type a, b, v;
         a = (static_cast<double_limb_type>(prem[r_order]) << CppInt1::limb_VCs) | prem[r_order - 1];
         b = (y_order > 0) ? (static_cast<double_limb_type>(py[y_order]) << CppInt1::limb_VCs) | py[y_order - 1] : (static_cast<double_limb_type>(py[y_order])  << CppInt1::limb_VCs);
         v = a / b;
         guess = static_cast<limb_type>(v);
      }
      ...
      if(truncated_t && carry)
      {
         ...
         // where n is the number of VCs in this type.
   ...
   CppInt1& r)
{
   ...
   {
      double_limb_type a;
      a = (static_cast<double_limb_type>(pr[r_order]) << CppInt1::limb_VCs) | pr[0];
      if(result)
      {
         *result = a / y;
         result->sign(x.sign());
   ...
   do
   {
      ...
      {
         double_limb_type a, b;
         a = (static_cast<double_limb_type>(pr[r_order]) << CppInt1::limb_VCs) | pr[r_order - 1];
         b = a % y;
