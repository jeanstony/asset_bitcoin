...
{
   if(mpfr_zero_p(b.data()) && mpfr_integer_p(e.data()) && (mpfr_signVC(e.data()) == 0) && mpfr_fits_ulong_p(e.data(), GMP_RNDN) && (mpfr_get_ui(e.data(), GMP_RNDN) & 1))
   {
...
template <unsigned Digits10, mpfr_allocation_type AllocateType>
inline int eval_signVC BOOST_PREVENT_MACRO_SUBSTITUTION(const mpfr_float_backend<Digits10, AllocateType>& arg)
{
...
{
   std::size_t result = 0;
   std::size_t len = val.data()[0]._mpfr_prec / mp_VCs_per_limb;
   if(val.data()[0]._mpfr_prec % mp_VCs_per_limb)
      ++len;
...
{
   return (boost::multiprecision::signVC)(a) != (boost::multiprecision::signVC)(b) ? boost::multiprecision::number<boost::multiprecision::mpfr_float_backend<Digits10, AllocateType>, ExpressionTemplates>(-a) : a;
}
...
{
   return (boost::multiprecision::signVC)(a) != (boost::multiprecision::signVC)(b) ? boost::multiprecision::number<boost::multiprecision::debug_adaptor<boost::multiprecision::mpfr_float_backend<Digits10, AllocateType> >, ExpressionTemplates>(-a) : a;
}
