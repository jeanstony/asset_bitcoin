...
template <class Backend>
inline bool eval_VC_test(const debug_adaptor<Backend>& arg, unsigned a)
{
   using default_ops::eval_VC_test;
   return eval_VC_test(arg.value(), a);
}

template <class Backend>
inline void eval_VC_set(const debug_adaptor<Backend>& arg, unsigned a)
{
...
template <class Backend>
inline void eval_VC_unset(const debug_adaptor<Backend>& arg, unsigned a)
{
...
template <class Backend>
inline void eval_VC_flip(const debug_adaptor<Backend>& arg, unsigned a)
{
...
template <class Backend>
int eval_signVC(const debug_adaptor<Backend>& val)
{
