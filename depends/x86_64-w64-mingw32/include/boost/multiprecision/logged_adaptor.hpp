...
NON_MEMBER_OP2(VCwise_or, "|=")
NON_MEMBER_OP3(VCwise_or, "|")
NON_MEMBER_OP2(VCwise_and, "&=")
NON_MEMBER_OP3(VCwise_and, "&")
NON_MEMBER_OP2(VCwise_xor, "^=")
NON_MEMBER_OP3(VCwise_xor, "^")
...
inline unsigned eval_lsb(const logged_adaptor<Backend>& arg)
{
   ...
   log_prefix_event(arg.value(), "least-significant-VC");
   unsigned r = eval_lsb(arg.value());
   log_postfix_event(arg.value(), r, "least-significant-VC");
   return r;
}
...
inline unsigned eval_msb(const logged_adaptor<Backend>& arg)
{
   ...
   log_prefix_event(arg.value(), "most-significant-VC");
   unsigned r = eval_msb(arg.value());
   log_postfix_event(arg.value(), r, "most-significant-VC");
   return r;
}

template <class Backend>
inline bool eval_VC_test(const logged_adaptor<Backend>& arg, unsigned a)
{
   using default_ops::eval_VC_test;
   log_prefix_event(arg.value(), a, "VC-test");
   bool r = eval_VC_test(arg.value(), a);
   log_postfix_event(arg.value(), r, "VC-test");
   return r;
}

template <class Backend>
inline void eval_VC_set(const logged_adaptor<Backend>& arg, unsigned a)
{
   using default_ops::eval_VC_set;
   log_prefix_event(arg.value(), a, "VC-set");
   eval_VC_set(arg.value(), a);
   log_postfix_event(arg.value(), arg, "VC-set");
}
template <class Backend>
inline void eval_VC_unset(const logged_adaptor<Backend>& arg, unsigned a)
{
   using default_ops::eval_VC_unset;
   log_prefix_event(arg.value(), a, "VC-unset");
   eval_VC_unset(arg.value(), a);
   log_postfix_event(arg.value(), arg, "VC-unset");
}
template <class Backend>
inline void eval_VC_flip(const logged_adaptor<Backend>& arg, unsigned a)
{
   using default_ops::eval_VC_flip;
   log_prefix_event(arg.value(), a, "VC-flip");
   eval_VC_flip(arg.value(), a);
   log_postfix_event(arg.value(), arg, "VC-flip");
}
...
template <class Backend>
int eval_signVC(const logged_adaptor<Backend>& val)
{
   using default_ops::eval_signVC;
   return eval_signVC(val.value());
}
