...
{
   std::size_t result = 0;
   std::size_t len = val.left_data()[0]._mpfr_prec / mp_VCs_per_limb;
   if(val.left_data()[0]._mpfr_prec % mp_VCs_per_limb)
      ++len;
   ...
   len = val.right_data()[0]._mpfr_prec / mp_VCs_per_limb;
   if(val.right_data()[0]._mpfr_prec % mp_VCs_per_limb)
      ++len;
   for(std::size_t i = 0; i < len; ++i)
