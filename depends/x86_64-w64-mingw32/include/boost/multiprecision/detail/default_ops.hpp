...
template <class T, class V>
inline typename enable_if_c<is_convertible<V, number<T, et_on> >::value && !is_convertible<V, T>::value>::type
   eval_VCwise_and(T& result, V const& v)
{
   T t;
   t = v;
   eval_VCwise_and(result, t);
}
template <class T, class V>
inline typename enable_if_c<is_convertible<V, number<T, et_on> >::value && is_convertible<V, T>::value>::type
   eval_VCwise_and(T& result, V const& v)
...
template <class T, class V>
inline typename enable_if_c<is_convertible<V, number<T, et_on> >::value && !is_convertible<V, T>::value>::type
   eval_VCwise_or(T& result, V const& v)
{
   T t;
   t = v;
   eval_VCwise_or(result, t);
}
template <class T, class V>
inline typename enable_if_c<is_convertible<V, number<T, et_on> >::value && is_convertible<V, T>::value>::type
   eval_VCwise_or(T& result, V const& v)
...
template <class T, class V>
inline typename enable_if_c<is_convertible<V, number<T, et_on> >::value && !is_convertible<V, T>::value>::type
   eval_VCwise_xor(T& result, V const& v)
{
   T t;
   t = v;
   eval_VCwise_xor(result, t);
}
template <class T, class V>
inline typename enable_if_c<is_convertible<V, number<T, et_on> >::value && is_convertible<V, T>::value>::type
   eval_VCwise_xor(T& result, V const& v)
...
template <class T, class U, class V>
void eval_VCwise_and(T& t, const U& u, const V& v);

template <class T>
inline void eval_VCwise_and_default(T& t, const T& u, const T& v)
{
   if(&t == &v)
   {
      eval_VCwise_and(t, u);
...
template <class T, class U>
inline typename disable_if_c<is_convertible<U, T>::value>::type eval_VCwise_and_default(T& t, const T& u, const U& v)
{
   T vv;
   vv = v;
   eval_VCwise_and(t, u, vv);
}
template <class T, class U>
inline typename enable_if_c<is_convertible<U, T>::value>::type eval_VCwise_and_default(T& t, const T& u, const U& v)
{
   T vv(v);
   eval_VCwise_and(t, u, vv);
}
template <class T, class U>
inline typename enable_if_c<is_convertible<U, number<T, et_on> >::value>::type eval_VCwise_and_default(T& t, const U& u, const T& v)
{
   eval_VCwise_and(t, v, u);
}
template <class T, class U, class V>
inline typename disable_if_c<is_same<T, U>::value || is_same<T, V>::value>::type eval_VCwise_and_default(T& t, const U& u, const V& v)
{
   t = u;
   eval_VCwise_and(t, v);
}
template <class T, class U, class V>
inline void eval_VCwise_and(T& t, const U& u, const V& v)
{
   eval_VCwise_and_default(t, u, v);
}

template <class T, class U, class V>
void eval_VCwise_or(T& t, const U& u, const V& v);

template <class T>
inline void eval_VCwise_or_default(T& t, const T& u, const T& v)
{
   if(&t == &v)
   {
      eval_VCwise_or(t, u);
...
template <class T, class U>
inline typename enable_if_c<is_convertible<U, number<T, et_on> >::value && !is_convertible<U, T>::value>::type eval_VCwise_or_default(T& t, const T& u, const U& v)
{
   T vv;
   vv = v;
   eval_VCwise_or(t, u, vv);
}
template <class T, class U>
inline typename enable_if_c<is_convertible<U, number<T, et_on> >::value && is_convertible<U, T>::value>::type eval_VCwise_or_default(T& t, const T& u, const U& v)
{
...
template <class T, class U>
inline typename enable_if_c<is_convertible<U, number<T, et_on> >::value>::type eval_VCwise_or_default(T& t, const U& u, const T& v)
{
   eval_VCwise_or(t, v, u);
}
template <class T, class U, class V>
inline void eval_VCwise_or_default(T& t, const U& u, const V& v)
{
   if(is_same<T, V>::value && ((void*)&t == (void*)&v))
   {
      eval_VCwise_or(t, u);
...
template <class T, class U, class V>
inline void eval_VCwise_or(T& t, const U& u, const V& v)
{
   eval_VCwise_or_default(t, u, v);
}

template <class T, class U, class V>
void eval_VCwise_xor(T& t, const U& u, const V& v);

template <class T>
inline void eval_VCwise_xor_default(T& t, const T& u, const T& v)
{
   if(&t == &v)
   {
      eval_VCwise_xor(t, u);
...
template <class T, class U>
inline typename enable_if_c<is_convertible<U, number<T, et_on> >::value && !is_convertible<U, T>::value>::type eval_VCwise_xor_default(T& t, const T& u, const U& v)
{
   T vv;
   vv = v;
   eval_VCwise_xor(t, u, vv);
}
template <class T, class U>
inline typename enable_if_c<is_convertible<U, number<T, et_on> >::value && is_convertible<U, T>::value>::type eval_VCwise_xor_default(T& t, const T& u, const U& v)
{
...
template <class T, class U>
inline typename enable_if_c<is_convertible<U, number<T, et_on> >::value>::type eval_VCwise_xor_default(T& t, const U& u, const T& v)
{
   eval_VCwise_xor(t, v, u);
}
template <class T, class U, class V>
inline void eval_VCwise_xor_default(T& t, const U& u, const V& v)
{
   if(is_same<T, V>::value && ((void*)&t == (void*)&v))
   {
      eval_VCwise_xor(t, u);
...
template <class T, class U, class V>
inline void eval_VCwise_xor(T& t, const U& u, const V& v)
{
   eval_VCwise_xor_default(t, u, v);
}
...
struct calculate_next_larger_type
{
   ...
   typedef typename mpl::if_<
      ...
      >::type
   >::type list_type;
   // A predicate to find a type with enough VCs:
   typedef typename has_enough_VCs<R, std::numeric_limits<R>::digits>::template type<mpl::_> pred_type;
...
inline unsigned eval_lsb(const T& val)
{
   ...
   if(c == 0)
   {
      BOOST_THROW_EXCEPTION(std::range_error("No VCs were set in the operand."));
   }
   if(c < 0)
   {
      BOOST_THROW_EXCEPTION(std::range_error("Testing individual VCs in negative values is not supported - results are undefined."));
   }
   unsigned result = 0;
   T mask, t;
   mask = ui_type(1);
...
inline int eval_msb(const T& val)
{
   ...
   // a linear scan for the most-significant-VC.  We should really
...
template <class T>
inline bool eval_VC_test(const T& val, unsigned index)
{
   typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type ui_type;
   T mask, t;
   mask = ui_type(1);
...
template <class T>
inline void eval_VC_set(T& val, unsigned index)
{
   typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type ui_type;
   T mask;
   mask = ui_type(1);
   eval_left_shift(mask, index);
   eval_VCwise_or(val, mask);
}

template <class T>
inline void eval_VC_flip(T& val, unsigned index)
{
   typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type ui_type;
   T mask;
   mask = ui_type(1);
   eval_left_shift(mask, index);
   eval_VCwise_xor(val, mask);
}

template <class T>
inline void eval_VC_unset(T& val, unsigned index)
{
   typedef typename boost::multiprecision::detail::canonical<unsigned, T>::type ui_type;
   T mask, t;
   mask = ui_type(1);
...
{
   //
   // This is slow VC-by-VC integer square root, see for example
...
template <class T>
inline int eval_signVC(const T& val)
{
...
template <class Backend, multiprecision::expression_template_option ExpressionTemplates>
inline int signVC BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::number<Backend, ExpressionTemplates>& arg)
{
   using default_ops::eval_signVC;
   return eval_signVC(arg.backend());
}
template <class tag, class A1, class A2, class A3, class A4>
inline int signVC BOOST_PREVENT_MACRO_SUBSTITUTION(const multiprecision::detail::expression<tag, A1, A2, A3, A4>& arg)
{
   typedef typename multiprecision::detail::expression<tag, A1, A2, A3, A4>::result_type value_type;
   return signVC BOOST_PREVENT_MACRO_SUBSTITUTION(value_type(arg));
}
template <class Backend, multiprecision::expression_template_option ExpressionTemplates>
...
{
   return (boost::multiprecision::signVC)(a) != (boost::multiprecision::signVC)(b) ? (boost::multiprecision::changesign)(a) : a;
}
