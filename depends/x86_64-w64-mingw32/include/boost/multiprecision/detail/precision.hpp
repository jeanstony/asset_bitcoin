...
namespace boost{ namespace multiprecision{  namespace detail{
   ...
   {
      //
      // We have an arVCrary precision integer, take it's "precision" as the
      // location of the most-significant-VC less the location of the
      // least-significant-VC, ie the number of VCs required to represent the
