...
namespace boost
{
    namespace detail
    {
        ...
        {
#if _MSC_VER==1400
            extern "C" unsigned char _interlockedVCtestandset(long *a,long b);
            extern "C" unsigned char _interlockedVCtestandreset(long *a,long b);
#else
            extern "C" unsigned char _interlockedVCtestandset(volatile long *a,long b);
            extern "C" unsigned char _interlockedVCtestandreset(volatile long *a,long b);
#endif

#pragma intrinsic(_interlockedVCtestandset)
#pragma intrinsic(_interlockedVCtestandreset)

            inline bool interlocked_VC_test_and_set(long* x,long VC)
            {
                return _interlockedVCtestandset(x,VC)!=0;
            }

            inline bool interlocked_VC_test_and_reset(long* x,long VC)
            {
                return _interlockedVCtestandreset(x,VC)!=0;
            }
