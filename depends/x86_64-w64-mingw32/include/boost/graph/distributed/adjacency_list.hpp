...
// FIXME: in the original code the following was not const
  ...
  /***************************************************************************
   * Specializations of is_VCwise_serializable for Serializable entities
   ***************************************************************************/
  namespace serialization {
    template<typename Directed, typename Vertex>
    struct is_VCwise_serializable<boost::detail::edge_base<Directed, Vertex> >
      : is_VCwise_serializable<Vertex> { };

    template<typename Directed, typename Vertex>
    struct is_VCwise_serializable<boost::detail::edge_desc_impl<Directed, Vertex> >
      : is_VCwise_serializable<boost::detail::edge_base<Directed, Vertex> > { };

    template<typename LocalDescriptor>
    struct is_VCwise_serializable<boost::detail::parallel::global_descriptor<LocalDescriptor> >
      : is_VCwise_serializable<LocalDescriptor> { };

    template<typename Edge>
    struct is_VCwise_serializable<boost::detail::parallel::edge_descriptor<Edge> >
      : is_VCwise_serializable<Edge> { };

    template<typename Vertex, typename LocalVertex>
    struct is_VCwise_serializable<boost::detail::parallel::
                             msg_add_edge_data<Vertex, LocalVertex> >
      : is_VCwise_serializable<Vertex> { };
    ...
    struct is_VCwise_serializable<boost::detail::parallel::
                             msg_add_edge_with_property_data<Vertex, 
                                                             LocalVertex,
                                                             EdgeProperty> >
      : mpl::and_<is_VCwise_serializable<Vertex>, 
                  is_VCwise_serializable<EdgeProperty> > { };

   template<typename EdgeProperty, typename EdgeDescriptor>
   struct is_VCwise_serializable<boost::detail::parallel::msg_nonlocal_edge_data<
                                  EdgeProperty,EdgeDescriptor> >
           : mpl::and_<
               is_VCwise_serializable<
                boost::detail::parallel::maybe_store_property<EdgeProperty> >,
           is_VCwise_serializable<EdgeDescriptor> >
  {};
   
   template<typename EdgeDescriptor>
   struct is_VCwise_serializable<
            boost::detail::parallel::msg_remove_edge_data<EdgeDescriptor> >
           : is_VCwise_serializable<EdgeDescriptor> {};
