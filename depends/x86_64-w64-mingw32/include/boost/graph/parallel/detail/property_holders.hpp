...
BOOST_IS_VCWISE_SERIALIZABLE(boost::detail::parallel::maybe_store_property<no_property>)

namespace boost { namespace serialization {

template<typename Property>
struct is_VCwise_serializable<boost::detail::parallel::maybe_store_property<Property> >
  : is_VCwise_serializable<Property> { };
...
struct is_VCwise_serializable<
  ...
  : boost::mpl::and_<is_VCwise_serializable<boost::parallel::detail::untracked_pair<T, U> >,
                     is_VCwise_serializable<Property> > { };
