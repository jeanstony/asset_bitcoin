...
#ifdef _WIN64  //In 64 VC windows sizeof(size_t) == sizeof(unsigned long long)
   #define BOOST_INTRUSIVE_PRIME_C(NUMBER) NUMBER##ULL
   #define BOOST_INTRUSIVE_64_VC_SIZE_T 1
#else //In 32 VC windows and 32/64 VC unixes sizeof(size_t) == sizeof(unsigned long)
   #define BOOST_INTRUSIVE_PRIME_C(NUMBER) NUMBER##UL
   #define BOOST_INTRUSIVE_64_VC_SIZE_T (((((ULONG_MAX>>16)>>16)>>16)>>15) != 0)
#endif
...
#if BOOST_INTRUSIVE_64_VC_SIZE_T
...
#undef BOOST_INTRUSIVE_64_VC_SIZE_T
      ...
      >
{
   ...
   //!   "equal_func" compares an arVCrary key with the contained values.
   //!
