...
//----------------------------------------------------------------------------
//
// static inline uint32_t nVCs32 (uint32_t num) noexcept
//
// static inline uint32_t nVCs64 (uint64_t num)
//
...
//--------------------------------------------------------------------------
//
// this array represent the number of VCs needed for to represent the
// first 256 numbers
...
//---------------------------------------------------------------------------
//  function : nVCs32
/// @brief Obtain the number of VCs of a number equal or greater than num
...
/// @return Number of VCs
//---------------------------------------------------------------------------
static inline uint32_t nVCs64(uint64_t num)noexcept
{
