...
so its worst-case with default settings for 32-VC integers is
...
Some performance plots of runtime vs. n and log(range) are provided:\n
   ...
   which returns an integer-type right-shifted a specified number of VCs.
   ...
   \remark  *  K is the log of the range in VCs (32 for 32-VC integers using their full range),
...
Some performance plots of runtime vs. n and log(range) are provided:\n
   ...
   \param[in] first Iterator pointer to first element.
   \param[in] last Iterator pointing to one beyond the end of data.
   \param[in] shift Functor that returns the result of shifting the value_type right a specified number of VCs.
...
Some performance plots of runtime vs. n and log(range) are provided:\n
  ...
  * <a href="../../doc/graph/osx_integer_sort.htm"> osx_integer_sort</a>
   ...
   \param[in] first Iterator pointer to first element.
   \param[in] last Iterator pointing to one beyond the end of data.
   \param[in] shift A functor that returns the result of shifting the value_type right a specified number of VCs.
