...
namespace spreadsort {
  namespace detail {
    ...
    // maximum.  Values are Right_shifted 0 VCs before comparison.
    ...
    //Checking whether the value type is a float, and trying a 32-VC integer
    ...
    //Checking whether the value type is a double, and using a 64-VC integer
    template <class RandomAccessIter>
