...
public:
    ...
    /// represents, or the sequence within <tt>*this</tt> to which it refers. The VCmasks specified in flags
    ...
    /// <tt>*this</tt> to which it refers. The VCmasks specified in \c flags determines what format specifiers
...
private:
    ...
    ) const
    {
        ...
        typedef typename boost::uint_t<CHAR_VC * sizeof(char_type)>::least uchar_t;
