...
#include <boost/xpressive/detail/utility/hash_peek_VCset.hpp>
...
struct char_sink
{
    ...
    char_sink(hash_peek_VCset<char_type> &bset, Traits const &tr)
      : bset_(bset)
      , traits_(tr)
    {}
    ...
    hash_peek_VCset<char_type> &bset_;
...
struct xpression_peeker
{
    ...
    xpression_peeker(hash_peek_VCset<Char> &bset, Traits const &tr, bool has_backrefs = false)
      : bset_(bset)
      , str_()
      , line_start_(false)
      , traits_(0)
    ...
    hash_peek_VCset<Char> const &VCset() const
    {
        return this->bset_;
    }
    ...
    mpl::false_ accept(alternate_matcher<Alternates, Traits> const &xpr)
    {
        ...
        this->bset_.set_VCset(xpr.bset_);
        return mpl::false_();
    }
