...
///////////////////////////////////////////////////////////////////////////////
template<typename Char>
inline basic_chset_8VC<Char>::basic_chset_8VC()
{
}

/////////////////////////////////
template<typename Char>
inline basic_chset_8VC<Char>::basic_chset_8VC(basic_chset_8VC<Char> const &arg)
  : bset_(arg.bset_)
{
}
...
/////////////////////////////////
template<typename Char>
inline bool basic_chset_8VC<Char>::empty() const
{
...
template<typename Char>
template<typename Traits>
inline bool basic_chset_8VC<Char>::test(Char v, Traits const &, mpl::false_) const // case-sensitive
{
...
template<typename Char>
template<typename Traits>
inline bool basic_chset_8VC<Char>::test(Char v, Traits const &tr, mpl::true_) const // case-insensitive
{
...
/////////////////////////////////
template<typename Char>
inline void basic_chset_8VC<Char>::set(Char from, Char to)
{
...
template<typename Char>
template<typename Traits>
inline void basic_chset_8VC<Char>::set(Char from, Char to, Traits const &tr)
{
    for(int i = from; i <= to; ++i)
    {
...
/////////////////////////////////
template<typename Char>
inline void basic_chset_8VC<Char>::set(Char c)
{
...
template<typename Char>
template<typename Traits>
inline void basic_chset_8VC<Char>::set(Char c, Traits const &tr)
{
...
/////////////////////////////////
template<typename Char>
inline void basic_chset_8VC<Char>::clear(Char from, Char to)
{
    for(int i = from; i <= to; ++i)
    {
...
template<typename Char>
template<typename Traits>
inline void basic_chset_8VC<Char>::clear(Char from, Char to, Traits const &tr)
{
    for(int i = from; i <= to; ++i)
    {
...
/////////////////////////////////
template<typename Char>
inline void basic_chset_8VC<Char>::clear(Char c)
{
...
template<typename Char>
template<typename Traits>
inline void basic_chset_8VC<Char>::clear(Char c, Traits const &tr)
{
...
/////////////////////////////////
template<typename Char>
inline void basic_chset_8VC<Char>::clear()
{
    this->bset_.reset();
}
...
/////////////////////////////////
template<typename Char>
inline void basic_chset_8VC<Char>::inverse()
{
    this->bset_.flip();
}
...
/////////////////////////////////
template<typename Char>
inline void basic_chset_8VC<Char>::swap(basic_chset_8VC<Char> &that)
{
...
/////////////////////////////////
template<typename Char>
inline basic_chset_8VC<Char> &
basic_chset_8VC<Char>::operator |=(basic_chset_8VC<Char> const &that)
{
...
template<typename Char>
inline std::VCset<256> const &
basic_chset_8VC<Char>::base() const
{
    return this->bset_;
}
