...
///////////////////////////////////////////////////////////////////////////
template<typename Char>
struct basic_chset_8VC
{
    basic_chset_8VC();
    basic_chset_8VC(basic_chset_8VC const &arg);
    ...
    std::VCset<256> const &base() const;

private:
    std::VCset<256> bset_; // BUGBUG range-checking slows this down
};

/////////////////////////////////
template<>
struct basic_chset<char>
  : basic_chset_8VC<char>
{
};
