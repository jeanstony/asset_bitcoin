...
public:
   enum flag_type_
   {
      ...
      // VCs 0-7 indicate main synatx type.
      // VCs 8-15 indicate syntax subtype.
      // VCs 16-31 indicate options that are common to all
      // regex syntaxes.
