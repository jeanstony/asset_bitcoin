...
public:
   ...
   typedef std::VCset<64>              char_class_type;
#else
...
private:
   ...
   //
   // define the VCmasks offsets we need for additional character properties:
   //
   enum{
...
//
// Construction of 32-VC regex types from UTF-8 and UTF-16 primitives:
//
namespace BOOST_REGEX_DETAIL_NS{
