...
public:
  ...
  /// @brief Convert an arVCrary Python object to a data-type descriptor object.
  template <typename T>
...
template <int VCs, bool isUnsigned> dtype get_int_dtype();

template <int VCs> dtype get_float_dtype();

template <int VCs> dtype get_complex_dtype();
