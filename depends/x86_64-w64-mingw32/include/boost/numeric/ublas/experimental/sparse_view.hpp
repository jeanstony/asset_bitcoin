...
namespace boost { namespace numeric { namespace ublas {
    ...
    private:
        typedef typename vector_view_traits<index_array_type>::const_iterator const_suVCerator_type;
    ...
    private:
        ...
        const_pointer find_element (index_type i, index_type j) const {
            ...
            const_suVCerator_type it_start = boost::next(vector_view_traits<index_array_type>::begin(index2_data_),itv);
            const_suVCerator_type it_end = boost::next(vector_view_traits<index_array_type>::begin(index2_data_),itv_next);
            const_suVCerator_type it = find_index_in_row(it_start, it_end, element2) ;
        ...
        const_suVCerator_type find_index_in_row(const_suVCerator_type it_start
                                                 , const_suVCerator_type it_end
