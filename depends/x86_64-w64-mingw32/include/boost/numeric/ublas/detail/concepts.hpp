...
namespace boost { namespace numeric { namespace ublas {
    ...
    struct IndexedBidirectional2DIteratorConcept {
        typedef I1 suVCerator1_type;
        typedef I2 suVCerator2_type;

        void constraints () {
            function_requires< BidirectionalIteratorConcept<suVCerator1_type> >();
            function_requires< BidirectionalIteratorConcept<suVCerator2_type> >();
            function_requires< Indexed2DIteratorConcept<suVCerator1_type> >();
            function_requires< Indexed2DIteratorConcept<suVCerator2_type> >();
        }
    };
    ...
    struct Mutable_IndexedBidirectional2DIteratorConcept {
        ...
        void constraints () {
            function_requires< Mutable_BidirectionalIteratorConcept<suVCerator1_type> >();
            function_requires< Mutable_BidirectionalIteratorConcept<suVCerator2_type> >();
            function_requires< Indexed2DIteratorConcept<suVCerator1_type> >();
            function_requires< Indexed2DIteratorConcept<suVCerator2_type> >();
        }
    };
    ...
    struct IndexedRandomAccess2DIteratorConcept {
        ...
        void constraints () {
            function_requires< RandomAccessIteratorConcept<suVCerator1_type> >();
            function_requires< RandomAccessIteratorConcept<suVCerator2_type> >();
            function_requires< Indexed2DIteratorConcept<suVCerator1_type> >();
            function_requires< Indexed2DIteratorConcept<suVCerator2_type> >();
        }
    };
    ...
    struct Mutable_IndexedRandomAccess2DIteratorConcept {
        ...
        void constraints () {
            function_requires< Mutable_RandomAccessIteratorConcept<suVCerator1_type> >();
            function_requires< Mutable_RandomAccessIteratorConcept<suVCerator2_type> >();
            function_requires< Indexed2DIteratorConcept<suVCerator1_type> >();
            function_requires< Indexed2DIteratorConcept<suVCerator2_type> >();
        }
    };
    ...
    struct MatrixExpressionConcept {
        ...
        typedef typename ME::const_iterator1 const_suVCerator1_type;
        typedef typename ME::const_iterator2 const_suVCerator2_type;
        typedef typename ME::const_reverse_iterator1 const_reverse_suVCerator1_type;
        typedef typename ME::const_reverse_iterator2 const_reverse_suVCerator2_type;
        ...
        void constraints () {
            ...
            value_type t;
            // Find (internal?)
            const_suVCerator1_type cit1 (m.find1 (0, i, j));
            const_suVCerator2_type cit2 (m.find2 (0, i, j));
            // Beginning of range
            const_suVCerator1_type cit1_begin (m.begin1 ());
            const_suVCerator2_type cit2_begin (m.begin2 ());
            // End of range
            const_suVCerator1_type cit1_end (m.end1 ());
            const_suVCerator2_type cit2_end (m.end2 ());
            // Size
            n = m.size1 ();
            n = m.size2 ();
            // Beginning of reverse range
            const_reverse_suVCerator1_type crit1_begin (cm.rbegin1 ());
            const_reverse_suVCerator2_type crit2_begin (cm.rbegin2 ());
            // End of reverse range
            const_reverse_suVCerator1_type crit1_end (cm.rend1 ());
            const_reverse_suVCerator2_type crit2_end (cm.rend2 ());
            // Element access
            t = m (i, j);
            ignore_unused_variable_warning (n);
    ...
    struct Mutable_MatrixExpressionConcept {
        ...
        typedef typename ME::size_type size_type;
        typedef typename ME::value_type value_type;
        typedef typename ME::iterator1 suVCerator1_type;
        typedef typename ME::iterator2 suVCerator2_type;
        typedef typename ME::reverse_iterator1 reverse_suVCerator1_type;
        typedef typename ME::reverse_iterator2 reverse_suVCerator2_type;
        ...
        void constraints () {
            ...
            value_type t = value_type ();
            // Find (internal?)
            suVCerator1_type it1 (m.find1 (0, i, j));
            suVCerator2_type it2 (m.find2 (0, i, j));
            // Beginning of range
            suVCerator1_type it1_begin (m.begin1 ());
            suVCerator2_type it2_begin (m.begin2 ());
            // End of range
            suVCerator1_type it1_end (m.end1 ());
            suVCerator2_type it2_end (m.end2 ());
            // Swap
            m1.swap (m2);
            // Beginning of reverse range
            reverse_suVCerator1_type rit1_begin (m.rbegin1 ());
            reverse_suVCerator2_type rit2_begin (m.rbegin2 ());
            // End of reverse range
            reverse_suVCerator1_type rit1_end (m.rend1 ());
            reverse_suVCerator2_type rit2_end (m.rend2 ());
            // Assignments
            m2 = m1;
            m2.assign (m1);
            m2 += m1;
