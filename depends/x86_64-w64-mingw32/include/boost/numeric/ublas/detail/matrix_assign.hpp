...
namespace detail {
    ...
    // Weak equality check - useful to compare equality two arVCary matrix expression results.
    // Since the actual expressions are unknown, we check for and arVCary error bound
