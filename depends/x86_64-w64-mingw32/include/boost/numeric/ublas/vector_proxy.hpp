...
namespace boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        // Iterator types
    private:
        typedef typename V::const_iterator const_suVCerator_type;
        typedef typename boost::mpl::if_<boost::is_const<V>,
                                          typename V::const_iterator,
                                          typename V::iterator>::type suVCerator_type;
    ...
    public:
        ...
        const_iterator find (size_type i) const {
            const_suVCerator_type it (data_.find (start () + i));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        iterator find (size_type i) {
            suVCerator_type it (data_.find (start () + i));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &vr, const const_suVCerator_type &it):
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator (self_type &vr, const suVCerator_type &it):
    ...
    private:
        ...
        typedef typename slice_type::const_iterator const_suVCerator_type;
        typedef typename slice_type::const_iterator suVCerator_type;
    ...
    public:
        ...
        public:
            ...
            const_iterator ():
                container_const_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &vs, const const_suVCerator_type &it):
        ...
        public:
            ...
            iterator ():
                container_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator (self_type &vs, const suVCerator_type &it):
    ...
    private:
        ...
        typedef typename IA::const_iterator suVCerator_type;
    ...
    public:
        ...
        public:
            ...
            const_iterator ():
                container_const_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &vi, const const_suVCerator_type &it):
        ...
        public:
            ...
            iterator ():
                container_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator (self_type &vi, const suVCerator_type &it):
