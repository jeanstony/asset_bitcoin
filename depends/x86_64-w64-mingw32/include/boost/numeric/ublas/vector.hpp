...
namespace boost { namespace numeric { namespace ublas {
	...
	/// \brief Return a const pointer to the element of index i
	 ...
	 private:
	     ...
	     typedef bool const_suVCerator_type;
	 public:
	     class const_iterator;
	     ...
	     public:
	         ...
	         BOOST_UBLAS_INLINE
	         const_iterator (const unit_vector &v, const const_suVCerator_type &it):
	 ...
	 public:
	     ...
	     public:
	         ...
	         BOOST_UBLAS_INLINE
	         const_iterator (const scalar_vector &v, const const_suVCerator_type &it):
