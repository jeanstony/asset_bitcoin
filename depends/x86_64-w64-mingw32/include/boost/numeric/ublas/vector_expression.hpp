...
namespace boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        // Iterator types
    private:
        typedef typename E::const_iterator const_suVCerator_type;
        typedef const value_type *const_pointer;

    public:
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        typedef indexed_const_iterator<const_closure_type, typename const_suVCerator_type::iterator_category> const_iterator;
        ...
        const_iterator find (size_type i) const {
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
            const_suVCerator_type it (e_.find (i));
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &vu, const const_suVCerator_type &it):
...
// #endif
    ...
    public:
        ...
        const_iterator find (size_type i) const {
            ...
            const_suVCerator1_type it1_end (e1_.find (size ()));
            const_suVCerator2_type it2 (e2_.find (i));
            const_suVCerator2_type it2_end (e2_.find (size ()));
        ...
        public:
            ...
            const_iterator (const self_type &vb, size_type i,
                            const const_suVCerator1_type &it1, const const_suVCerator1_type &it1_end,
                            const const_suVCerator2_type &it2, const const_suVCerator2_type &it2_end):
    ...
    private:
        ...
        typedef typename expression2_type::const_iterator const_suVCerator2_type;
        typedef const value_type *const_pointer;
    ...
    public:
        ...
        const_iterator find (size_type i) const {
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
            const_suVCerator2_type it (e2_.find (i));
            return const_iterator (*this, it.index ());
#else
            return const_iterator (*this, const_suVCerator1_type (e1_), e2_.find (i));
#endif
        }
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &vbs, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
    ...
    public:
        ...
        // Iterator types
    private:
        typedef typename expression1_type::const_iterator const_suVCerator1_type;
    ...
    public:
        ...
        const_iterator find (size_type i) const {
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
            const_suVCerator1_type it (e1_.find (i));
            return const_iterator (*this, it.index ());
#else
            return const_iterator (*this, e1_.find (i), const_suVCerator2_type (e2_));
#endif
        }
