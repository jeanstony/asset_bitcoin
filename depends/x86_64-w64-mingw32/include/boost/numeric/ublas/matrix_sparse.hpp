    ...
    */
	...
	void reserve (size_type non_zeros, bool /*preserve*/ = true) {
        ...
        const_pointer find_element (size_type i, size_type j) const {
            ...
            const_suVCerator_type it (data ().find (element));
            if (it == data ().end ())
                return 0;
...
#ifndef BOOST_UBLAS_STRICT_MATRIX_SPARSE
            const size_type element = layout_type::element (i, size1_, j, size2_);
            std::pair<suVCerator_type, bool> ii (data ().insert (typename array_type::value_type (element, value_type/*zero*/())));
        ...
        true_reference insert_element (size_type i, size_type j, const_reference t) {
            ...
            const size_type element = layout_type::element (i, size1_, j, size2_);
            std::pair<suVCerator_type, bool> ii (data ().insert (typename array_type::value_type (element, t)));
            BOOST_UBLAS_CHECK ((ii.first)->first == element, internal_logic ());   // broken map
        ...
        void erase_element (size_type i, size_type j) {
            suVCerator_type it = data ().find (layout_type::element (i, size1_, j, size2_));
            if (it == data ().end ())
                return;
            data ().erase (it);
        }
    ...
    private:
        ...
        typedef typename A::const_iterator const_suVCerator_type;
        typedef typename A::iterator suVCerator_type;

        BOOST_UBLAS_INLINE
        true_reference at_element (size_type i, size_type j) {
            const size_type element = layout_type::element (i, size1_, j, size2_);
            suVCerator_type it (data ().find (element));
    ...
    public:
        ...
        const_iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) const {
            const_suVCerator_type it (data ().lower_bound (layout_type::address (i, size1_, j, size2_)));
            const_suVCerator_type it_end (data ().end ());
        ...
        iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) {
            suVCerator_type it (data ().lower_bound (layout_type::address (i, size1_, j, size2_)));
            suVCerator_type it_end (data ().end ());
            size_type index1 = size_type (-1);
            size_type index2 = size_type (-1);
            while (rank == 1 && it != it_end) {
                index1 = layout_type::index_i ((*it).first, size1_, size2_);
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator1 (const self_type &m, int rank, size_type i, size_type j, const const_suVCerator_type &it):
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator1 (self_type &m, int rank, size_type i, size_type j, const suVCerator_type &it):
        ...
        public:
            ...
            const_iterator2 ():
                container_const_reference<self_type> (), rank_ (), i_ (), j_ (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const self_type &m, int rank, size_type i, size_type j, const const_suVCerator_type &it):
                container_const_reference<self_type> (m), rank_ (rank), i_ (i), j_ (j), it_ (it) {}
            BOOST_UBLAS_INLINE
        ...
        public:
            ...
            iterator2 ():
                container_reference<self_type> (), rank_ (), i_ (), j_ (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator2 (self_type &m, int rank, size_type i, size_type j, const suVCerator_type &it):
                container_reference<self_type> (m), rank_ (rank), i_ (i), j_ (j), it_ (it) {}
    ...
    public:
        ...
        size_type nnz_capacity () const {
            ...
            for (vector_const_suVCerator_type itv = data_ ().begin (); itv != data_ ().end (); ++ itv)
        ...
        const_pointer find_element (size_type i, size_type j) const {
            ...
            vector_const_suVCerator_type itv (data ().find (element1));
            if (itv == data ().end ())
                return 0;
            BOOST_UBLAS_CHECK ((*itv).first == element1, internal_logic ());   // broken map
            const_suVCerator_type it ((*itv).second.find (element2));
        ...
        reference operator () (size_type i, size_type j) {
            ...
            std::pair<suVCerator_type, bool> ii (vd.insert (typename array_type::value_type::second_type::value_type (element2, value_type/*zero*/())));
        ...
        true_reference insert_element (size_type i, size_type j, const_reference t) {
            ...
            vector_data_value_type& vd (data () [element1]);
            std::pair<suVCerator_type, bool> ii (vd.insert (typename vector_data_value_type::value_type (element2, t)));
            BOOST_UBLAS_CHECK ((ii.first)->first == element2, internal_logic ());   // broken map
            if (!ii.second)     // existing element
                (ii.first)->second = t;
            return (ii.first)->second;
        ...
        BOOST_UBLAS_INLINE
        void erase_element (size_type i, size_type j) {
            vector_suVCerator_type itv (data ().find (layout_type::index_M (i, j)));
            if (itv == data ().end ())
                return;
            suVCerator_type it ((*itv).second.find (layout_type::index_m (i, j)));
            if (it == (*itv).second.end ())
                return;
            (*itv).second.erase (it);
        }
    ...
    private:
        ...
        typedef typename A::const_iterator vector_const_suVCerator_type;
        typedef typename A::iterator vector_suVCerator_type;
        typedef typename A::value_type::second_type::const_iterator const_suVCerator_type;
        typedef typename A::value_type::second_type::iterator suVCerator_type;

        BOOST_UBLAS_INLINE
        true_reference at_element (size_type i, size_type j) {
            const size_type element1 = layout_type::index_M (i, j);
            const size_type element2 = layout_type::index_m (i, j);
            vector_suVCerator_type itv (data ().find (element1));
            BOOST_UBLAS_CHECK (itv != data ().end(), bad_index ());
            BOOST_UBLAS_CHECK ((*itv).first == element1, internal_logic ());   // broken map
            suVCerator_type it ((*itv).second.find (element2));
    ...
    public:
        ...
        const_iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) const {
            ...
            for (;;) {
                vector_const_suVCerator_type itv (data ().lower_bound (layout_type::index_M (i, j)));
                vector_const_suVCerator_type itv_end (data ().end ());
                if (itv == itv_end)
                    return const_iterator1 (*this, rank, i, j, itv_end, (*(-- itv)).second.end ());

                const_suVCerator_type it ((*itv).second.lower_bound (layout_type::index_m (i, j)));
                const_suVCerator_type it_end ((*itv).second.end ());
                if (rank == 0) {
        ...
        iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) {
            BOOST_UBLAS_CHECK (data ().begin () != data ().end (), internal_logic ());
            for (;;) {
                vector_suVCerator_type itv (data ().lower_bound (layout_type::index_M (i, j)));
                vector_suVCerator_type itv_end (data ().end ());
                if (itv == itv_end)
                    return iterator1 (*this, rank, i, j, itv_end, (*(-- itv)).second.end ());

                suVCerator_type it ((*itv).second.lower_bound (layout_type::index_m (i, j)));
                suVCerator_type it_end ((*itv).second.end ());
                if (rank == 0) {
                    // advance to the first available major index
                    size_type M = itv->first;
                    size_type m;
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator1 (const self_type &m, int rank, size_type i, size_type j, const vector_const_suVCerator_type &itv, const const_suVCerator_type &it):
        ...
        private:
            ...
            size_type i_;
            size_type j_;
            vector_const_suVCerator_type itv_;
            const_suVCerator_type it_;
        };
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator1 (self_type &m, int rank, size_type i, size_type j, const vector_suVCerator_type &itv, const suVCerator_type &it):
        ...
        public:
            ...
            const_iterator2 ():
                container_const_reference<self_type> (), rank_ (), i_ (), j_ (), itv_ (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const self_type &m, int rank, size_type i, size_type j, const vector_const_suVCerator_type &itv, const const_suVCerator_type &it):
                container_const_reference<self_type> (m), rank_ (rank), i_ (i), j_ (j), itv_ (itv), it_ (it) {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const iterator2 &it):
                container_const_reference<self_type> (it ()), rank_ (it.rank_), i_ (it.i_), j_ (it.j_), itv_ (it.itv_), it_ (it.it_) {}
        ...
        public:
            ...
            iterator2 ():
                container_reference<self_type> (), rank_ (), i_ (), j_ (), itv_ (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator2 (self_type &m, int rank, size_type i, size_type j, const vector_suVCerator_type &itv, const suVCerator_type &it):
                container_reference<self_type> (m), rank_ (rank), i_ (i), j_ (j), itv_ (itv), it_ (it) {}
    ...
    public:
            ...
            index1_data_ (layout_type::size_M (size1_, size2_) + 1)
        {
            ...
            reserve(m.nnz(), false);
            filled2_ = m.nnz();
            const_suVCerator_type  i_start = m.index1_data().begin();
            const_suVCerator_type  i_end   = (i_start + filled2_);
            const_suVCerator_type  i = i_start;
            size_type r = 1;
    ...
    public:
        ...
        const_pointer find_element (size_type i, size_type j) const {
            ...
            if (filled1_ <= element1 + 1)
                return 0;
            vector_const_suVCerator_type itv (index1_data_.begin () + element1);
            const_suVCerator_type it_begin (index2_data_.begin () + zero_based (*itv));
            const_suVCerator_type it_end (index2_data_.begin () + zero_based (*(itv + 1)));
            const_suVCerator_type it (detail::lower_bound (it_begin, it_end, k_based (element2), std::less<size_type> ()));
        ...
        true_reference insert_element (size_type i, size_type j, const_reference t) {
            ...
            vector_suVCerator_type itv (index1_data_.begin () + element1);
            suVCerator_type it_begin (index2_data_.begin () + zero_based (*itv));
            suVCerator_type it_end (index2_data_.begin () + zero_based (*(itv + 1)));
            suVCerator_type it (detail::lower_bound (it_begin, it_end, k_based (element2), std::less<size_type> ()));
            typename std::iterator_traits<suVCerator_type>::difference_type n = it - index2_data_.begin ();
    ...
    private:
        ...
        typedef typename IA::const_iterator vector_const_suVCerator_type;
        typedef typename IA::iterator vector_suVCerator_type;
        typedef typename IA::const_iterator const_suVCerator_type;
        typedef typename IA::iterator suVCerator_type;
    ...
    public:
        ...
        const_iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) const {
            for (;;) {
                ...
                vector_const_suVCerator_type itv (index1_data_.begin () + (std::min) (filled1_ - 1, address1));
                ...
                const_suVCerator_type it (detail::lower_bound (it_begin, it_end, k_based (address2), std::less<size_type> ()));
                if (rank == 0)
                    return const_iterator1 (*this, rank, i, j, itv, it);
        ...
        iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) {
            for (;;) {
                array_size_type address1 (layout_type::index_M (i, j));
                array_size_type address2 (layout_type::index_m (i, j));
                vector_suVCerator_type itv (index1_data_.begin () + (std::min) (filled1_ - 1, address1));
                if (filled1_ <= address1 + 1)
                ...
                suVCerator_type it (detail::lower_bound (it_begin, it_end, k_based (address2), std::less<size_type> ()));
                if (rank == 0)
                    return iterator1 (*this, rank, i, j, itv, it);
                if (it != it_end && zero_based (*it) == address2)
                    return iterator1 (*this, rank, i, j, itv, it);
    ...
    public:
        ...
        const_pointer find_element (size_type i, size_type j) const {
            ...
            size_type element1 (layout_type::index_M (i, j));
            size_type element2 (layout_type::index_m (i, j));
            vector_const_suVCerator_type itv_begin (detail::lower_bound (index1_data_.begin (), index1_data_.begin () + filled_, k_based (element1), std::less<size_type> ()));
            vector_const_suVCerator_type itv_end (detail::upper_bound (index1_data_.begin (), index1_data_.begin () + filled_, k_based (element1), std::less<size_type> ()));
            if (itv_begin == itv_end)
                return 0;
            const_suVCerator_type it_begin (index2_data_.begin () + (itv_begin - index1_data_.begin ()));
            const_suVCerator_type it_end (index2_data_.begin () + (itv_end - index1_data_.begin ()));
            const_suVCerator_type it (detail::lower_bound (it_begin, it_end, k_based (element2), std::less<size_type> ()));
            if (it == it_end || *it != k_based (element2))
                return 0;
            return &value_data_ [it - index2_data_.begin ()];
        ...
        void erase_element (size_type i, size_type j) {
            ...
            size_type element2 = layout_type::index_m (i, j);
            sort ();
            vector_suVCerator_type itv_begin (detail::lower_bound (index1_data_.begin (), index1_data_.begin () + filled_, k_based (element1), std::less<size_type> ()));
            vector_suVCerator_type itv_end (detail::upper_bound (index1_data_.begin (), index1_data_.begin () + filled_, k_based (element1), std::less<size_type> ()));
            suVCerator_type it_begin (index2_data_.begin () + (itv_begin - index1_data_.begin ()));
            suVCerator_type it_end (index2_data_.begin () + (itv_end - index1_data_.begin ()));
            suVCerator_type it (detail::lower_bound (it_begin, it_end, k_based (element2), std::less<size_type> ()));
            if (it != it_end && *it == k_based (element2)) {
                typename std::iterator_traits<suVCerator_type>::difference_type n = it - index2_data_.begin ();
                vector_suVCerator_type itv (index1_data_.begin () + n);
    ...
    public:
        ...
        const_iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) const {
            ...
            for (;;) {
                ...
                vector_const_suVCerator_type itv_begin (detail::lower_bound (index1_data_.begin (), index1_data_.begin () + filled_, k_based (address1), std::less<size_type> ()));
                vector_const_suVCerator_type itv_end (detail::upper_bound (index1_data_.begin (), index1_data_.begin () + filled_, k_based (address1), std::less<size_type> ()));

                const_suVCerator_type it_begin (index2_data_.begin () + (itv_begin - index1_data_.begin ()));
                const_suVCerator_type it_end (index2_data_.begin () + (itv_end - index1_data_.begin ()));

                const_suVCerator_type it (detail::lower_bound (it_begin, it_end, k_based (address2), std::less<size_type> ()));
                vector_const_suVCerator_type itv (index1_data_.begin () + (it - index2_data_.begin ()));
                if (rank == 0)
                    return const_iterator1 (*this, rank, i, j, itv, it);
                if (it != it_end && zero_based (*it) == address2)
                    return const_iterator1 (*this, rank, i, j, itv, it);
        ...
        iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) {
            ...
            for (;;) {
                size_type address1 (layout_type::index_M (i, j));
                size_type address2 (layout_type::index_m (i, j));
                vector_suVCerator_type itv_begin (detail::lower_bound (index1_data_.begin (), index1_data_.begin () + filled_, k_based (address1), std::less<size_type> ()));
                vector_suVCerator_type itv_end (detail::upper_bound (index1_data_.begin (), index1_data_.begin () + filled_, k_based (address1), std::less<size_type> ()));

                suVCerator_type it_begin (index2_data_.begin () + (itv_begin - index1_data_.begin ()));
                suVCerator_type it_end (index2_data_.begin () + (itv_end - index1_data_.begin ()));

                suVCerator_type it (detail::lower_bound (it_begin, it_end, k_based (address2), std::less<size_type> ()));
                vector_suVCerator_type itv (index1_data_.begin () + (it - index2_data_.begin ()));
                if (rank == 0)
                    return iterator1 (*this, rank, i, j, itv, it);
                if (it != it_end && zero_based (*it) == address2)
                    return iterator1 (*this, rank, i, j, itv, it);
