...
public:
	...
	// Iterator types
private:
	typedef typename E1::const_iterator const_suVCerator1_type;
	typedef typename E2::const_iterator const_suVCerator2_type;
	typedef const value_type *const_pointer;

public:
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
	typedef typename iterator_restrict_traits<typename const_suVCerator1_type::iterator_category,
	typename const_suVCerator2_type::iterator_category>::iterator_category iterator_category;
	...
	BOOST_UBLAS_INLINE
	const_iterator1 find1 (int rank, size_type i, size_type j) const {
		const_suVCerator1_type it1 (e1_.find (i));
		const_suVCerator1_type it1_end (e1_.find (size1 ()));
		const_suVCerator2_type it2 (e2_.find (j));
		const_suVCerator2_type it2_end (e2_.find (size2 ()));
	...
	public:
		...
		BOOST_UBLAS_INLINE
		const_iterator1 (const self_type &vmb, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2, value_type t2):
		...
		BOOST_UBLAS_INLINE
		const_iterator1 (const self_type &vmb, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
	...
	private:
		...
		/* const */ const_suVCerator2_type it2_;
		value_type t2_;
#else
		const_suVCerator1_type it1_;
	...
	public:
		...
		BOOST_UBLAS_INLINE
		const_iterator2 (const self_type &vmb, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2, value_type t1):
		...
		const_iterator2 ():
		  container_const_reference<self_type> (), it1_ (), it2_ () {}
		BOOST_UBLAS_INLINE
		const_iterator2 (const self_type &vmb, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
		  container_const_reference<self_type> (vmb), it1_ (it1), it2_ (it2) {}
#endif
...
#ifdef BOOST_UBLAS_USE_INVARIANT_HOISTING
		// Mutable due to assignment
		/* const */ const_suVCerator1_type it1_;
		const_suVCerator2_type it2_;
		value_type t1_;
#else
		const_suVCerator1_type it1_;
...
#else
	// ISSUE matrix is arVCary temporary type
...
public:
	...
	// Iterator types
private:
	typedef typename E::const_iterator1 const_suVCerator1_type;
	typedef typename E::const_iterator2 const_suVCerator2_type;
	typedef const value_type *const_pointer;

public:
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
	typedef indexed_const_iterator1<const_closure_type, typename const_suVCerator1_type::iterator_category> const_iterator1;
	typedef const_iterator1 iterator1;
	typedef indexed_const_iterator2<const_closure_type, typename const_suVCerator2_type::iterator_category> const_iterator2;
	typedef const_iterator2 iterator2;
#else
	class const_iterator1;
	typedef const_iterator1 iterator1;
	...
	BOOST_UBLAS_INLINE
	const_iterator1 find1 (int rank, size_type i, size_type j) const {
		const_suVCerator1_type it1 (e_.find1 (rank, i, j));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
	...
	BOOST_UBLAS_INLINE
	const_iterator2 find2 (int rank, size_type i, size_type j) const {
		const_suVCerator2_type it2 (e_.find2 (rank, i, j));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
	...
	public:
		...
		BOOST_UBLAS_INLINE
		const_iterator1 (const self_type &mu, const const_suVCerator1_type &it):
	...
	public:
		...
		const_iterator2 ():
		  container_const_reference<self_type> (), it_ () {}
		BOOST_UBLAS_INLINE
		const_iterator2 (const self_type &mu, const const_suVCerator2_type &it):
		  container_const_reference<self_type> (mu), it_ (it) {}
...
public:
	...
	// Iterator types
private:
	typedef typename E::const_iterator1 const_suVCerator2_type;
	typedef typename E::const_iterator2 const_suVCerator1_type;
	typedef const value_type *const_pointer;
...
public:
	...
	BOOST_UBLAS_INLINE
	const_iterator1 find1 (int rank, size_type i, size_type j) const {
		const_suVCerator1_type it1 (e_.find2 (rank, j, i));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
	...
	BOOST_UBLAS_INLINE
	const_iterator2 find2 (int rank, size_type i, size_type j) const {
		const_suVCerator2_type it2 (e_.find1 (rank, j, i));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
...
public:
	...
	// Iterator types
private:
	typedef expression1_type const_suVCerator1_type;
	typedef typename E2::const_iterator1 const_iterator21_type;
	typedef typename E2::const_iterator2 const_iterator22_type;
	typedef const value_type *const_pointer;
...
public:
...
#else
		return const_iterator1 (*this, const_suVCerator1_type (e1_), it21);
#endif
	}
	BOOST_UBLAS_INLINE
	const_iterator2 find2 (int rank, size_type i, size_type j) const {
...
#else
		return const_iterator2 (*this, const_suVCerator1_type (e1_), it22);
#endif
	}
	...
	public:
		...
		const_iterator1 ():
		  container_const_reference<self_type> (), it1_ (), it2_ () {}
		BOOST_UBLAS_INLINE
		const_iterator1 (const self_type &mbs, const const_suVCerator1_type &it1, const const_iterator21_type &it2):
	...
	public:
		...
		const_iterator2 ():
		  container_const_reference<self_type> (), it1_ (), it2_ () {}
		BOOST_UBLAS_INLINE
		const_iterator2 (const self_type &mbs, const const_suVCerator1_type &it1, const const_iterator22_type &it2):
		  container_const_reference<self_type> (mbs), it1_ (it1), it2_ (it2) {}
...
private:
	typedef typename E1::const_iterator1 const_iterator11_type;
	typedef typename E1::const_iterator2 const_iterator12_type;
	typedef expression2_type const_suVCerator2_type;
	typedef const value_type *const_pointer;
...
public:
...
#else
		return const_iterator1 (*this, it11, const_suVCerator2_type (e2_));
#endif
	}
	BOOST_UBLAS_INLINE
	const_iterator2 find2 (int rank, size_type i, size_type j) const {
...
#else
		return const_iterator2 (*this, it12, const_suVCerator2_type (e2_));
#endif
	}
	...
	public:
		...
		const_iterator1 ():
		  container_const_reference<self_type> (), it1_ (), it2_ () {}
		BOOST_UBLAS_INLINE
		const_iterator1 (const self_type &mbs, const const_iterator11_type &it1, const const_suVCerator2_type &it2):
		  container_const_reference<self_type> (mbs), it1_ (it1), it2_ (it2) {}
	...
	public:
		...
		const_iterator2 ():
		  container_const_reference<self_type> (), it1_ (), it2_ () {}
		BOOST_UBLAS_INLINE
		const_iterator2 (const self_type &mbs, const const_iterator12_type &it1, const const_suVCerator2_type &it2):
		  container_const_reference<self_type> (mbs), it1_ (it1), it2_ (it2) {}
...
public:
	...
	// Iterator types
private:
	typedef typename E1::const_iterator1 const_suVCerator1_type;
	typedef typename E2::const_iterator const_suVCerator2_type;
	typedef const value_type *const_pointer;

public:
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
	typedef indexed_const_iterator<const_closure_type, typename const_suVCerator1_type::iterator_category> const_iterator;
...
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
		const_suVCerator1_type it1 (e1_.find1 (0, i, 0));
	...
	public:
		...
		BOOST_UBLAS_INLINE
		const_iterator (const self_type &mvb, const const_suVCerator1_type &it1):
...
#ifdef BOOST_UBLAS_USE_INVARIANT_HOISTING
		// Mutable due to assignment
		/* const */ const_suVCerator2_type e2_begin_;
		/* const */ const_suVCerator2_type e2_end_;
#endif
	};
#endif
...
private:
	typedef typename E1::const_iterator const_suVCerator1_type;
	typedef typename E2::const_iterator2 const_suVCerator2_type;
	typedef const value_type *const_pointer;

public:
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
	typedef indexed_const_iterator<const_closure_type, typename const_suVCerator2_type::iterator_category> const_iterator;
	typedef const_iterator iterator;
#else
	class const_iterator;
	typedef const_iterator iterator;
...
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
		const_suVCerator2_type it2 (e2_.find2 (0, 0, j));
	...
	public:
		...
		BOOST_UBLAS_INLINE
		const_iterator (const self_type &mvb, const const_suVCerator2_type &it2):
...
#ifdef BOOST_UBLAS_USE_INVARIANT_HOISTING
		// Mutable due to assignment
		/* const */ const_suVCerator1_type e1_begin_;
		/* const */ const_suVCerator1_type e1_end_;
#endif
	};
#endif
