...
// MSVC does not like arrays of size 0 in base classes.  Hence, this conditionally changes the size to 1
    ...
    public:
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator (const basic_range &r, const const_suVCerator_type &it):
    ...
    public:
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator (const basic_slice &s, const const_suVCerator_type &it):
    ...
    private:
        ...
        typedef difference_type const_suVCerator_type;
    ...
    public:
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator (const indirect_array &ia, const const_suVCerator_type &it):
