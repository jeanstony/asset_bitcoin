...
namespace boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        const_pointer find_element (size_type i) const {
            const_suVCerator_type it (data ().find (i));
            if (it == data ().end ())
                return 0;
        ...
        true_reference ref (size_type i) {
            BOOST_UBLAS_CHECK (i < size_, bad_index ());
            std::pair<suVCerator_type, bool> ii (data ().insert (typename array_type::value_type (i, value_type/*zero*/())));
        ...
        true_reference insert_element (size_type i, const_reference t) {
            std::pair<suVCerator_type, bool> ii = data ().insert (typename array_type::value_type (i, t));
        ...
        void erase_element (size_type i) {
            suVCerator_type it = data ().find (i);
            if (it == data ().end ())
                return;
            data ().erase (it);
        }
    ...
    public:
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &v, const const_suVCerator_type &it):
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator (self_type &v, const suVCerator_type &it):
    ...
    public:
        ...
        BOOST_UBLAS_INLINE
        const_pointer find_element (size_type i) const {
            const_suVCerator_type it (detail::lower_bound (index_data_.begin (), index_data_.begin () + filled_, k_based (i), std::less<size_type> ()));
        ...
        true_reference ref (size_type i) {
            BOOST_UBLAS_CHECK (i < size_, bad_index ());
            suVCerator_type it (detail::lower_bound (index_data_.begin (), index_data_.begin () + filled_, k_based (i), std::less<size_type> ()));
            if (it == index_data_.begin () + filled_ || *it != k_based (i))
        ...
        true_reference insert_element (size_type i, const_reference t) {
            ...
            typename std::iterator_traits<suVCerator_type>::difference_type n = it - index_data_.begin ();
