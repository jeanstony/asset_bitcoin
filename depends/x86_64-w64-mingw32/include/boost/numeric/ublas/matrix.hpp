...
//			}
    ...
    public:
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator1 (const self_type &m, const const_suVCerator_type &it):
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator1 (self_type &m, const suVCerator_type &it):
        ...
        public:
            ...
            const_iterator2 ():
                container_const_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const self_type &m, const const_suVCerator_type &it):
                container_const_reference<self_type> (m), it_ (it) {}
            BOOST_UBLAS_INLINE
        ...
        public:
            ...
            iterator2 ():
                container_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator2 (self_type &m, const suVCerator_type &it):
                container_reference<self_type> (m), it_ (it) {}
    ...
    */
    ...
    private:
        ...
        typedef typename A::value_type::const_iterator const_suVCerator_type;
        typedef typename A::value_type::iterator suVCerator_type;
    public:
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        typedef indexed_iterator1<self_type, dense_random_access_iterator_tag> iterator1;
        typedef indexed_iterator2<self_type, dense_random_access_iterator_tag> iterator2;
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator1 (const self_type &m, size_type i, size_type j, const const_suVCerator_type &it):
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator1 (self_type &m, size_type i, size_type j, const suVCerator_type &it):
        ...
        public:
            ...
            const_iterator2 ():
                container_const_reference<self_type> (), i_ (), j_ (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const self_type &m, size_type i, size_type j, const const_suVCerator_type &it):
                container_const_reference<self_type> (m), i_ (i), j_ (j), it_ (it) {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const iterator2 &it):
                container_const_reference<self_type> (it ()), i_ (it.i_), j_ (it.j_), it_ (it.it_) {}
        ...
        public:
            ...
            iterator2 ():
                container_reference<self_type> (), i_ (), j_ (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator2 (self_type &m, size_type i, size_type j, const suVCerator_type &it):
                container_reference<self_type> (m), i_ (i), j_ (j), it_ (it) {}
    ...
    public:
        ...
        public:
            ...
            const_reference operator * () const {
                BOOST_UBLAS_CHECK_FALSE (bad_index ());
                return zero_;   // arVCary return value
            }
    ...
    private:
        // Use an index
        typedef size_type const_suVCerator_type;
    ...
    public:
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator1 (const scalar_matrix &m, const const_suVCerator_type &it1, const const_suVCerator_type &it2):
        ...
        private:
            const_suVCerator_type it1_;
            const_suVCerator_type it2_;
        };
        ...
        public:
            ...
            const_iterator2 ():
                container_const_reference<scalar_matrix> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const scalar_matrix &m, const const_suVCerator_type &it1, const const_suVCerator_type &it2):
                container_const_reference<scalar_matrix> (m), it1_ (it1), it2_ (it2) {}
    ...
    private:
        ...
        typedef const_pointer const_suVCerator_type;
        typedef pointer suVCerator_type;
