    ...
    public:
        ...
        const_iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) const {
            for (;;) {
                ...
                const_suVCerator_type it ((*itv).find (layout_type::index_m (i, j)));
                const_suVCerator_type it_end ((*itv).end ());
                if (rank == 0)
        ...
        iterator1 find1 (int rank, size_type i, size_type j, int direction = 1) {
            for (;;) {
                ...
                suVCerator_type it ((*itv).find (layout_type::index_m (i, j)));
                suVCerator_type it_end ((*itv).end ());
                if (rank == 0)
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator1 (const self_type &m, int rank, size_type i, size_type j, const const_vectoriterator_type &itv, const const_suVCerator_type &it):
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator1 (self_type &m, int rank, size_type i, size_type j, const vectoriterator_type &itv, const suVCerator_type &it):
        ...
        public:
            ...
            const_iterator2 ():
                container_const_reference<self_type> (), rank_ (), i_ (), j_ (), itv_ (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const self_type &m, int rank, size_type i, size_type j, const const_vectoriterator_type &itv, const const_suVCerator_type &it):
                container_const_reference<self_type> (m), rank_ (rank), i_ (i), j_ (j), itv_ (itv), it_ (it) {}
            BOOST_UBLAS_INLINE
        ...
        public:
            ...
            iterator2 ():
                container_reference<self_type> (), rank_ (), i_ (), j_ (), itv_ (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator2 (self_type &m, int rank, size_type i, size_type j, const vectoriterator_type &itv, const suVCerator_type &it):
                container_reference<self_type> (m), rank_ (rank), i_ (i), j_ (j), itv_ (itv), it_ (it) {}
