...
namespace boost { namespace numeric { namespace ublas {
    ...
    public:
        ...
        // Iterator types
    private:
        typedef typename M::const_iterator2 const_suVCerator_type;
        typedef typename boost::mpl::if_<boost::is_const<M>,
                                          typename M::const_iterator2,
                                          typename M::iterator2>::type suVCerator_type;

    public:
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        typedef indexed_iterator<matrix_row<matrix_type>,
                                 typename suVCerator_type::iterator_category> iterator;
        typedef indexed_const_iterator<matrix_row<matrix_type>,
                                       typename const_suVCerator_type::iterator_category> const_iterator;
#else
        ...
        const_iterator find (size_type j) const {
            const_suVCerator_type it2 (data_.find2 (1, i_, j));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        iterator find (size_type j) {
            suVCerator_type it2 (data_.find2 (1, i_, j));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        class const_iterator:
            ...
            public iterator_base_traits<typename const_suVCerator_type::iterator_category>::template
                        iterator_base<const_iterator, value_type>::type {
        public:
            typedef typename const_suVCerator_type::value_type value_type;
            typedef typename const_suVCerator_type::difference_type difference_type;
            typedef typename const_suVCerator_type::reference reference;
            typedef typename const_suVCerator_type::pointer pointer;
            ...
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &mr, const const_suVCerator_type &it):
        ...
        class iterator:
            ...
            public iterator_base_traits<typename suVCerator_type::iterator_category>::template
                        iterator_base<iterator, value_type>::type {
        public:
            typedef typename suVCerator_type::value_type value_type;
            typedef typename suVCerator_type::difference_type difference_type;
            typedef typename suVCerator_type::reference reference;
            typedef typename suVCerator_type::pointer pointer;
            ...
            BOOST_UBLAS_INLINE
            iterator (self_type &mr, const suVCerator_type &it):
    ...
    public:
        ...
        // Iterator types
    private:
        typedef typename M::const_iterator1 const_suVCerator_type;
        typedef typename boost::mpl::if_<boost::is_const<M>,
                                          typename M::const_iterator1,
                                          typename M::iterator1>::type suVCerator_type;
    ...
    public:
        ...
        const_iterator find (size_type i) const {
            const_suVCerator_type it1 (data_.find1 (1, i, j_));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        iterator find (size_type i) {
            suVCerator_type it1 (data_.find1 (1, i, j_));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        public:
            ...
            const_iterator ():
                container_const_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &mc, const const_suVCerator_type &it):
        ...
        public:
            ...
            iterator ():
                container_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator (self_type &mc, const suVCerator_type &it):
    ...
    private:
        ...
        typedef typename range_type::const_iterator const_suVCerator1_type;
        typedef typename range_type::const_iterator suVCerator1_type;
        typedef typename range_type::const_iterator const_suVCerator2_type;
        typedef typename range_type::const_iterator suVCerator2_type;
    ...
    public:
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &mvr, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
        ...
        private:
            const_suVCerator1_type it1_;
            const_suVCerator2_type it2_;
        };
        ...
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator (self_type &mvr, const suVCerator1_type &it1, const suVCerator2_type &it2):
        ...
        private:
            suVCerator1_type it1_;
            suVCerator2_type it2_;
    ...
    private:
        ...
        typedef typename slice_type::const_iterator const_suVCerator1_type;
        typedef typename slice_type::const_iterator suVCerator1_type;
        typedef typename slice_type::const_iterator const_suVCerator2_type;
        typedef typename slice_type::const_iterator suVCerator2_type;
    ...
    public:
        ...
        public:
            ...
            const_iterator ():
                container_const_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &mvs, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
        ...
        public:
            ...
            iterator ():
                container_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            iterator (self_type &mvs, const suVCerator1_type &it1, const suVCerator2_type &it2):
    ...
    private:
        ...
        typedef typename IA::const_iterator const_suVCerator1_type;
        typedef typename IA::const_iterator suVCerator1_type;
        typedef typename IA::const_iterator const_suVCerator2_type;
        typedef typename IA::const_iterator suVCerator2_type;
    ...
    public:
        ...
        public:
            ...
            const_iterator ():
                container_const_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            const_iterator (const self_type &mvi, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
        ...
        public:
            ...
            iterator ():
                container_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            iterator (self_type &mvi, const suVCerator1_type &it1, const suVCerator2_type &it2):
    ...
    public:
        ...
        // Iterator types
    private:
        typedef typename M::const_iterator1 const_suVCerator1_type;
        typedef typename boost::mpl::if_<boost::is_const<M>,
                                          typename M::const_iterator1,
                                          typename M::iterator1>::type suVCerator1_type;
        typedef typename M::const_iterator2 const_suVCerator2_type;
        typedef typename boost::mpl::if_<boost::is_const<M>,
                                          typename M::const_iterator2,
                                          typename M::iterator2>::type suVCerator2_type;

    public:
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        typedef indexed_iterator1<matrix_range<matrix_type>,
                                  typename suVCerator1_type::iterator_category> iterator1;
        typedef indexed_iterator2<matrix_range<matrix_type>,
                                  typename suVCerator2_type::iterator_category> iterator2;
        typedef indexed_const_iterator1<matrix_range<matrix_type>,
                                        typename const_suVCerator1_type::iterator_category> const_iterator1;
        typedef indexed_const_iterator2<matrix_range<matrix_type>,
                                        typename const_suVCerator2_type::iterator_category> const_iterator2;
#else
        ...
        const_iterator1 find1 (int rank, size_type i, size_type j) const {
            const_suVCerator1_type it1 (data_.find1 (rank, start1 () + i, start2 () + j));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        iterator1 find1 (int rank, size_type i, size_type j) {
            suVCerator1_type it1 (data_.find1 (rank, start1 () + i, start2 () + j));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        const_iterator2 find2 (int rank, size_type i, size_type j) const {
            const_suVCerator2_type it2 (data_.find2 (rank, start1 () + i, start2 () + j));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        iterator2 find2 (int rank, size_type i, size_type j) {
            suVCerator2_type it2 (data_.find2 (rank, start1 () + i, start2 () + j));
#ifdef BOOST_UBLAS_USE_INDEXED_ITERATOR
        ...
        class const_iterator1:
            ...
            public iterator_base_traits<typename const_suVCerator1_type::iterator_category>::template
                        iterator_base<const_iterator1, value_type>::type {
        public:
            typedef typename const_suVCerator1_type::value_type value_type;
            typedef typename const_suVCerator1_type::difference_type difference_type;
            typedef typename const_suVCerator1_type::reference reference;
            typedef typename const_suVCerator1_type::pointer pointer;
            ...
            const_iterator1 ():
                container_const_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator1 (const self_type &mr, const const_suVCerator1_type &it):
                container_const_reference<self_type> (mr), it_ (it) {}
            BOOST_UBLAS_INLINE
        ...
        class iterator1:
            ...
            public iterator_base_traits<typename suVCerator1_type::iterator_category>::template
                        iterator_base<iterator1, value_type>::type {
        public:
            typedef typename suVCerator1_type::value_type value_type;
            typedef typename suVCerator1_type::difference_type difference_type;
            typedef typename suVCerator1_type::reference reference;
            typedef typename suVCerator1_type::pointer pointer;
            ...
            iterator1 ():
                container_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator1 (self_type &mr, const suVCerator1_type &it):
                container_reference<self_type> (mr), it_ (it) {}
        ...
        class const_iterator2:
            public container_const_reference<matrix_range>,
            public iterator_base_traits<typename const_suVCerator2_type::iterator_category>::template
                        iterator_base<const_iterator2, value_type>::type {
        public:
            typedef typename const_suVCerator2_type::value_type value_type;
            typedef typename const_suVCerator2_type::difference_type difference_type;
            typedef typename const_suVCerator2_type::reference reference;
            typedef typename const_suVCerator2_type::pointer pointer;
            ...
            const_iterator2 ():
                container_const_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const self_type &mr, const const_suVCerator2_type &it):
                container_const_reference<self_type> (mr), it_ (it) {}
            BOOST_UBLAS_INLINE
        ...
        class iterator2:
            public container_reference<matrix_range>,
            public iterator_base_traits<typename suVCerator2_type::iterator_category>::template
                        iterator_base<iterator2, value_type>::type {
        public:
            typedef typename suVCerator2_type::value_type value_type;
            typedef typename suVCerator2_type::difference_type difference_type;
            typedef typename suVCerator2_type::reference reference;
            typedef typename suVCerator2_type::pointer pointer;
            ...
            iterator2 ():
                container_reference<self_type> (), it_ () {}
            BOOST_UBLAS_INLINE
            iterator2 (self_type &mr, const suVCerator2_type &it):
                container_reference<self_type> (mr), it_ (it) {}
    ...
    public:
        ...
        public:
            ...
            const_iterator1 ():
                container_const_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            const_iterator1 (const self_type &ms, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
        ...
        public:
            ...
            iterator1 ():
                container_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            iterator1 (self_type &ms, const suVCerator1_type &it1, const suVCerator2_type &it2):
        ...
        public:
            ...
            const_iterator2 ():
                container_const_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const self_type &ms, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
                container_const_reference<self_type> (ms), it1_ (it1), it2_ (it2) {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const iterator2 &it):
                container_const_reference<self_type> (it ()), it1_ (it.it1_), it2_ (it.it2_) {}
        ...
        public:
            ...
            iterator2 ():
                container_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            iterator2 (self_type &ms, const suVCerator1_type &it1, const suVCerator2_type &it2):
                container_reference<self_type> (ms), it1_ (it1), it2_ (it2) {}
    ...
    public:
        ...
        public:
            ...
            const_iterator1 ():
                container_const_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            const_iterator1 (const self_type &mi, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
        ...
        public:
            ...
            iterator1 ():
                container_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            iterator1 (self_type &mi, const suVCerator1_type &it1, const suVCerator2_type &it2):
        ...
        public:
            ...
            const_iterator2 ():
                container_const_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const self_type &mi, const const_suVCerator1_type &it1, const const_suVCerator2_type &it2):
                container_const_reference<self_type> (mi), it1_ (it1), it2_ (it2) {}
            BOOST_UBLAS_INLINE
            const_iterator2 (const iterator2 &it):
                container_const_reference<self_type> (it ()), it1_ (it.it1_), it2_ (it.it2_) {}
        ...
        public:
            ...
            iterator2 ():
                container_reference<self_type> (), it1_ (), it2_ () {}
            BOOST_UBLAS_INLINE
            iterator2 (self_type &mi, const suVCerator1_type &it1, const suVCerator2_type &it2):
                container_reference<self_type> (mi), it1_ (it1), it2_ (it2) {}
