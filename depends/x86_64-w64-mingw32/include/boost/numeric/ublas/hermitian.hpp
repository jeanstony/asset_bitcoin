    ...
    public:
        ...
        class const_iterator1:
            ...
            public random_access_iterator_base<typename iterator_restrict_traits<
                                                   typename const_suVCerator1_type::iterator_category, dense_random_access_iterator_tag>::iterator_category,
                                               const_iterator1, value_type> {
        public:
            ...
            typedef typename const_suVCerator1_type::value_type reference;
            ...
            const_iterator1 (const self_type &m, int begin, int end,
                             const const_suVCerator1_type &it1_begin, const const_suVCerator1_type &it1_end,
                             const const_suVCerator2_type &it2_begin, const const_suVCerator2_type &it2_end):
        ...
        private:
            ...
            int end_;
            int current_;
            const_suVCerator1_type it1_begin_;
            const_suVCerator1_type it1_end_;
            const_suVCerator1_type it1_;
            const_suVCerator2_type it2_begin_;
            const_suVCerator2_type it2_end_;
        ...
        class iterator1:
            ...
            public random_access_iterator_base<typename iterator_restrict_traits<
                                                   typename suVCerator1_type::iterator_category, packed_random_access_iterator_tag>::iterator_category,
                                               iterator1, value_type> {
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator1 (self_type &m, const suVCerator1_type &it1):
        ...
        class const_iterator2:
            public container_const_reference<hermitian_adaptor>,
            public random_access_iterator_base<typename iterator_restrict_traits<
            typename const_suVCerator2_type::iterator_category, dense_random_access_iterator_tag>::iterator_category,
                                               const_iterator2, value_type> {
        public:
            ...
            typedef typename const_suVCerator2_type::value_type reference;
        ...
        class iterator2:
            public container_reference<hermitian_adaptor>,
            public random_access_iterator_base<typename iterator_restrict_traits<
                                                   typename suVCerator2_type::iterator_category, packed_random_access_iterator_tag>::iterator_category,
                                               iterator2, value_type> {
        public:
            ...
            BOOST_UBLAS_INLINE
            iterator2 (self_type &m, const suVCerator2_type &it2):
