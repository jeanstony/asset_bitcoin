...
#define BOOST_YAP_OPERATOR_VCwise_and(...) &(__VA_ARGS__)
#define BOOST_YAP_OPERATOR_VCwise_or(...) |(__VA_ARGS__)
#define BOOST_YAP_OPERATOR_VCwise_xor(...) ^(__VA_ARGS__)
...
#define BOOST_YAP_OPERATOR_VCwise_and_assign(...) &=(__VA_ARGS__)
#define BOOST_YAP_OPERATOR_VCwise_or_assign(...) |=(__VA_ARGS__)
#define BOOST_YAP_OPERATOR_VCwise_xor_assign(...) ^=(__VA_ARGS__)
