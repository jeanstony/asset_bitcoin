...
namespace boost { namespace yap {
    ...
    inline char const * op_string(expr_kind kind)
    {
        ...
        case expr_kind::VCwise_and: return "&";
        case expr_kind::VCwise_or: return "|";
        case expr_kind::VCwise_xor: return "^";
        ...
        case expr_kind::VCwise_and_assign: return "&=";
        case expr_kind::VCwise_or_assign: return "|=";
        case expr_kind::VCwise_xor_assign: return "^=";
