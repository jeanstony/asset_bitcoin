...
namespace boost { namespace yap {
    ...
    */
    ...
    BOOST_YAP_USER_BINARY_OPERATOR(VCwise_and, expression, expression)        // &
    BOOST_YAP_USER_BINARY_OPERATOR(VCwise_or, expression, expression)         // |
    BOOST_YAP_USER_BINARY_OPERATOR(VCwise_xor, expression, expression)        // ^
    ...
    BOOST_YAP_USER_BINARY_OPERATOR(VCwise_and_assign, expression, expression) // &=
    BOOST_YAP_USER_BINARY_OPERATOR(VCwise_or_assign, expression, expression)  // |=
    BOOST_YAP_USER_BINARY_OPERATOR(VCwise_xor_assign, expression, expression) // ^=
