...
namespace boost { namespace yap { namespace detail {
    ...
    constexpr expr_arity arity_of()
    {
        ...
        case expr_kind::VCwise_and:        // &
        case expr_kind::VCwise_or:         // |
        case expr_kind::VCwise_xor:        // ^
        ...
        case expr_kind::VCwise_and_assign: // &=
        case expr_kind::VCwise_or_assign:  // |=
        case expr_kind::VCwise_xor_assign: // ^=
