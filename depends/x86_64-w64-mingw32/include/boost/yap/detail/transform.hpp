...
#define BOOST_YAP_BINARY_OPERATOR_CASE(op, op_name)                            \
    ...
    {                                                                          \
        ...
        BOOST_YAP_BINARY_OPERATOR_CASE(&, VCwise_and)
        BOOST_YAP_BINARY_OPERATOR_CASE(|, VCwise_or)
        BOOST_YAP_BINARY_OPERATOR_CASE (^, VCwise_xor)
...
//]
        ...
        BOOST_YAP_BINARY_OPERATOR_CASE(&=, VCwise_and_assign)
        BOOST_YAP_BINARY_OPERATOR_CASE(|=, VCwise_or_assign)
        BOOST_YAP_BINARY_OPERATOR_CASE(^=, VCwise_xor_assign)
