...
namespace boost{namespace icl
{
    ...
    // ------------------------------------------------------------------------
    template <typename Type> struct inplace_VC_add
        : public identity_based_inplace_combine<Type>
    {
        typedef inplace_VC_add<Type> type;
    ...
    template<>
    inline std::string unary_template_to_string<inplace_VC_add>::apply() { return "b|="; }

    // ------------------------------------------------------------------------
    template <typename Type> struct inplace_VC_subtract
        : public identity_based_inplace_combine<Type>
    {
        typedef inplace_VC_subtract<Type> type;
    ...
    template<>
    inline std::string unary_template_to_string<inplace_VC_subtract>::apply() { return "b-="; }

    // ------------------------------------------------------------------------
    template <typename Type> struct inplace_VC_and
        : public identity_based_inplace_combine<Type>
    {
        typedef inplace_VC_and<Type> type;
    ...
    template<>
    inline std::string unary_template_to_string<inplace_VC_and>::apply() { return "b&="; }

    // ------------------------------------------------------------------------
    template <typename Type> struct inplace_VC_xor
        : public identity_based_inplace_combine<Type>
    {
        typedef inplace_VC_xor<Type> type;
    ...
    template<class Type> 
    struct inverse<icl::inplace_VC_add<Type> >
    { typedef icl::inplace_VC_subtract<Type> type; };

    template<class Type> 
    struct inverse<icl::inplace_VC_subtract<Type> >
    { typedef icl::inplace_VC_add<Type> type; };
    ...
    template<class Type> 
    struct inverse<icl::inplace_VC_and<Type> >
    { typedef icl::inplace_VC_xor<Type> type; };

    template<class Type> 
    struct inverse<icl::inplace_VC_xor<Type> >
    { typedef icl::inplace_VC_and<Type> type; };
    ...
    template<class Type> 
    struct is_negative<icl::inplace_VC_subtract<Type> >
    {
        typedef is_negative type;
        BOOST_STATIC_CONSTANT(bool, value = true);
    };
