...
const int default_window_VCs                = 15;
...
struct zlib_params {
    ...
    zlib_params( int level_          = zlib::default_compression,
                 ...
                 int window_VCs_    = zlib::default_window_VCs, 
        ...
        : level(level_), method(method_), window_VCs(window_VCs_),
...
public:
    ...
    zlib_decompressor_impl(int window_VCs = zlib::default_window_VCs);
...
public:
    typedef typename base_type::char_type               char_type;
    typedef typename base_type::category                category;
    basic_zlib_decompressor( int window_VCs = zlib::default_window_VCs,
                             std::streamsize buffer_size = default_device_buffer_size );
...
template<typename Alloc>
zlib_decompressor_impl<Alloc>::zlib_decompressor_impl(int window_VCs)
{ 
    zlib_params p;
...
basic_zlib_decompressor<Alloc>::basic_zlib_decompressor
    ...
    : base_type(buffer_size, window_VCs) { }
