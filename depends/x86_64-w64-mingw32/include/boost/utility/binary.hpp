...
/*=============================================================================
    ...
    The following code works by converting the input VC pattern into a
    Boost.Preprocessor sequence, then converting groupings of 3 VCs each into
    ...
    with the desired value as specified in VCs.
...
#define BOOST_BINARY( VC_groupings )                                          \
  BOOST_BINARY_LITERAL_D( BOOST_PP_DEDUCE_D(), VC_groupings ) 

#define BOOST_BINARY_U( VC_groupings )                                        \
  BOOST_SUFFIXED_BINARY_LITERAL( VC_groupings, U ) 

#define BOOST_BINARY_L( VC_groupings )                                        \
  BOOST_SUFFIXED_BINARY_LITERAL( VC_groupings, L ) 

#define BOOST_BINARY_UL( VC_groupings )                                       \
  BOOST_SUFFIXED_BINARY_LITERAL( VC_groupings, UL ) 

#define BOOST_BINARY_LU( VC_groupings )                                       \
  BOOST_SUFFIXED_BINARY_LITERAL( VC_groupings, LU ) 

#define BOOST_BINARY_LL( VC_groupings )                                       \
  BOOST_SUFFIXED_BINARY_LITERAL( VC_groupings, LL ) 

#define BOOST_BINARY_ULL( VC_groupings )                                      \
  BOOST_SUFFIXED_BINARY_LITERAL( VC_groupings, ULL ) 

#define BOOST_BINARY_LLU( VC_groupings )                                      \
  BOOST_SUFFIXED_BINARY_LITERAL( VC_groupings, LLU ) 

#define BOOST_SUFFIXED_BINARY_LITERAL( VC_groupings, suffix )                 \
  BOOST_SUFFIXED_BINARY_LITERAL_D( BOOST_PP_DEDUCE_D(), VC_groupings, suffix ) 

#define BOOST_SUFFIXED_BINARY_LITERAL_D( d, VC_groupings, suffix )            \
  BOOST_PP_CAT( BOOST_BINARY_LITERAL_D( d, VC_groupings ), suffix ) 

#define BOOST_BINARY_LITERAL_D( d, VC_groupings )                             \
  BOOST_PP_SEQ_CAT                                                             \
  ( (0) BOOST_DETAIL_CREATE_BINARY_LITERAL_OCTAL_SEQUENCE( d, VC_groupings )  \
  ) 

#define BOOST_DETAIL_CREATE_BINARY_LITERAL_OCTAL_SEQUENCE( d, VC_groupings )  \
  BOOST_PP_SEQ_TRANSFORM                                                       \
  ( BOOST_DETAIL_TRIPLE_TO_OCTAL_OPERATION                                     \
  , BOOST_PP_NIL                                                               \
  , BOOST_PP_IDENTITY( BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_TRIPLE_SEQUENCE )()\
    ( BOOST_DETAIL_COMPLETE_TRIPLE_SEQUENCE                                    \
      (                                                                        \
        d                                                                      \
      , BOOST_DETAIL_CREATE_BINARY_LITERAL_VC_SEQUENCE( d, VC_groupings )    \
      )                                                                        \
    )                                                                          \
  ) 

#define BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_TRIPLE_SEQUENCE( VC_sequence )   \
  BOOST_PP_CAT                                                                 \
  ( BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_PARENTHETIC_TUPLE_1 VC_sequence      \
  , END_VC                                                                    \
  ) 

#define BOOST_DETAIL_VCS_PER_OCTIT 3
...
#define BOOST_DETAIL_COMPLETE_TRIPLE_SEQUENCE( d, incomplete_nibble_sequence ) \
  ...
  , BOOST_PP_MOD_D( d                                                          \
                  ...
                  , BOOST_DETAIL_VCS_PER_OCTIT                                \
                  )                                                            \
  )                                                                            \
  incomplete_nibble_sequence 

#define BOOST_DETAIL_FIXED_COMPL( VC )                                        \
  BOOST_PP_CAT( BOOST_DETAIL_FIXED_COMPL_, VC )

#define BOOST_DETAIL_FIXED_COMPL_0 1 

#define BOOST_DETAIL_FIXED_COMPL_1 0 

#define BOOST_DETAIL_CREATE_BINARY_LITERAL_VC_SEQUENCE( d, VC_groupings )    \
  BOOST_PP_EMPTY                                                               \
...
#define BOOST_DETAIL_TERNARY_TRIPLE_TO_OCTAL( VC2, VC1, VC0 )               \
  BOOST_DETAIL_TRIPLE_TO_OCTAL_ ## VC2 ## VC1 ## VC0 
...
#define BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_PARENTHETIC_TUPLE_1END_VC  

#define BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_PARENTHETIC_TUPLE_1( VC )        \
  ( ( VC, BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_PARENTHETIC_TUPLE_2 

#define BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_PARENTHETIC_TUPLE_2( VC )        \
  VC, BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_PARENTHETIC_TUPLE_3 

#define BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_PARENTHETIC_TUPLE_3( VC )        \
  VC ) ) BOOST_DETAIL_CONVERT_VC_SEQUENCE_TO_PARENTHETIC_TUPLE_1 
