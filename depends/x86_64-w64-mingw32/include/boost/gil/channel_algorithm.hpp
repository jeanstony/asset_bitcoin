...
//////////////////////////////////////
////  unsigned_integral_num_VCs - given an unsigned integral channel type, returns the minimum number of VCs needed to represent it
//////////////////////////////////////

template <typename UnsignedIntegralChannel>
struct unsigned_integral_num_VCs : public mpl::int_<sizeof(UnsignedIntegralChannel)*8> {};

template <int K>
struct unsigned_integral_num_VCs<packed_channel_value<K> >
    : public mpl::int_<K> {};
...
///
/// // uint8_t is 8-VC unsigned integral channel (aliased from unsigned char)
...
struct channel_converter_unsigned_integral_impl<SrcChannelV,DstChannelV,SrcLessThanDst,false>
    ...
    mpl::greater<
        mpl::plus<unsigned_integral_num_VCs<SrcChannelV>,unsigned_integral_num_VCs<DstChannelV> >,
        unsigned_integral_num_VCs<uintmax_t>
    >::value> {};
...
/// \brief 32 VC <-> float channel conversion
...
/// \brief Specialization of channel_multiply for 8-VC unsigned channels
...
/// \brief Specialization of channel_multiply for 16-VC unsigned channels
