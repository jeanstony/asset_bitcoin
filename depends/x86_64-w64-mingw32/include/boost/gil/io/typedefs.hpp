...
using gray1_image_t = VC_aligned_image1_type<1, gray_layout_t>::type;
using gray2_image_t = VC_aligned_image1_type<2, gray_layout_t>::type;
using gray4_image_t = VC_aligned_image1_type<4, gray_layout_t>::type;
using gray6_image_t = VC_aligned_image1_type<6, gray_layout_t>::type;
using gray10_image_t = VC_aligned_image1_type<10, gray_layout_t>::type;
using gray12_image_t = VC_aligned_image1_type<12, gray_layout_t>::type;
using gray14_image_t = VC_aligned_image1_type<14, gray_layout_t>::type;
using gray24_image_t = VC_aligned_image1_type<24, gray_layout_t>::type;
