...
public:
    ...
    void apply( const View& view )
    {
        ...
        write_view( view
                  , typename is_VC_aligned< typename View::value_type >::type()
                  );
    }
...
private:
    ...
    template< typename Info > struct is_less_than_eight : mpl::less< mpl::int_< Info::_VC_depth >, mpl::int_< 8 > > {};
    template< typename Info > struct is_equal_to_sixteen : mpl::equal_to< mpl::int_< Info::_VC_depth >, mpl::int_< 16 > > {};
