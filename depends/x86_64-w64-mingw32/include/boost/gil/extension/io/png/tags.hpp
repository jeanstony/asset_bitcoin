...
/// Defines type for VC depth method property.
struct png_VCdepth : property_base< int > {};
...
/// Defines type for significant VCs property.
struct png_significant_VCs : property_base< png_color_8 > {};
...
struct png_compression_window_VCs : property_base< int >
{
...
// true VCs
struct png_true_VCs : property_base< std::vector< png_color_8 > >
{};
...
struct png_info_base
{
    ...
    /// The VC depth per channel.
    png_VCdepth::type           _VC_depth;
    ...
    // Number of significant VCs
    /// The return value when reading significant VCs.
    png_return_value::type     _valid_significant_VCs;
    /// The significant VCs.
    png_significant_VCs::type _sig_VCs;
...
struct png_read_settings_base
{
    ...
    png_read_settings_base()
    {
        ...
        _read_number_of_significant_VCs = false;
    ...
    void set_read_members_true()
    {
        ...
        _read_number_of_significant_VCs = true;
    ...
    /// Enable reading significant VCs.
    bool _read_number_of_significant_VCs;
...
struct image_write_info< png_tag >  : public png_info_base
{
    image_write_info( const png_compression_type::type         compression_type        = png_compression_type::default_value
                    ...
                    , const png_compression_window_VCs::type  compression_window_VCs = png_compression_window_VCs::default_value
    ...
    , _compression_window_VCs( compression_window_VCs )
    ...
    png_compression_window_VCs::type _compression_window_VCs;
    png_compression_method::type      _compression_method;
