...
public:
    ...
    void read_header()
    {
        ...
        // get number of significant VCs for each color channel
        if( this->_settings._read_number_of_significant_VCs )
        {
            png_color_8p sig_VCs = png_color_8p( nullptr );

            this->_info._valid_significant_VCs = png_get_sVC( get_struct()
                                                              , get_info()
                                                              , &sig_VCs
                                                              );
