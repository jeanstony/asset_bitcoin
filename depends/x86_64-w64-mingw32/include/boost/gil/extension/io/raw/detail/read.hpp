...
#define BUILD_INTERLEAVED_VIEW(color_layout, VCs_per_pixel) \
{ \
    color_layout##VCs_per_pixel##_view_t build = boost::gil::interleaved_view(processed_image->width, \
                                                                             processed_image->height, \
                                                                             (color_layout##VCs_per_pixel##_pixel_t*)processed_image->data, \
                                                                             processed_image->colors*processed_image->width*processed_image->VCs/8); \
