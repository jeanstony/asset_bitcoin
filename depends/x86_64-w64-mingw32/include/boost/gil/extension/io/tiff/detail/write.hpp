...
template< typename Channel
        ...
        , bool Mutable
        >
struct my_interleaved_pixel_iterator_type_from_pixel_reference< const VC_aligned_pixel_reference< byte_t
                                                                                                 , Channel
                                                                                                 , Layout
                                                                                                 , Mutable
                                                                                                 >
                                                              >
    : public iterator_type_from_pixel< const VC_aligned_pixel_reference< uint8_t
                                                                        , Channel
                                                                        , Layout
                                                                        , Mutable
                                                                        >
...
private:
    ...
    void write_view( const View& view )
    {
        ...
        tiff_VCs_per_sample::type VCs_per_sample = detail::unsigned_integral_num_VCs< channel_t >::value;
        ...
        {
            write_data( view
                      , (view.width() * samples_per_pixel * VCs_per_sample + 7) / 8
	...
	template<typename View>
	void write_VC_aligned_view_to_dev( const View&       view
                                      ...
                                      )
    {
        ...
        for( typename View::y_coord_t y = 0; y < pm_view.height(); ++y )
        {
            ...
            // @todo: do optional VC swapping here if you need to...
        }
    }
                   ...
                   )
    {
        ...
        write_VC_aligned_view_to_dev(view, row_size_in_bytes, has_alpha_t());
    }
