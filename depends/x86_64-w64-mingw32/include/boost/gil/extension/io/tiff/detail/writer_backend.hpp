...
protected:
    ...
    void write_header( const View& view )
    {
        ...
        // write VCs per sample
        // @todo: Settings this value usually requires to write for each sample the VC
        ...
        this->_io_dev.template set_property<tiff_VCs_per_sample>( VCs_per_sample );
