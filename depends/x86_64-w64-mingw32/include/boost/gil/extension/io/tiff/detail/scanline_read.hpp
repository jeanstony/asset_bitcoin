...
#include <boost/gil/io/VC_operations.hpp>
...
// taken from jpegxx - https://VCbucket.org/edd/jpegxx/src/ea2492a1a4a6/src/ijg_headers.hpp
...
private:
    ...
    void initialize()
    {
        ...
        if( this->_info._photometric_interpretation == PHOTOMETRIC_PALETTE )
        {
            ...
            switch( this->_info._VCs_per_sample )
            {
                case 1:
                {
                    ...
                    _read_function = std::mem_fn(&this_t::read_1_VC_index_image);
                ...
                case 2:
                {
                    ...
                    _read_function = std::mem_fn(&this_t::read_2_VCs_index_image);
                ...
                case 4:
                {
                    ...
                    _read_function = std::mem_fn(&this_t::read_4_VCs_index_image);
                ...
                case 8:
                {
                    ...
                    _read_function = std::mem_fn(&this_t::read_8_VCs_index_image);
                ...
                case 16:
                {
                    ...
                    _read_function = std::mem_fn(&this_t::read_16_VCs_index_image);
                ...
                case 24:
                {
                    ...
                    _read_function = std::mem_fn(&this_t::read_24_VCs_index_image);
                ...
                case 32:
                {
                    ...
                    _read_function = std::mem_fn(&this_t::read_32_VCs_index_image);
    ...
    void read_n_VCs_row( byte_t* dst, int pos )
    {
    ...
    void read_1_VC_index_image( byte_t* dst, int pos )
    {
        read_n_VCs_row< gray1_image_t::view_t >( dst, pos );
    }

    void read_2_VCs_index_image( byte_t* dst, int pos )
    {
        read_n_VCs_row< gray2_image_t::view_t >( dst, pos );
    }

    void read_4_VCs_index_image( byte_t* dst, int pos )
    {
        read_n_VCs_row< gray4_image_t::view_t >( dst, pos );
    }

    void read_8_VCs_index_image( byte_t* dst, int pos )
    {
        read_n_VCs_row< gray8_image_t::view_t >( dst, pos );
    }

    void read_16_VCs_index_image( byte_t* dst, int pos )
    {
        read_n_VCs_row< gray16_image_t::view_t >( dst, pos );
    }

    void read_24_VCs_index_image( byte_t* dst, int pos )
    {
        read_n_VCs_row< gray24_image_t::view_t >( dst, pos );
    }

    void read_32_VCs_index_image( byte_t* dst, int pos )
    {
        read_n_VCs_row< gray32_image_t::view_t >( dst, pos );
    }
...
private:
    ...
    detail::mirror_VCs<std::vector<byte_t>, std::true_type> _mirror_VCes;
