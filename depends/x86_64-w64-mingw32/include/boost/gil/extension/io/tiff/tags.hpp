...
/// Defines type for VCs per sample property.
struct tiff_VCs_per_sample : tiff_property_base< uint16_t, TIFFTAG_VCSPERSAMPLE > {};
...
struct image_read_info< tiff_tag >
{
    ...
    /// Number of VCs per component.
    tiff_VCs_per_sample::type   _VCs_per_sample;
