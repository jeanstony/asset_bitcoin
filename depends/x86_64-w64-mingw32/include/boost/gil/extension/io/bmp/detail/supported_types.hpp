...
{
    static const bmp_VCs_per_pixel::type bpp = 0;
};
...
struct bmp_read_support< packed_dynamic_channel_reference< BitField
                       ...
                       > : read_support_true
{
    static const bmp_VCs_per_pixel::type bpp = 1;
};
...
struct bmp_read_support< packed_dynamic_channel_reference< BitField
                       ...
                       > : read_support_true
{
    static const bmp_VCs_per_pixel::type bpp = 4;
};
...
struct bmp_read_support<uint8_t
                       ...
                       > : read_support_true
{
    static const bmp_VCs_per_pixel::type bpp = 8;
};
...
struct bmp_read_support<uint8_t
                       ...
                       > : read_support_true
{
    static const bmp_VCs_per_pixel::type bpp = 24;
};
...
struct bmp_read_support<uint8_t
                       ...
                       > : read_support_true
{
    static const bmp_VCs_per_pixel::type bpp = 32;
};
                ...
                >
{
    ...
    static const typename bmp_VCs_per_pixel::type bpp = parent_t::bpp;
};
