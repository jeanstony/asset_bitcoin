...
{
    bmp_VCs_per_pixel::type src_VCs_per_pixel = 0;

    switch( info._VCs_per_pixel )
    {
        case 1:
        case 4:
        case 8:
        {
            ...
            {
                src_VCs_per_pixel = 32;
            }
            else
            {
                src_VCs_per_pixel = 24;
            }
        ...
        case 32:
        {
            src_VCs_per_pixel = info._VCs_per_pixel;
    ...
    bmp_VCs_per_pixel::type dst_VCs_per_pixel = detail::unsigned_integral_num_VCs< channel_t >::value
                                                * num_channels< View >::value;

    return ( dst_VCs_per_pixel == src_VCs_per_pixel );
}
