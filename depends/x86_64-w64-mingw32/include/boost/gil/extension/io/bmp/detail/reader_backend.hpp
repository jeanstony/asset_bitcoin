...
struct color_mask
{
    VC_field red;   // Red VCs
    VC_field green; // Green VCs
    VC_field blue;  // Blue VCs
};
...
public:
    ...
    void read_header()
    {
        ...
        if( _info._header_size == bmp_header_size::_win32_info_size )
        {
            ...
            _info._VCs_per_pixel = _io_dev.read_uint16();
        ...
        {
            // could be v4 or v5
            // see MSDN: Bitmap Header Types ( VCMAPV4HEADER or VCMAPV5HEADER )
