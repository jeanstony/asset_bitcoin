...
private:
    ...
    {
        using y_t = typename View_Dst::y_coord_t;
        using is_VC_aligned_t = typename is_VC_aligned<typename View_Src::value_type>::type;
        ...
        detail::negate_VCs
            <
                ...
                std::integral_constant<bool, is_VC_aligned_t::value> // TODO: Simplify after MPL removal
            > neg;
