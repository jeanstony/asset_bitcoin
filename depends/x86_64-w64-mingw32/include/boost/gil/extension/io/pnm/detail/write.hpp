...
public:
    ...
    void apply( const View& view )
    {
        ...
        unsigned int type = get_type< num_channels< View >::value >( is_VC_aligned< pixel_t >() );
...
private:
    ...
    unsigned int get_type( mpl::true_  /* is_VC_aligned */ )
    {
    ...
    template< int Channels >
    unsigned int get_type( mpl::false_ /* is_VC_aligned */ )
    {
        return boost::mpl::if_c< Channels == 1
                   ...
                   )
    {
        ...
        detail::negate_VCs<byte_vector_t, std::true_type> negate;
        detail::mirror_VCs<byte_vector_t, std::true_type> mirror;
