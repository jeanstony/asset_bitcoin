...
/// Defines type for color map VC depth property.
...
/// Defines type for image VC depth property.
...
struct targa_screen_origin_VC : property_base< bool > {};
...
struct image_read_info< targa_tag >
{
    ...
    targa_depth::type _VCs_per_pixel;
    ...
    targa_screen_origin_VC::type _screen_origin_VC;
