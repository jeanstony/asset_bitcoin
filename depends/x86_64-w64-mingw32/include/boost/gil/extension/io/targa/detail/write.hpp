...
private:
    ...
    {
        uint8_t VC_depth = static_cast<uint8_t>( num_channels<View>::value * 8 );
        ...
        this->_io_dev.write_uint8( VC_depth );

        if( 32 == VC_depth )
        {
            this->_io_dev.write_uint8( 8 ); // 8-VC alpha channel descriptor
        }
        else
        {
