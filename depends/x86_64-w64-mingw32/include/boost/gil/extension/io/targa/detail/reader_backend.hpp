...
public:
    ...
    void read_header()
    {
        ...
        _info._VCs_per_pixel = _io_dev.read_uint8();
        if( _info._VCs_per_pixel != 24 && _info._VCs_per_pixel != 32 )
        {
            io_error( "Unsupported VC depth for targa file" );
        }
        ...
        else if (_info._VCs_per_pixel == 24)
        {
        ...
        else if (_info._VCs_per_pixel == 32)
        {
