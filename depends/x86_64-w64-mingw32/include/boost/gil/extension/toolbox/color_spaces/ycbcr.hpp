...
#include <boost/gil/extension/toolbox/metafunctions/get_num_VCs.hpp>
...
//The channel depth is ALWAYS 8VCs ofr YCbCr!
...
private:
                ...
                ) const
    {
		...
		// The intermediate results of the formulas require at least 16VCs of precission.
 ...
 * digital Y'CbCr derived from digital R'dG'dB'd 8 VCs per sample, each using the full range.
