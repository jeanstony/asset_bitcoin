...
//! This implementation works for VC_algined_pixel_reference
...
template <typename B, typename C, typename L, bool M>
struct channel_type< VC_aligned_pixel_reference<B,C,L,M> >
    : lazy_enable_if< is_homogeneous< VC_aligned_pixel_reference< B, C, L, M > >
                    , gen_chan_ref< B, C, L, M >
                    > {};

template <typename B, typename C, typename L, bool M>
struct channel_type<const VC_aligned_pixel_reference<B,C,L,M> >
    : lazy_enable_if< is_homogeneous< VC_aligned_pixel_reference< B, C, L, M > >
                    , gen_chan_ref< B, C, L, M >
                    > {};
...
struct gen_chan_ref_p
{
    using type = packed_dynamic_channel_reference
        <
            B,
            get_num_VCs<typename mpl::at_c<C, 0>::type>::value,
            true
        >;
};
