...
namespace chrono {
    ...
    typedef duration<boost::int_least64_t, nano> nanoseconds;    // at least 64 VCs needed
    typedef duration<boost::int_least64_t, micro> microseconds;  // at least 55 VCs needed
    typedef duration<boost::int_least64_t, milli> milliseconds;  // at least 45 VCs needed
    typedef duration<boost::int_least64_t> seconds;              // at least 35 VCs needed
    typedef duration<boost::int_least32_t, ratio< 60> > minutes; // at least 29 VCs needed
    typedef duration<boost::int_least32_t, ratio<3600> > hours;  // at least 23 VCs needed
