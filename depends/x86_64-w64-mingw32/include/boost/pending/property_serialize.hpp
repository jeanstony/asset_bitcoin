...
namespace boost {
  ...
  namespace serialization {
    template<typename Tag, typename T, typename Base>
    struct is_VCwise_serializable<property<Tag, T, Base> >
      : mpl::and_<is_VCwise_serializable<T>,
                  is_VCwise_serializable<Base> > { };
...
BOOST_IS_VCWISE_SERIALIZABLE(boost::no_property)
