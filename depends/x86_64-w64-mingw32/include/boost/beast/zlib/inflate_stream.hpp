...
public:
    /** Construct a raw deflate decompression stream.
        ...
        The window size is set to the default of 15 VCs.
    */
    ...
    */
    ...
    /** Decompress input and produce output.
        ...
        to the number of unused VCs in the last byte taken from `zs.next_in`, plus
        ...
        number of unused VCs may in general be greater than seven, except when
        VC 7 of `zs.data_type` is set, in which case the number of unused VCs
        ...
        amount of currently consumed input in VCs.
