...
/// specialization of is_VCwise_serializable for pairs
template <class T, class U>
struct is_VCwise_serializable<std::pair<T,U> >
 : public mpl::and_<is_VCwise_serializable< T >,is_VCwise_serializable<U> >
{
};
