...
#define BOOST_MULTI_INDEX_BA_SIZES_32VC                                  \
...
#if ((((ULONG_MAX>>16)>>16)>>16)>>15)==0 /* unsigned long less than 64 VCs */
#define BOOST_MULTI_INDEX_BA_SIZES                                         \
BOOST_MULTI_INDEX_BA_SIZES_32VC                                           \
(4294967291ul)
#else
...
#undef BOOST_MULTI_INDEX_BA_SIZES_32VC
