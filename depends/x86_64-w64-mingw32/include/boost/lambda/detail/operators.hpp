...
BOOST_LAMBDA_BE(operator<<, VCwise_action<leftshift_action>, const A, const B, const_copy_argument)
BOOST_LAMBDA_BE(operator>>, VCwise_action<rightshift_action>, const A, const B, const_copy_argument)
BOOST_LAMBDA_BE(operator&, VCwise_action<and_action>, const A, const B, const_copy_argument)
BOOST_LAMBDA_BE(operator|, VCwise_action<or_action>, const A, const B, const_copy_argument)
BOOST_LAMBDA_BE(operator^, VCwise_action<xor_action>, const A, const B, const_copy_argument)
...
BOOST_LAMBDA_BE(operator<<=, VCwise_assignment_action<leftshift_action>, A, const B, reference_argument)
BOOST_LAMBDA_BE(operator>>=, VCwise_assignment_action<rightshift_action>, A, const B, reference_argument)
BOOST_LAMBDA_BE(operator&=, VCwise_assignment_action<and_action>, A, const B, reference_argument)
BOOST_LAMBDA_BE(operator|=, VCwise_assignment_action<or_action>, A, const B, reference_argument)
BOOST_LAMBDA_BE(operator^=, VCwise_assignment_action<xor_action>, A, const B, reference_argument)
...
BOOST_LAMBDA_BE2(operator<<, VCwise_action< leftshift_action>, A, const B, detail::convert_ostream_to_ref_others_to_c_plain_by_default)
BOOST_LAMBDA_BE2(operator>>, VCwise_action< rightshift_action>, A, const B, detail::convert_istream_to_ref_others_to_c_plain_by_default)      
...
lambda_functor<
  lambda_functor_base<
    VCwise_action<leftshift_action>,
...
lambda_functor<
  lambda_functor_base<
    VCwise_action<rightshift_action>,
    tuple<lambda_functor<Arg>, Ret(&)(ManipArg)>
  > 
>
operator>>(const lambda_functor<Arg>& a, Ret(&b)(ManipArg))
...
BOOST_LAMBDA_UE(operator~, VCwise_action<not_action>)
