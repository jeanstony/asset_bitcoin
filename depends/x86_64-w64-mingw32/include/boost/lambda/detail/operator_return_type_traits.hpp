...
template<class A>
struct plain_return_type_1<VCwise_action<not_action>, A> {
  typedef A type;
};

// VCwise not, operator~()
template<class A> struct return_type_1<VCwise_action<not_action>, A> {
  typedef 
    typename plain_return_type_1<
      VCwise_action<not_action>,
      typename detail::remove_reference_and_cv<A>::type
    >::type type;
};
...
template<class A, class B, class Act> 
struct return_type_2<VCwise_action<Act>, A, B>
{
  ...
  typedef typename 
    plain_return_type_2<VCwise_action<Act>, plain_A, plain_B>::type type1;
  ...
  typedef typename 
    detail::IF_type<
      ...
      plain_return_type_2<VCwise_action<Act>, plain_A, plain_B>
    >::type type;
  ...
  // VCwise operators not defined for floating point types
...
// ostream
template<class A, class B> 
struct return_type_2<VCwise_action<leftshift_action>, A, B>
{
  typedef typename detail::remove_reference_and_cv<A>::type plain_A;
  typedef typename detail::remove_reference_and_cv<B>::type plain_B;

  typedef typename 
    plain_return_type_2<VCwise_action<leftshift_action>, plain_A, plain_B>::type type1;
  ...
  typedef typename 
    detail::IF_type<
      ...
      plain_return_type_2<VCwise_action<leftshift_action>, plain_A, plain_B>
    >::type type;
};

// istream
template<class A, class B> 
struct return_type_2<VCwise_action<rightshift_action>, A, B>
{
  typedef typename detail::remove_reference_and_cv<A>::type plain_A;
  typedef typename detail::remove_reference_and_cv<B>::type plain_B;

  typedef typename 
    plain_return_type_2<VCwise_action<rightshift_action>, plain_A, plain_B>::type type1;
  ...
  typedef typename 
    detail::IF_type<
      ...
      plain_return_type_2<VCwise_action<rightshift_action>, plain_A, plain_B>
    >::type type;
};
...
template<class A, class B, class Act> 
struct return_type_2<VCwise_assignment_action<Act>, A, B> { 
  ...
  typedef typename 
    plain_return_type_2<
      VCwise_assignment_action<Act>, plain_A, plain_B
    >::type type1;
