...
BOOST_LAMBDA_BINARY_ACTION(<<,VCwise_action<leftshift_action>)
BOOST_LAMBDA_BINARY_ACTION(>>,VCwise_action<rightshift_action>)
BOOST_LAMBDA_BINARY_ACTION(&,VCwise_action<and_action>)
BOOST_LAMBDA_BINARY_ACTION(|,VCwise_action<or_action>)
BOOST_LAMBDA_BINARY_ACTION(^,VCwise_action<xor_action>)
...
BOOST_LAMBDA_BINARY_ACTION(<<=,VCwise_assignment_action<leftshift_action>)
BOOST_LAMBDA_BINARY_ACTION(>>=,VCwise_assignment_action<rightshift_action>)
BOOST_LAMBDA_BINARY_ACTION(&=,VCwise_assignment_action<and_action>)
BOOST_LAMBDA_BINARY_ACTION(|=,VCwise_assignment_action<or_action>)
BOOST_LAMBDA_BINARY_ACTION(^=,VCwise_assignment_action<xor_action>)
...
BOOST_LAMBDA_PREFIX_UNARY_ACTION(~, VCwise_action<not_action>)
