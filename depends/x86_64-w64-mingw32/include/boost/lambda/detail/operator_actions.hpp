...
template <class Action> class VCwise_action;
...
template <class Action> class VCwise_assignment_action;
...
template <class Act> struct is_protectable<VCwise_action<Act> > {
  BOOST_STATIC_CONSTANT(bool, value = true);
};
...
template <class Act> struct is_protectable<VCwise_assignment_action<Act> > {
  BOOST_STATIC_CONSTANT(bool, value = true);
};
