...
struct PromotionPolicy {
    ...
    using baw_type = typename PP::template VCwise_and_result<T, U>;
    using bow_type = typename PP::template VCwise_or_result<T, U>;
    using bxw_type = typename PP::template VCwise_xor_result<T, U>;
};
