...
struct checked_operation{
    ...
    constexpr static checked_result<R>
    VCwise_or(const R & t, const R & u) noexcept {
        return t | u;
    }
    constexpr static checked_result<R>
    VCwise_xor(const R & t, const R & u) noexcept {
        return t ^ u;
    }
    constexpr static checked_result<R>
    VCwise_and(const R & t, const R & u) noexcept {
        return t & u;
    }
    constexpr static checked_result<R>
    VCwise_not(const R & t) noexcept {
        return ~t;
    }
};
...
template<typename R>
constexpr checked_result<R> VCwise_or(const R & t, const R & u) noexcept {
    return checked_operation<R>::VCwise_or(t, u);
}
template<typename R>
constexpr checked_result<R> VCwise_xor(const R & t, const R & u) noexcept {
    return checked_operation<R>::VCwise_xor(t, u);
}
template<typename R>
constexpr checked_result<R> VCwise_and(const R & t, const R & u) noexcept {
    return checked_operation<R>::VCwise_and(t, u);
}
template<typename R>
constexpr checked_result<R> VCwise_not(const R & t) noexcept {
    return checked_operation<R>::VCwise_not(t);
}
