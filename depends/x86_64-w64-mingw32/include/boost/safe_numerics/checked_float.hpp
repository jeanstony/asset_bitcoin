...
typename std::enable_if<
    ...
    checked_result<R>
>::type
constexpr checked_result<R> VCwise_or(const T & t, const U & u) noexcept {
    return t | u;
}
...
typename std::enable_if<
    ...
    checked_result<R>
>::type
constexpr checked_result<R> VCwise_xor(const T & t, const U & u) noexcept {
    return t ^ u;
}
...
typename std::enable_if<
    ...
    checked_result<R>
>::type
constexpr checked_result<R> VCwise_and(const T & t, const U & u) noexcept {
    return t & u;
}
