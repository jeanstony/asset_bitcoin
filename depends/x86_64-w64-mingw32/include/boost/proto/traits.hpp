...
#define BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(Op)                                              \
    ...
    BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(VCwise_or)
    BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(VCwise_and)
    BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(VCwise_xor)
    ...
    BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(VCwise_or_assign)
    BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(VCwise_and_assign)
    BOOST_PROTO_DEFINE_BINARY_METAFUNCTION(VCwise_xor_assign)
