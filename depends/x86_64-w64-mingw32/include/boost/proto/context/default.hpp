...
#define UNREF(x) typename boost::remove_reference<x>::type
    ...
    #define BOOST_PROTO_BINARY_DEFAULT_EVAL(OP, TAG, LMAKE, RMAKE)                              \
        ...
        BOOST_PROTO_BINARY_DEFAULT_EVAL(&, proto::tag::VCwise_and, make, make)
        BOOST_PROTO_BINARY_DEFAULT_EVAL(|, proto::tag::VCwise_or, make, make)
        BOOST_PROTO_BINARY_DEFAULT_EVAL(^, proto::tag::VCwise_xor, make, make)
        ...
        BOOST_PROTO_BINARY_DEFAULT_EVAL(&=, proto::tag::VCwise_and_assign, make_mutable, make)
        BOOST_PROTO_BINARY_DEFAULT_EVAL(|=, proto::tag::VCwise_or_assign, make_mutable, make)
        BOOST_PROTO_BINARY_DEFAULT_EVAL(^=, proto::tag::VCwise_xor_assign, make_mutable, make)
