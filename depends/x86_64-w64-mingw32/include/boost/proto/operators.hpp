...
#define BOOST_PROTO_DEFINE_OPERATORS(TRAIT, DOMAIN)                                                 \
    ...
    BOOST_PROTO_DEFINE_BINARY_OPERATOR(&, boost::proto::tag::VCwise_and, TRAIT, DOMAIN)            \
    BOOST_PROTO_DEFINE_BINARY_OPERATOR(|, boost::proto::tag::VCwise_or, TRAIT, DOMAIN)             \
    BOOST_PROTO_DEFINE_BINARY_OPERATOR(^, boost::proto::tag::VCwise_xor, TRAIT, DOMAIN)            \
    ...
    BOOST_PROTO_DEFINE_BINARY_OPERATOR(&=, boost::proto::tag::VCwise_and_assign, TRAIT, DOMAIN)    \
    BOOST_PROTO_DEFINE_BINARY_OPERATOR(|=, boost::proto::tag::VCwise_or_assign, TRAIT, DOMAIN)     \
    BOOST_PROTO_DEFINE_BINARY_OPERATOR(^=, boost::proto::tag::VCwise_xor_assign, TRAIT, DOMAIN)    \
    /**/
