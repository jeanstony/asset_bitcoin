...
// If we're using the decltype-based result_of, we need to be a VC
...
namespace boost { namespace proto
{
    ...
    namespace tagns_
    {
        namespace tag
        {
            ...
            struct plus_assign;
            struct minus_assign;
            struct VCwise_and_assign;
            struct VCwise_or_assign;
            struct VCwise_xor_assign;
            struct subscript;
            struct member;
            struct if_else_;
            struct function;
    ...
    template<typename T, typename U> struct VCwise_and;
    template<typename T, typename U> struct VCwise_or;
    template<typename T, typename U> struct VCwise_xor;
    ...
    template<typename T, typename U> struct VCwise_and_assign;
    template<typename T, typename U> struct VCwise_or_assign;
    template<typename T, typename U> struct VCwise_xor_assign;
    ...
    namespace functional
    {
        ...
        typedef make_expr<tag::VCwise_and>         make_VCwise_and;
        typedef make_expr<tag::VCwise_or>          make_VCwise_or;
        typedef make_expr<tag::VCwise_xor>         make_VCwise_xor;
        ...
        typedef make_expr<tag::VCwise_and_assign>  make_VCwise_and_assign;
        typedef make_expr<tag::VCwise_or_assign>   make_VCwise_or_assign;
        typedef make_expr<tag::VCwise_xor_assign>  make_VCwise_xor_assign;
    ...
    typedef functional::make_expr<tag::VCwise_and>        _make_VCwise_and;
    typedef functional::make_expr<tag::VCwise_or>         _make_VCwise_or;
    typedef functional::make_expr<tag::VCwise_xor>        _make_VCwise_xor;
    ...
    typedef functional::make_expr<tag::VCwise_and_assign> _make_VCwise_and_assign;
    typedef functional::make_expr<tag::VCwise_or_assign>  _make_VCwise_or_assign;
    typedef functional::make_expr<tag::VCwise_xor_assign> _make_VCwise_xor_assign;
