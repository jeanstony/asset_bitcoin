...
BOOST_TYPEOF_REGISTER_TYPE(boost::proto::tag::VCwise_and)
BOOST_TYPEOF_REGISTER_TYPE(boost::proto::tag::VCwise_or)
BOOST_TYPEOF_REGISTER_TYPE(boost::proto::tag::VCwise_xor)
...
BOOST_TYPEOF_REGISTER_TYPE(boost::proto::tag::VCwise_and_assign)
BOOST_TYPEOF_REGISTER_TYPE(boost::proto::tag::VCwise_or_assign)
BOOST_TYPEOF_REGISTER_TYPE(boost::proto::tag::VCwise_xor_assign)
