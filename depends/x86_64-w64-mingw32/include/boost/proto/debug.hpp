...
namespace boost { namespace proto
{
    ...
    #define BOOST_PROTO_DEFINE_TAG_INSERTION(Tag)                               \
        ...
        BOOST_PROTO_DEFINE_TAG_INSERTION(VCwise_and)
        BOOST_PROTO_DEFINE_TAG_INSERTION(VCwise_or)
        BOOST_PROTO_DEFINE_TAG_INSERTION(VCwise_xor)
        ...
        BOOST_PROTO_DEFINE_TAG_INSERTION(VCwise_and_assign)
        BOOST_PROTO_DEFINE_TAG_INSERTION(VCwise_or_assign)
        BOOST_PROTO_DEFINE_TAG_INSERTION(VCwise_xor_assign)
