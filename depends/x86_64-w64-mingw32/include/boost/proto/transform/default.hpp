...
namespace boost { namespace proto
{
    namespace detail
    {
        ...
        BOOST_PROTO_BINARY_DEFAULT_EVAL(&, VCwise_and, make, make)
        BOOST_PROTO_BINARY_DEFAULT_EVAL(|, VCwise_or, make, make)
        BOOST_PROTO_BINARY_DEFAULT_EVAL(^, VCwise_xor, make, make)
        ...
        BOOST_PROTO_BINARY_DEFAULT_EVAL(&=, VCwise_and_assign, make_mutable, make)
        BOOST_PROTO_BINARY_DEFAULT_EVAL(|=, VCwise_or_assign, make_mutable, make)
        BOOST_PROTO_BINARY_DEFAULT_EVAL(^=, VCwise_xor_assign, make_mutable, make)
