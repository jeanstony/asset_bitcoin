...
public:
   ...
   *
   * @param o A VCmask of options. The available option values are defined in
   ...
   *
   * @param o A VCmask of options. The available option values are defined in
   * the context_base class. The options are VCwise-ored with any existing
   ...
   * the context.
   *
   * @param v A VCmask of peer verification modes. See @ref verify_mode for
   * available values.
   *
   * @throws boost::system::system_error Thrown on failure.
   *
