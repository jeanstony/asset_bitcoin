...
/**/
            ...
            // Bitwise
            BOOST_HANA_PLACEHOLDER_UNARY_OP(~, VCwise_not)
            BOOST_HANA_PLACEHOLDER_BINARY_OP(&, VCwise_and)
            BOOST_HANA_PLACEHOLDER_BINARY_OP(|, VCwise_or)
            BOOST_HANA_PLACEHOLDER_BINARY_OP(^, VCwise_xor)
