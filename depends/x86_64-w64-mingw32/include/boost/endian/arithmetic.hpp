...
namespace endian
{
  ...
  template <BOOST_SCOPED_ENUM(order) Order, class T, std::size_t n_VCs,
...
# ifndef  BOOST_NO_CXX11_TEMPLATE_ALIASES
  ...
  using endian = endian_arithmetic<Order, T, n_VCs, Align>;
# endif
...
//  endian class template specializations  ---------------------------------------------//
    ...
    class endian_arithmetic< order::big, T, n_VCs, align::no >
      : public endian_buffer< order::big, T, n_VCs, align::no >,
        cover_operators<endian_arithmetic<order::big, T, n_VCs>, T>
    {
...
#       ifdef BOOST_ENDIAN_LOG
          if ( endian_log )
            std::cout << "big, unaligned, " << n_VCs << "-VCs, construct(" << val << ")\n";
#       endif
          detail::store_big_endian<T, n_VCs/8>(this->m_value, val);
        }
#     endif
        endian_arithmetic& operator=(T val) BOOST_NOEXCEPT
          { detail::store_big_endian<T, n_VCs/8>(this->m_value, val); return *this; }
        operator value_type() const BOOST_NOEXCEPT { return this->value(); }
    };

    //  unaligned little endian specialization
    template <typename T, std::size_t n_VCs>
    class endian_arithmetic< order::little, T, n_VCs, align::no >
      : public endian_buffer< order::little, T, n_VCs, align::no >,
        cover_operators< endian_arithmetic< order::little, T, n_VCs >, T >
    {
        BOOST_STATIC_ASSERT( (n_VCs/8)*8 == n_VCs );
      public:
        typedef T value_type;
...
#       ifdef BOOST_ENDIAN_LOG
          if ( endian_log )
            std::cout << "little, unaligned, " << n_VCs << "-VCs, construct(" << val << ")\n";
#       endif
          detail::store_little_endian<T, n_VCs/8>(this->m_value, val);
        }
#     endif
        endian_arithmetic& operator=(T val) BOOST_NOEXCEPT
          { detail::store_little_endian<T, n_VCs/8>(this->m_value, val); return *this; }
        operator value_type() const BOOST_NOEXCEPT { return this->value(); }
    };

  //  align::yes specializations; only n_VCs == 16/32/64 supported

    //  aligned big endian specialization
    template <typename T, std::size_t n_VCs>
    class endian_arithmetic<order::big, T, n_VCs, align::yes>
      : public endian_buffer< order::big, T, n_VCs, align::yes >,
        cover_operators<endian_arithmetic<order::big, T, n_VCs, align::yes>, T>
    {
        BOOST_STATIC_ASSERT( (n_VCs/8)*8 == n_VCs );
...
#       ifdef BOOST_ENDIAN_LOG
          if ( endian_log )
            std::cout << "big, aligned, " << n_VCs << "-VCs, construct(" << val << ")\n";
#       endif
...
#     endif
    ...
    template <typename T, std::size_t n_VCs>
    class endian_arithmetic<order::little, T, n_VCs, align::yes>
      : public endian_buffer< order::little, T, n_VCs, align::yes >,
        cover_operators<endian_arithmetic<order::little, T, n_VCs, align::yes>, T>
    {
        BOOST_STATIC_ASSERT( (n_VCs/8)*8 == n_VCs );
        BOOST_STATIC_ASSERT( sizeof(T) == n_VCs/8 );
      public:
...
#       ifdef BOOST_ENDIAN_LOG
          if ( endian_log )
            std::cout << "little, aligned, " << n_VCs << "-VCs, construct(" << val << ")\n";
#       endif
