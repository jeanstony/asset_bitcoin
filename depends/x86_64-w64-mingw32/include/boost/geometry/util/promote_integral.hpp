...
template <typename T>
struct VC_size<T, true>
    : boost::mpl::size_t<(CHAR_VC * sizeof(T))>
{};
...
struct promote_to_larger
{
    ...
    typedef typename boost::mpl::if_c
        <
            (VC_size<current_type>::type::value >= MinSize),
            current_type,
...
private:
    ...
    typedef detail::promote_integral::VC_size<T> VC_size_type;
    ...
    typedef typename boost::mpl::if_c
        <
            ...
            boost::mpl::size_t<(2 * VC_size_type::value)>,
            typename boost::mpl::if_c
                <
                    is_unsigned,
                    boost::mpl::size_t<(2 * VC_size_type::value + 1)>,
                    boost::mpl::size_t<(2 * VC_size_type::value - 1)>
                >::type
        >::type min_VC_size_type;
