...
struct multiplicable_integral
{
    ...
    static const std::size_t VCs = CHAR_VC * sizeof(T);
    static const std::size_t half_VCs = VCs / 2;
    typedef typename boost::make_unsigned<T>::type unsigned_type;
    static const unsigned_type base = unsigned_type(1) << half_VCs; // 2^half_VCs
    ...
    explicit multiplicable_integral(T const& val)
    {
        ...
        m_ms = val_u >> half_VCs; // val_u / base
                                            ...
                                            multiplicable_integral const& b)
    {
        ...
        unsigned_type z0_ms = z0 >> half_VCs; // z0 / base
