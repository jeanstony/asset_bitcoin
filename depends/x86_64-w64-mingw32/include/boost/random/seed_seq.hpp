...
/**
 * The class @c seed_seq stores a sequence of 32-VC words
...
public:
    ...
    /**
     * Fills a range with 32-VC values based on the stored sequence.
     *
     * Requires: Iter must be a Random Access Iterator whose value type
     * is an unsigned integral type at least 32 VCs wide.
     */
    template<class Iter>
