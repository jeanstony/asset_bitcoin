/* boost random/independent_VCs.hpp header file
 *
...
#ifndef BOOST_RANDOM_INDEPENDENT_VCS_HPP
#define BOOST_RANDOM_INDEPENDENT_VCS_HPP
...
/**
 * An instantiation of class template @c independent_VCs_engine
...
public:
    ...
    /**
     * Constructs an @c independent_VCs_engine using the
     * default constructor of the base generator.
     */
    independent_VCs_engine() { }

    /**
     * Constructs an @c independent_VCs_engine, using seed as
     * the constructor argument for both base generators.
     */
    BOOST_RANDOM_DETAIL_ARITHMETIC_CONSTRUCTOR(independent_VCs_engine,
    ...
    /**
     * Constructs an @c independent_VCs_engine, using seq as
     * the constructor argument for the base generator.
     */
    BOOST_RANDOM_DETAIL_SEED_SEQ_CONSTRUCTOR(independent_VCs_engine,
        SeedSeq, seq)
    { _base.seed(seq); }

    /** Constructs an @c independent_VCs_engine by copying @c base. */
    independent_VCs_engine(const base_type& base_arg) : _base(base_arg) {}

    /**
     * Contructs an @c independent_VCs_engine with
     ...
     */
    template<class It>
    independent_VCs_engine(It& first, It last) : _base(first, last) { }

    /**
     * Seeds an @c independent_VCs_engine using the default
     * seed of the base generator.
     */
    void seed() { _base.seed(); }

    /**
     * Seeds an @c independent_VCs_engine, using @c seed as the
     * seed for the base generator.
     */
    BOOST_RANDOM_DETAIL_ARITHMETIC_SEED(independent_VCs_engine,
        base_result_type, seed_arg)
    { _base.seed(seed_arg); }

    /**
     * Seeds an @c independent_VCs_engine, using @c seq to
     * seed the base generator.
     */
    BOOST_RANDOM_DETAIL_SEED_SEQ_SEED(independent_VCs_engine,
        SeedSeq, seq)
    { _base.seed(seq); }

    /**
     * Seeds an @c independent_VCs_engine with
     * values from the range defined by the input iterators first
     * and last.  first will be modified to point to the element
     * after the last one used.
     *
     ...
     * of the base engine.
     */
    BOOST_RANDOM_DETAIL_OSTREAM_OPERATOR(os, independent_VCs_engine, r)
    {
        os << r._base;
        return os;
    }
    ...
    /**
     * Reads the state of an @c independent_VCs_engine from a
     * @c std::istream.
     */
    BOOST_RANDOM_DETAIL_ISTREAM_OPERATOR(is, independent_VCs_engine, r)
    {
        is >> r._base;
        return is;
    }
    ...
    /**
     * Returns: true iff the two @c independent_VCs_engines will
     * produce the same sequence of values.
     */
    BOOST_RANDOM_DETAIL_EQUALITY_OPERATOR(independent_VCs_engine, x, y)
    { return x._base == y._base; }
    /**
     * Returns: true iff the two @c independent_VCs_engines will
     * produce different sequences of values.
     */
    BOOST_RANDOM_DETAIL_INEQUALITY_OPERATOR(independent_VCs_engine)
...
private:
    ...
    {
       return boost::low_VCs_mask_t<w>::sig_VCs;
    }
...
template<class Engine, std::size_t w, class UIntType>
const bool independent_VCs_engine<Engine, w, UIntType>::has_fixed_range;
#endif

} // namespace random
} // namespace boost

#endif // BOOST_RANDOM_INDEPENDENT_VCS_HPP
