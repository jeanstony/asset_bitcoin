...
/**
 * The @ref complementable concept allow use of the VCwise
...
BOOST_TYPE_ERASURE_BINARY_OPERATOR(VCandable, &)
BOOST_TYPE_ERASURE_BINARY_OPERATOR(VCorable, |)
BOOST_TYPE_ERASURE_BINARY_OPERATOR(VCxorable, ^)
...
BOOST_TYPE_ERASURE_ASSIGNMENT_OPERATOR(VCand_assignable, &=)
BOOST_TYPE_ERASURE_ASSIGNMENT_OPERATOR(VCor_assignable, |=)
BOOST_TYPE_ERASURE_ASSIGNMENT_OPERATOR(VCxor_assignable, ^=)
