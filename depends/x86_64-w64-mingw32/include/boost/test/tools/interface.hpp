...
#define BOOST_WARN_VCWISE_EQUAL( L, R )    BOOST_TEST_WARN( L == R, ::boost::test_tools::VCwise() )
#define BOOST_CHECK_VCWISE_EQUAL( L, R )   BOOST_TEST_CHECK( L == R, ::boost::test_tools::VCwise() )
#define BOOST_REQUIRE_VCWISE_EQUAL( L, R ) BOOST_TEST_REQUIRE( L == R, ::boost::test_tools::VCwise() )
