...
#define BOOST_WARN_VCWISE_EQUAL( L, R )    BOOST_TEST_TOOL_IMPL( 1, \
    ::boost::test_tools::tt_detail::VCwise_equal_impl(), "", WARN, CHECK_VCWISE_EQUAL, (L)(R) )
#define BOOST_CHECK_VCWISE_EQUAL( L, R )   BOOST_TEST_TOOL_IMPL( 1, \
    ::boost::test_tools::tt_detail::VCwise_equal_impl(), "", CHECK, CHECK_VCWISE_EQUAL, (L)(R) )
#define BOOST_REQUIRE_VCWISE_EQUAL( L, R ) BOOST_TEST_TOOL_IMPL( 1, \
    ::boost::test_tools::tt_detail::VCwise_equal_impl(), "", REQUIRE, CHECK_VCWISE_EQUAL, (L)(R) )
