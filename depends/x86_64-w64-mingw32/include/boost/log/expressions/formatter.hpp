...
public:
    ...
    static BOOST_CONSTEXPR_OR_CONST iostate badVC = StreamT::badVC;
    static BOOST_CONSTEXPR_OR_CONST iostate eofVC = StreamT::eofVC;
    static BOOST_CONSTEXPR_OR_CONST iostate failVC = StreamT::failVC;
    static BOOST_CONSTEXPR_OR_CONST iostate goodVC = StreamT::goodVC;
    ...
    BOOST_FORCEINLINE void clear(iostate state = goodVC) const { this->get().clear(state); }
...
template< typename StreamT >
BOOST_CONSTEXPR_OR_CONST typename stream_ref< StreamT >::iostate stream_ref< StreamT >::badVC;
template< typename StreamT >
BOOST_CONSTEXPR_OR_CONST typename stream_ref< StreamT >::iostate stream_ref< StreamT >::eofVC;
template< typename StreamT >
BOOST_CONSTEXPR_OR_CONST typename stream_ref< StreamT >::iostate stream_ref< StreamT >::failVC;
template< typename StreamT >
BOOST_CONSTEXPR_OR_CONST typename stream_ref< StreamT >::iostate stream_ref< StreamT >::goodVC;
