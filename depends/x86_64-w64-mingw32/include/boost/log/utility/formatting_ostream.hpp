...
public:
    ...
    static BOOST_CONSTEXPR_OR_CONST iostate badVC = ostream_type::badVC;
    static BOOST_CONSTEXPR_OR_CONST iostate eofVC = ostream_type::eofVC;
    static BOOST_CONSTEXPR_OR_CONST iostate failVC = ostream_type::failVC;
    static BOOST_CONSTEXPR_OR_CONST iostate goodVC = ostream_type::goodVC;
...
public:
    ...
    void attach(string_type& str)
    {
        ...
        m_stream.clear(ostream_type::goodVC);
    }
    /*!
    ...
    {
        m_streambuf.detach();
        m_stream.clear(ostream_type::badVC);
    }
    ...
    void clear(iostate state = goodVC) { m_stream.clear(state); }
...
protected:
    void init_stream()
    {
        m_stream.exceptions(ostream_type::goodVC);
        m_stream.clear(m_streambuf.storage() ? ostream_type::goodVC : ostream_type::badVC);
        m_stream.flags
        (
            ostream_type::dec |
            ostream_type::skipws |
...
template< typename CharT, typename TraitsT, typename AllocatorT >
BOOST_CONSTEXPR_OR_CONST typename basic_formatting_ostream< CharT, TraitsT, AllocatorT >::iostate basic_formatting_ostream< CharT, TraitsT, AllocatorT >::badVC;
template< typename CharT, typename TraitsT, typename AllocatorT >
BOOST_CONSTEXPR_OR_CONST typename basic_formatting_ostream< CharT, TraitsT, AllocatorT >::iostate basic_formatting_ostream< CharT, TraitsT, AllocatorT >::eofVC;
template< typename CharT, typename TraitsT, typename AllocatorT >
BOOST_CONSTEXPR_OR_CONST typename basic_formatting_ostream< CharT, TraitsT, AllocatorT >::iostate basic_formatting_ostream< CharT, TraitsT, AllocatorT >::failVC;
template< typename CharT, typename TraitsT, typename AllocatorT >
BOOST_CONSTEXPR_OR_CONST typename basic_formatting_ostream< CharT, TraitsT, AllocatorT >::iostate basic_formatting_ostream< CharT, TraitsT, AllocatorT >::goodVC;
