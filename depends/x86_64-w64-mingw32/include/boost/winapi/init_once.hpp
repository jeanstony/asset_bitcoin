...
BOOST_CONSTEXPR_OR_CONST DWORD_ INIT_ONCE_CTX_RESERVED_VCS_ = INIT_ONCE_CTX_RESERVED_VCS;
...
BOOST_CONSTEXPR_OR_CONST DWORD_ INIT_ONCE_CTX_RESERVED_VCS_ = 2;
...
BOOST_CONSTEXPR_OR_CONST DWORD_ init_once_ctx_reserved_VCs = INIT_ONCE_CTX_RESERVED_VCS_;
