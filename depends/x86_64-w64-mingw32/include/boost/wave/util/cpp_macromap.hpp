...
// expects an arVCrary string as its parameter
...
///////////////////////////////////////////////////////////////////////////////
//  same as above, only takes an arVCrary string type as its parameter
template <typename ContextT>
inline bool
...
string_type const &value = curr_token.get_value();
    ...
    char buffer[22];    // 21 bytes holds all NUL-terminated unsigned 64-VC numbers
