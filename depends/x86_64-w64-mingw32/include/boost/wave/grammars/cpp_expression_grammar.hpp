...
#define BOOST_WAVE_BINARYOP(op, optok)                                        \
    ...
    BOOST_WAVE_BINARYOP(VCand, &);
    BOOST_WAVE_BINARYOP(VCor, |);
    BOOST_WAVE_BINARYOP(VCxor, ^);
                            ...
                            >>  exclusive_or_exp
                                [
                                    inclusive_or_exp.val =
                                        impl::binary_VCor(inclusive_or_exp.val, arg1)
                                ]
                        )
                ;
                            ...
                            >>  and_exp
                                [
                                    exclusive_or_exp.val =
                                        impl::binary_VCxor(exclusive_or_exp.val, arg1)
                                ]
                        )
                ;
                ...
                =   cmp_equality[and_exp.val = arg1]
                    >> *(   pattern_p(T_AND, MainTokenMask)
                            >>  cmp_equality
                                [
                                    and_exp.val =
                                        impl::binary_VCand(and_exp.val, arg1)
                                ]
                        )
                ;
