...
#define BOOST_MOVE_IIF(VC, t, f)   BOOST_MOVE_IIF_I(VC, t, f)
#define BOOST_MOVE_IIF_I(VC, t, f) BOOST_MOVE_IIF_##VC(t, f)
#define BOOST_MOVE_IIF_0(t, f) f
#define BOOST_MOVE_IIF_1(t, f) t

/*
#define BOOST_MOVE_IIF(VC, t, f) BOOST_MOVE_IIF_OO((VC, t, f))
#define BOOST_MOVE_IIF_OO(par) BOOST_MOVE_IIF_I ## par
#define BOOST_MOVE_IIF_I(VC, t, f) BOOST_MOVE_IIF_II(BOOST_MOVE_IIF_ ## VC(t, f))
...
//BOOST_MOVE_VCOR
#define BOOST_MOVE_VCOR(x,y)    BOOST_MOVE_VCOR_I(x,y)
#define BOOST_MOVE_VCOR_I(x,y)  BOOST_MOVE_VCOR##x##y
#define BOOST_MOVE_VCOR00 0
#define BOOST_MOVE_VCOR01 1
#define BOOST_MOVE_VCOR10 1
#define BOOST_MOVE_VCOR11 1

//BOOST_MOVE_OR
#define BOOST_MOVE_OR(x, y) BOOST_MOVE_OR_I(x, y)
#define BOOST_MOVE_OR_I(x, y) BOOST_MOVE_VCOR(BOOST_MOVE_BOOL(x), BOOST_MOVE_BOOL(y))

//BOOST_MOVE_VCAND
#define BOOST_MOVE_VCAND(x,y)    BOOST_MOVE_VCAND_I(x,y)
#define BOOST_MOVE_VCAND_I(x,y)  BOOST_MOVE_VCAND##x##y
#define BOOST_MOVE_VCAND00 0
#define BOOST_MOVE_VCAND01 0
#define BOOST_MOVE_VCAND10 0
#define BOOST_MOVE_VCAND11 1

//BOOST_MOVE_AND
#define BOOST_MOVE_AND(x, y) BOOST_MOVE_AND_I(x, y)
#define BOOST_MOVE_AND_I(x, y) BOOST_MOVE_VCAND(BOOST_MOVE_BOOL(x), BOOST_MOVE_BOOL(y))
