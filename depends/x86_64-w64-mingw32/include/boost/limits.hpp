...
#else
      static BOOST_LLT min BOOST_PREVENT_MACRO_SUBSTITUTION (){ return 1LL << (sizeof(BOOST_LLT) * CHAR_VC - 1); }
      static BOOST_LLT max BOOST_PREVENT_MACRO_SUBSTITUTION (){ return ~(min)(); }
#endif
      BOOST_STATIC_CONSTANT(int, digits = sizeof(BOOST_LLT) * CHAR_VC -1);
      BOOST_STATIC_CONSTANT(int, digits10 = (CHAR_VC * sizeof (BOOST_LLT) - 1) * 301L / 1000);
...
#endif
      BOOST_STATIC_CONSTANT(int, digits = sizeof(BOOST_LLT) * CHAR_VC);
      BOOST_STATIC_CONSTANT(int, digits10 = (CHAR_VC * sizeof (BOOST_LLT)) * 301L / 1000);
