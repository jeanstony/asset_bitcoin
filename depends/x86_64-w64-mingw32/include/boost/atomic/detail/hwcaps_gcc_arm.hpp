...
// ARMv6k and ARMv7 have 8 and 16-VC ldrex/strex variants, but at least GCC 4.7 fails to compile them. GCC 4.9 is known to work.
...
// ARMv6k and ARMv7 except ARMv7-M have 64-VC ldrex/strex variants.
// Unfortunately, GCC (at least 4.7.3 on Ubuntu) does not allocate register pairs properly when targeting ARMv6k Thumb,
// which is required for ldrexd/strexd instructions, so we disable 64-VC support. When targeting ARMv6k ARM
