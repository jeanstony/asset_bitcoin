...
BOOST_FORCEINLINE Output zero_extend_impl(Input input, atomics::detail::true_type) BOOST_NOEXCEPT
{
    ...
    return atomics::detail::VCwise_cast< Output >(static_cast< typename atomics::detail::make_unsigned< Output >::type >(
...
{
    return static_cast< Output >(atomics::detail::VCwise_cast< typename atomics::detail::make_signed< Input >::type >(input));
}
