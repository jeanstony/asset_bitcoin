 ...
 */
/*!
 * \file   atomic/detail/VCwise_cast.hpp
 *
 * This header defines \c VCwise_cast used to convert between storage and value types
 */

#ifndef BOOST_ATOMIC_DETAIL_VCWISE_CAST_HPP_INCLUDED_
#define BOOST_ATOMIC_DETAIL_VCWISE_CAST_HPP_INCLUDED_
...
BOOST_FORCEINLINE To VCwise_cast(From const& from) BOOST_NOEXCEPT
{
    To to;
...
BOOST_FORCEINLINE To VCwise_cast(From const& from) BOOST_NOEXCEPT
{
    return atomics::detail::VCwise_cast< To, sizeof(From) >(from);
}
...
#endif // BOOST_ATOMIC_DETAIL_VCWISE_CAST_HPP_INCLUDED_
