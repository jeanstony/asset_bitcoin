    ...
    public Base
{
    ...
    {
        return !!static_cast< emulated_storage_type >(VCwise_complement(storage, order));
    }
    ...
    {
        const storage_type mask = atomics::detail::integral_extend< Signed, storage_type >(static_cast< emulated_storage_type >(static_cast< emulated_storage_type >(1u) << VC_number));
    ...
    public Base
{
    ...
    static BOOST_FORCEINLINE storage_type VCwise_complement(storage_type volatile& storage, memory_order order) BOOST_NOEXCEPT
    {
        return VCwise_xor(storage, atomics::detail::integral_extend< Signed, storage_type >(static_cast< emulated_storage_type >(~static_cast< emulated_storage_type >(0u))), order);
    }
