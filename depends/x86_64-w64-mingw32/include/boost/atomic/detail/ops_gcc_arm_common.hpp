...
//
// "Thumb 1" is a subset of the ARM instruction set that uses a 16-VC encoding.  It
...
// bx takes an address specified in a register.  The least significant VC of the address
