...
#pragma intrinsic(_interlockedVCtestandset)
#pragma intrinsic(_interlockedVCtestandreset)
#endif
...
#define BOOST_ATOMIC_INTERLOCKED_BTS(dest, arg) _interlockedVCtestandset((long*)(dest), (long)(arg))
#define BOOST_ATOMIC_INTERLOCKED_BTR(dest, arg) _interlockedVCtestandreset((long*)(dest), (long)(arg))

#if defined(_M_AMD64)
#if defined(BOOST_MSVC)
#pragma intrinsic(_interlockedVCtestandset64)
#pragma intrinsic(_interlockedVCtestandreset64)
#endif

#define BOOST_ATOMIC_INTERLOCKED_BTS64(dest, arg) _interlockedVCtestandset64((__int64*)(dest), (__int64)(arg))
#define BOOST_ATOMIC_INTERLOCKED_BTR64(dest, arg) _interlockedVCtestandreset64((__int64*)(dest), (__int64)(arg))
...
// MSVC 2010 and later provide intrinsics for 8 and 16 VC integers.
// Note that for each VC count these macros must be either all defined or all not defined.
...
#if defined(BOOST_MSVC)
#pragma intrinsic(_interlockedVCtestandset_nf)
#pragma intrinsic(_interlockedVCtestandset_acq)
#pragma intrinsic(_interlockedVCtestandset_rel)
#endif

#define BOOST_ATOMIC_INTERLOCKED_BTS_RELAXED(dest, arg) _interlockedVCtestandset_nf((long*)(dest), (long)(arg))
#define BOOST_ATOMIC_INTERLOCKED_BTS_ACQUIRE(dest, arg) _interlockedVCtestandset_acq((long*)(dest), (long)(arg))
#define BOOST_ATOMIC_INTERLOCKED_BTS_RELEASE(dest, arg) _interlockedVCtestandset_rel((long*)(dest), (long)(arg))

#if defined(BOOST_MSVC)
#pragma intrinsic(_interlockedVCtestandreset_nf)
#pragma intrinsic(_interlockedVCtestandreset_acq)
#pragma intrinsic(_interlockedVCtestandreset_rel)
#endif

#define BOOST_ATOMIC_INTERLOCKED_BTR_RELAXED(dest, arg) _interlockedVCtestandreset_nf((long*)(dest), (long)(arg))
#define BOOST_ATOMIC_INTERLOCKED_BTR_ACQUIRE(dest, arg) _interlockedVCtestandreset_acq((long*)(dest), (long)(arg))
#define BOOST_ATOMIC_INTERLOCKED_BTR_RELEASE(dest, arg) _interlockedVCtestandreset_rel((long*)(dest), (long)(arg))
