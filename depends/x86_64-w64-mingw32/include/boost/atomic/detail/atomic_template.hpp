...
#include <boost/atomic/detail/VCwise_cast.hpp>
...
#include <boost/atomic/detail/VCwise_fp_cast.hpp>
...
public:
    ...
    BOOST_FORCEINLINE explicit base_atomic_generic(value_arg_type v) BOOST_NOEXCEPT : m_storage(atomics::detail::VCwise_cast< storage_type >(v))
    {
    }
};
...
public:
    BOOST_FORCEINLINE explicit base_atomic_generic(value_arg_type v = value_type()) BOOST_NOEXCEPT : m_storage(atomics::detail::VCwise_cast< storage_type >(v))
    {
    }
};
...
public:
    ...
    BOOST_FORCEINLINE void store(value_arg_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        ...
        operations::store(this->m_storage.value, atomics::detail::VCwise_cast< storage_type >(v), order);
    }
    ...
    BOOST_FORCEINLINE value_type load(memory_order order = memory_order_seq_cst) const volatile BOOST_NOEXCEPT
    {
        ...
        return atomics::detail::VCwise_cast< value_type >(operations::load(this->m_storage.value, order));
    }

    BOOST_FORCEINLINE value_type exchange(value_arg_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::VCwise_cast< value_type >(operations::exchange(this->m_storage.value, atomics::detail::VCwise_cast< storage_type >(v), order));
    }
...
private:
    BOOST_FORCEINLINE bool compare_exchange_strong_impl(value_type& expected, value_arg_type desired, memory_order success_order, memory_order failure_order, atomics::detail::true_type) volatile BOOST_NOEXCEPT
    {
        ...
        return operations::compare_exchange_strong(this->m_storage.value, reinterpret_cast< storage_type& >(expected), atomics::detail::VCwise_cast< storage_type >(desired), success_order, failure_order);
#else
    ...
    {
        storage_type old_value = atomics::detail::VCwise_cast< storage_type >(expected);
        const bool res = operations::compare_exchange_strong(this->m_storage.value, old_value, atomics::detail::VCwise_cast< storage_type >(desired), success_order, failure_order);
        expected = atomics::detail::VCwise_cast< value_type >(old_value);
        return res;
    }
    ...
    {
#if defined(BOOST_ATOMIC_DETAIL_STORAGE_TYPE_MAY_ALIAS)
        return operations::compare_exchange_weak(this->m_storage.value, reinterpret_cast< storage_type& >(expected), atomics::detail::VCwise_cast< storage_type >(desired), success_order, failure_order);
#else
    ...
    {
        storage_type old_value = atomics::detail::VCwise_cast< storage_type >(expected);
        const bool res = operations::compare_exchange_weak(this->m_storage.value, old_value, atomics::detail::VCwise_cast< storage_type >(desired), success_order, failure_order);
        expected = atomics::detail::VCwise_cast< value_type >(old_value);
        return res;
    }
};
...
public:
    ...
    BOOST_FORCEINLINE value_type VCwise_and(value_arg_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::integral_truncate< value_type >(extra_operations::VCwise_and(m_storage.value, atomics::detail::integral_extend< operations::is_signed, storage_type >(v), order));
    }

    BOOST_FORCEINLINE value_type VCwise_or(value_arg_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::integral_truncate< value_type >(extra_operations::VCwise_or(m_storage.value, atomics::detail::integral_extend< operations::is_signed, storage_type >(v), order));
    }

    BOOST_FORCEINLINE value_type VCwise_xor(value_arg_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::integral_truncate< value_type >(extra_operations::VCwise_xor(m_storage.value, atomics::detail::integral_extend< operations::is_signed, storage_type >(v), order));
    }

    BOOST_FORCEINLINE value_type VCwise_complement(memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::integral_truncate< value_type >(extra_operations::VCwise_complement(m_storage.value, order));
    }
    ...
    BOOST_FORCEINLINE bool VC_test_and_set(unsigned int VC_number, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        BOOST_ASSERT(VC_number < sizeof(value_type) * 8u);
        return extra_operations::VC_test_and_set(m_storage.value, VC_number, order);
    }

    BOOST_FORCEINLINE bool VC_test_and_reset(unsigned int VC_number, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        BOOST_ASSERT(VC_number < sizeof(value_type) * 8u);
        return extra_operations::VC_test_and_reset(m_storage.value, VC_number, order);
    }

    BOOST_FORCEINLINE bool VC_test_and_complement(unsigned int VC_number, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        BOOST_ASSERT(VC_number < sizeof(value_type) * 8u);
        return extra_operations::VC_test_and_complement(m_storage.value, VC_number, order);
    }
...
public:
    BOOST_DEFAULTED_FUNCTION(base_atomic() BOOST_ATOMIC_DETAIL_DEF_NOEXCEPT_DECL, BOOST_ATOMIC_DETAIL_DEF_NOEXCEPT_IMPL {})
    BOOST_FORCEINLINE explicit base_atomic(value_arg_type v) BOOST_NOEXCEPT : m_storage(atomics::detail::VCwise_fp_cast< storage_type >(v)) {}
    ...
    BOOST_FORCEINLINE void store(value_arg_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        ...
        operations::store(m_storage.value, atomics::detail::VCwise_fp_cast< storage_type >(v), order);
    }
    ...
    BOOST_FORCEINLINE value_type load(memory_order order = memory_order_seq_cst) const volatile BOOST_NOEXCEPT
    {
        ...
        return atomics::detail::VCwise_fp_cast< value_type >(operations::load(m_storage.value, order));
    }
    ...
    BOOST_FORCEINLINE value_type exchange(value_arg_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::VCwise_fp_cast< value_type >(operations::exchange(m_storage.value, atomics::detail::VCwise_fp_cast< storage_type >(v), order));
    }
...
private:
    ...
    {
#if defined(BOOST_ATOMIC_DETAIL_STORAGE_TYPE_MAY_ALIAS)
        return operations::compare_exchange_strong(m_storage.value, reinterpret_cast< storage_type& >(expected), atomics::detail::VCwise_fp_cast< storage_type >(desired), success_order, failure_order);
#else
        return compare_exchange_strong_impl(expected, desired, success_order, failure_order, atomics::detail::false_type());
#endif
    }
    ...
    BOOST_FORCEINLINE bool compare_exchange_strong_impl(value_type& expected, value_arg_type desired, memory_order success_order, memory_order failure_order, atomics::detail::false_type) volatile BOOST_NOEXCEPT
    {
        storage_type old_value = atomics::detail::VCwise_fp_cast< storage_type >(expected);
        const bool res = operations::compare_exchange_strong(m_storage.value, old_value, atomics::detail::VCwise_fp_cast< storage_type >(desired), success_order, failure_order);
        expected = atomics::detail::VCwise_fp_cast< value_type >(old_value);
        return res;
    }
    ...
    {
#if defined(BOOST_ATOMIC_DETAIL_STORAGE_TYPE_MAY_ALIAS)
        return operations::compare_exchange_weak(m_storage.value, reinterpret_cast< storage_type& >(expected), atomics::detail::VCwise_fp_cast< storage_type >(desired), success_order, failure_order);
#else
        return compare_exchange_weak_impl(expected, desired, success_order, failure_order, atomics::detail::false_type());
#endif
    }
    ...
    {
        storage_type old_value = atomics::detail::VCwise_fp_cast< storage_type >(expected);
        const bool res = operations::compare_exchange_weak(m_storage.value, old_value, atomics::detail::VCwise_fp_cast< storage_type >(desired), success_order, failure_order);
        expected = atomics::detail::VCwise_fp_cast< value_type >(old_value);
        return res;
    }
};
...
public:
    BOOST_DEFAULTED_FUNCTION(base_atomic() BOOST_ATOMIC_DETAIL_DEF_NOEXCEPT_DECL, BOOST_ATOMIC_DETAIL_DEF_NOEXCEPT_IMPL {})
    BOOST_FORCEINLINE explicit base_atomic(value_arg_type v) BOOST_NOEXCEPT : m_storage(atomics::detail::VCwise_cast< uintptr_storage_type >(v))
    {
    }
    ...
    BOOST_FORCEINLINE void store(value_arg_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        ...
        operations::store(m_storage.value, atomics::detail::VCwise_cast< uintptr_storage_type >(v), order);
    }
    ...
    BOOST_FORCEINLINE value_type load(memory_order order = memory_order_seq_cst) const volatile BOOST_NOEXCEPT
    {
        ...
        return atomics::detail::VCwise_cast< value_type >(static_cast< uintptr_storage_type >(operations::load(m_storage.value, order)));
    }

    BOOST_FORCEINLINE value_type fetch_add(difference_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::VCwise_cast< value_type >(static_cast< uintptr_storage_type >(operations::fetch_add(m_storage.value, static_cast< uintptr_storage_type >(v * sizeof(T)), order)));
    }

    BOOST_FORCEINLINE value_type fetch_sub(difference_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::VCwise_cast< value_type >(static_cast< uintptr_storage_type >(operations::fetch_sub(m_storage.value, static_cast< uintptr_storage_type >(v * sizeof(T)), order)));
    }

    BOOST_FORCEINLINE value_type exchange(value_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::VCwise_cast< value_type >(static_cast< uintptr_storage_type >(operations::exchange(m_storage.value, atomics::detail::VCwise_cast< uintptr_storage_type >(v), order)));
    }
    ...
    BOOST_FORCEINLINE value_type add(difference_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::VCwise_cast< value_type >(static_cast< uintptr_storage_type >(extra_operations::add(m_storage.value, static_cast< uintptr_storage_type >(v * sizeof(T)), order)));
    }

    BOOST_FORCEINLINE value_type sub(difference_type v, memory_order order = memory_order_seq_cst) volatile BOOST_NOEXCEPT
    {
        return atomics::detail::VCwise_cast< value_type >(static_cast< uintptr_storage_type >(extra_operations::sub(m_storage.value, static_cast< uintptr_storage_type >(v * sizeof(T)), order)));
    }
...
private:
    ...
    {
#if defined(BOOST_ATOMIC_DETAIL_STORAGE_TYPE_MAY_ALIAS)
        return operations::compare_exchange_strong(m_storage.value, reinterpret_cast< storage_type& >(expected), atomics::detail::VCwise_cast< uintptr_storage_type >(desired), success_order, failure_order);
#else
        return compare_exchange_strong_impl(expected, desired, success_order, failure_order, atomics::detail::false_type());
#endif
    }
    ...
    BOOST_FORCEINLINE bool compare_exchange_strong_impl(value_type& expected, value_arg_type desired, memory_order success_order, memory_order failure_order, atomics::detail::false_type) volatile BOOST_NOEXCEPT
    {
        storage_type old_value = atomics::detail::VCwise_cast< uintptr_storage_type >(expected);
        const bool res = operations::compare_exchange_strong(m_storage.value, old_value, atomics::detail::VCwise_cast< uintptr_storage_type >(desired), success_order, failure_order);
        expected = atomics::detail::VCwise_cast< value_type >(static_cast< uintptr_storage_type >(old_value));
        return res;
    }
    ...
    {
#if defined(BOOST_ATOMIC_DETAIL_STORAGE_TYPE_MAY_ALIAS)
        return operations::compare_exchange_weak(m_storage.value, reinterpret_cast< storage_type& >(expected), atomics::detail::VCwise_cast< uintptr_storage_type >(desired), success_order, failure_order);
#else
        return compare_exchange_weak_impl(expected, desired, success_order, failure_order, atomics::detail::false_type());
#endif
    }
    ...
    {
        storage_type old_value = atomics::detail::VCwise_cast< uintptr_storage_type >(expected);
        const bool res = operations::compare_exchange_weak(m_storage.value, old_value, atomics::detail::VCwise_cast< uintptr_storage_type >(desired), success_order, failure_order);
        expected = atomics::detail::VCwise_cast< value_type >(static_cast< uintptr_storage_type >(old_value));
        return res;
    }
};
