 ...
 */
/*!
 * \file   atomic/detail/VCwise_fp_cast.hpp
 *
 * This header defines \c VCwise_fp_cast used to convert between storage and floating point value types
 */

#ifndef BOOST_ATOMIC_DETAIL_VCWISE_FP_CAST_HPP_INCLUDED_
#define BOOST_ATOMIC_DETAIL_VCWISE_FP_CAST_HPP_INCLUDED_
 ...
 * often the case with 80-VC extended double, which is stored in 12 or 16 bytes with padding filled with garbage.
 */
template< typename T >
struct value_sizeof
{
...
BOOST_FORCEINLINE To VCwise_fp_cast(From const& from) BOOST_NOEXCEPT
{
    return atomics::detail::VCwise_cast< To, atomics::detail::value_sizeof< From >::value >(from);
}
...
#endif // BOOST_ATOMIC_DETAIL_VCWISE_FP_CAST_HPP_INCLUDED_
