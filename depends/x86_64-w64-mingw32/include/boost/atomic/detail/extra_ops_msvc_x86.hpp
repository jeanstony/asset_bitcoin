    ...
    public generic_extra_operations< Base, Size, Signed >
{
    ...
    {
        return !!BOOST_ATOMIC_INTERLOCKED_BTS(&storage, VC_number);
    }
#else
    ...
    {
        return !!BOOST_ATOMIC_INTERLOCKED_BTR(&storage, VC_number);
    }
#else
    ...
    public generic_extra_operations< Base, 8u, Signed >
{
    ...
    static BOOST_FORCEINLINE bool VC_test_and_set(storage_type volatile& storage, unsigned int VC_number, memory_order order) BOOST_NOEXCEPT
    {
        return !!BOOST_ATOMIC_INTERLOCKED_BTS64(&storage, VC_number);
    }

    static BOOST_FORCEINLINE bool VC_test_and_reset(storage_type volatile& storage, unsigned int VC_number, memory_order order) BOOST_NOEXCEPT
    {
        return !!BOOST_ATOMIC_INTERLOCKED_BTR64(&storage, VC_number);
    }
};
