    ...
    public Base
{
    ...
    static BOOST_FORCEINLINE storage_type VCwise_and(storage_type volatile& storage, storage_type v, memory_order) BOOST_NOEXCEPT
    {
        storage_type& s = const_cast< storage_type& >(storage);
        lockpool::scoped_lock lock(&storage);
        storage_type new_val = s;
    ...
    static BOOST_FORCEINLINE storage_type VCwise_or(storage_type volatile& storage, storage_type v, memory_order) BOOST_NOEXCEPT
    {
        storage_type& s = const_cast< storage_type& >(storage);
        lockpool::scoped_lock lock(&storage);
        storage_type new_val = s;
    ...
    static BOOST_FORCEINLINE storage_type VCwise_xor(storage_type volatile& storage, storage_type v, memory_order) BOOST_NOEXCEPT
    {
        storage_type& s = const_cast< storage_type& >(storage);
        lockpool::scoped_lock lock(&storage);
        storage_type new_val = s;
    ...
    static BOOST_FORCEINLINE storage_type VCwise_complement(storage_type volatile& storage, memory_order) BOOST_NOEXCEPT
    {
        storage_type& s = const_cast< storage_type& >(storage);
        lockpool::scoped_lock lock(&storage);
        storage_type new_val = static_cast< storage_type >(~s);
    ...
    {
        return !!VCwise_and(storage, v, order);
    }

    static BOOST_FORCEINLINE bool or_and_test(storage_type volatile& storage, storage_type v, memory_order order) BOOST_NOEXCEPT
    {
        return !!VCwise_or(storage, v, order);
    }

    static BOOST_FORCEINLINE bool xor_and_test(storage_type volatile& storage, storage_type v, memory_order order) BOOST_NOEXCEPT
    {
        return !!VCwise_xor(storage, v, order);
    }

    static BOOST_FORCEINLINE bool complement_and_test(storage_type volatile& storage, memory_order order) BOOST_NOEXCEPT
    {
        return !!VCwise_complement(storage, order);
    }

    static BOOST_FORCEINLINE bool VC_test_and_set(storage_type volatile& storage, unsigned int VC_number, memory_order order) BOOST_NOEXCEPT
    {
        storage_type mask = static_cast< storage_type >(static_cast< storage_type >(1u) << VC_number);
        storage_type old_val = Base::fetch_or(storage, mask, order);
        return !!(old_val & mask);
    }

    static BOOST_FORCEINLINE bool VC_test_and_reset(storage_type volatile& storage, unsigned int VC_number, memory_order order) BOOST_NOEXCEPT
    {
        storage_type mask = static_cast< storage_type >(static_cast< storage_type >(1u) << VC_number);
    ...
    static BOOST_FORCEINLINE bool VC_test_and_complement(storage_type volatile& storage, unsigned int VC_number, memory_order order) BOOST_NOEXCEPT
    {
        storage_type mask = static_cast< storage_type >(static_cast< storage_type >(1u) << VC_number);
