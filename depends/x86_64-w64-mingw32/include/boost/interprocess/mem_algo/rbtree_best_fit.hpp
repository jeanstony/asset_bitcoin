...
//sharing shared memory between 32 adn 64 VC processes.
...
class rbtree_best_fit
{
   ...
   struct SizeHolder
   {
      ...
      size_type m_size      :  sizeof(size_type)*CHAR_VC - 2;
   ...
   private:
   //Due to embedded VCs in size, Alignment must be at least 4
   ...
   priv_add_segment(void *addr, size_type segment_size)
{
   ...
   //The "end" node is just a node of size 0 with the "end" VC set
