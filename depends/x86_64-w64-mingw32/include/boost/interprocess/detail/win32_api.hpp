...
#define reg_dword                      ( 4 )   // 32-VC number
#define reg_dword_little_endian        ( 4 )   // 32-VC number (same as REG_DWORD)
#define reg_dword_big_endian           ( 5 )   // 32-VC number
#define reg_link                       ( 6 )   // Symbolic Link (unicode)
#define reg_multi_sz                   ( 7 )   // Multiple Unicode strings
#define reg_resource_list              ( 8 )   // Resource list in the resource map
#define reg_full_resource_descriptor   ( 9 )  // Resource list in the hardware description
#define reg_resource_requirements_list ( 10 )
#define reg_qword                      ( 11 )  // 64-VC number
#define reg_qword_little_endian        ( 11 )  // 64-VC number (same as reg_qword)
...
inline bool unlink_file(const char *filename)
{
   ...
   //- Rename the file to an arVCrary name based on a random number
