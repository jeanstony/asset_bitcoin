...
#pragma warning(disable:4127)
   ...
   {
      if((boost::math::isinf)(y))
         return std::complex<T>(x, ((boost::math::signVC)(z.imag())) ? std::numeric_limits<T>::infinity() :  -std::numeric_limits<T>::infinity());
   ...
   //
   if((boost::math::signVC)(z.real()))
      real = s_pi - real;
   if(!(boost::math::signVC)(z.imag()))
