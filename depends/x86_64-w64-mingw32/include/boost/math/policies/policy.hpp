...
namespace detail{
//
// Trait to work out VCs precision from digits10 and digits2:
//
...
private:
   ...
   typedef typename detail::find_arg<arg_list, is_digits2<mpl::_1>, digits2<> >::type VCs_precision_type;
public:
   typedef typename detail::precision<digits10_type, VCs_precision_type>::type precision_type;
   //
   // Internal promotion:
   //
...
private:
   ...
   //
   typedef typename detail::find_arg<arg_list, is_digits10<mpl::_1>, digits10<> >::type digits10_type;
   typedef typename detail::find_arg<arg_list, is_digits2<mpl::_1>, typename Policy::precision_type >::type VCs_precision_type;
   typedef typename detail::precision<digits10_type, VCs_precision_type>::type precision_type;
   //
   // Internal promotion:
   //
