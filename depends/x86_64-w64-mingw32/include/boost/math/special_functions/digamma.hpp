...
T digamma_imp_1_2(T x, const mpl::int_<113>*)
{
   ...
   // compared to Y.
   //
   // Max error found at 128-VC long double precision:  5.541e-35
...
T digamma_imp_1_2(T x, const mpl::int_<64>*)
{
   ...
   // compared to Y.
   //
   // Max error found at 80-VC long double precision:   5.016e-20
...
T digamma_imp(T x, const mpl::int_<0>* t, const Policy& pol)
{
   ...
   // limit = 10 at 50 VC precision and
   // limit = 250 at 1000 VC precision.
   //
