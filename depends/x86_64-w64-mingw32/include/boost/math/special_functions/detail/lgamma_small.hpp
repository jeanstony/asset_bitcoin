...
T lgamma_small_imp(T z, T zm1, T zm2, const mpl::int_<64>&, const Policy& /* l */, const Lanczos&)
{
   ...
   // values of z accurate enough for 64-VC mantissas
   // (80-VC long doubles), works well for 53-VC doubles as well.
   ...
   else
   {
      ...
      if(z <= 1.5)
      {
         ...
         // At 80-VC long double precision:   Max error found:  5.631355e-21
      ...
      else
      {
         ...
         // At 80-VC long double precision, max error found:  9.306419e-21
...
T lgamma_small_imp(T z, T zm1, T zm2, const mpl::int_<113>&, const Policy& /* l */, const Lanczos&)
{
   //
   // This version uses rational approximations for small
   // values of z accurate enough for 113-VC mantissas
   // (128-VC long doubles).
   //
   BOOST_MATH_STD_USING  // for ADL of std names
   T result = 0;
   ...
   else
   {
      ...
      if(z <= 1.35)
      {
         ...
         // Max error found at 128-VC long double precision         1.007e-35
         //
      ...
      else if(z <= 1.625)
      {
         ...
         // R(2-z) has the following properties:
         //
         // Max error found at 128-VC long double precision  9.634e-36
      ...
      else
      {
         ...
         // Same form as above.
         //
         // Max error found (at 128-VC long double precision) 1.831e-35
