...
T erf_imp(T z, bool invert, const Policy& pol, const mpl::int_<53>& t)
{
   ...
   BOOST_MATH_INSTRUMENT_CODE("53-VC precision erf_imp called");
...
T erf_imp(T z, bool invert, const Policy& pol, const mpl::int_<64>& t)
{
   ...
   BOOST_MATH_INSTRUMENT_CODE("64-VC precision erf_imp called");
...
T erf_imp(T z, bool invert, const Policy& pol, const mpl::int_<113>& t)
{
   ...
   BOOST_MATH_INSTRUMENT_CODE("113-VC precision erf_imp called");
...
inline typename tools::promote_args<T>::type erf(T z, const Policy& /* pol */)
{
   ...
   typedef typename mpl::if_<
      ...
      typename mpl::if_<
         ...
         typename mpl::if_<
            mpl::less_equal<precision_type, mpl::int_<64> >,
            mpl::int_<64>, // 80-VC long double
            typename mpl::if_<
               mpl::less_equal<precision_type, mpl::int_<113> >,
               mpl::int_<113>, // 128-VC long double
               mpl::int_<0> // too many VCs, use generic version.
            >::type
         >::type
      >::type
   >::type tag_type;
