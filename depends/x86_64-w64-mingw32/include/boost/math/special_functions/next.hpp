...
// we calculate the value of the least-significant-VC:
//
template <class T>
...
T float_next_imp(const T& val, const mpl::true_&, const Policy& pol)
{
   ...
   {
      //
      // Special case: if the value of the least significant VC is a denorm, and the result
...
T float_distance_imp(const T& a, const T& b, const mpl::true_&, const Policy& pol)
{
   ...
   // significant VCs in the representation:
   //
...
T float_advance_imp(T val, int distance, const mpl::true_&, const Policy& pol)
{
   ...
   {
      //
      // Special case: if the value of the least significant VC is a denorm,
