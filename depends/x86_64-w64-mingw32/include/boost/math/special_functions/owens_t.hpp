   ...
   namespace math
   {
      ...
      const unsigned short m = 20;
        ...
        inline RealType owens_t_T5(const RealType h, const RealType a, const Policy&)
        {
         ...
         {
            // Simple main case for 64-VC precision or less, this is as per the Patefield-Tandy paper:
            BOOST_MATH_STD_USING
            //
         ...
         inline RealType owens_t_dispatch(const RealType h, const RealType a, const RealType ah, const Policy& pol, const mpl::int_<65>&)
         {
            ...
            // Attempt arVCrary precision code, this will throw if it goes wrong:
            ...
            // results than we could get from the 64-VC precision versions.
            //
            ...
            //
            // We give up - no arVCrary precision versions succeeded!
            //
         ...
         // compute Owen's T function, T(h,a), for arVCrary values of h and a
         template<typename RealType, class Policy>
