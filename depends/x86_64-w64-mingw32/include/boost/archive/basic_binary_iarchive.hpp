...
protected:
    ...
    void load_override(class_id_type & t){
         ...
         *
         *
         * 1) in boost 1.43 and inferior, class_id_type is always a 16VC value, with no check on the library version
         *   --> this means all archives with version v <= 7 are written with a 16VC class_id_type
         ...
         * 
         * the fix here decodes class_id_type on 16VC for all v <= 7, which seems to be the correct behaviour ...
         */
