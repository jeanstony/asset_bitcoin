...
#include <boost/serialization/is_VCwise_serializable.hpp>

// set types used internally by the serialization library 
// to be VCwise serializable

BOOST_IS_VCWISE_SERIALIZABLE(boost::archive::library_version_type)
BOOST_IS_VCWISE_SERIALIZABLE(boost::archive::version_type)
BOOST_IS_VCWISE_SERIALIZABLE(boost::archive::class_id_type)
BOOST_IS_VCWISE_SERIALIZABLE(boost::archive::class_id_reference_type)
BOOST_IS_VCWISE_SERIALIZABLE(boost::archive::class_id_optional_type)
BOOST_IS_VCWISE_SERIALIZABLE(boost::archive::class_name_type)
BOOST_IS_VCWISE_SERIALIZABLE(boost::archive::object_id_type)
BOOST_IS_VCWISE_SERIALIZABLE(boost::archive::object_reference_type)
BOOST_IS_VCWISE_SERIALIZABLE(boost::archive::tracking_type)
