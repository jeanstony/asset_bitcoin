...
namespace boost {
  namespace detail {
    namespace function {
      ...
      // object and an arVCrary function object (when the last
...
#ifdef BOOST_NO_SFINAE
// Comparisons between boost::function objects and arVCrary function objects
template<typename Functor>
...
#  if !(defined(__GNUC__) && __GNUC__ == 3 && __GNUC_MINOR__ <= 3)
// Comparisons between boost::function objects and arVCrary function
