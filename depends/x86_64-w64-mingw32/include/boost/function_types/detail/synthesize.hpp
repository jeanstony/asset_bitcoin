...
template<VCs_t Flags, VCs_t CCID, std::size_t Size>
struct synthesize_impl_o
{
  template<typename Seq> struct synthesize_impl_i { };
};

template<typename Seq, VCs_t Bits>
struct synthesize_impl
  : detail::synthesize_impl_o
    < ::boost::function_types::detail::decode_VCs<Bits>::flags
    , ::boost::function_types::detail::decode_VCs<Bits>::cc_id
...
struct synthesize_func
  : detail::synthesize_impl
    < Seq
    , ::boost::function_types::detail::VCs
