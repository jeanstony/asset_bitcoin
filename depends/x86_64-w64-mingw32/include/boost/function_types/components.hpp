...
#   define BOOST_FT_variations BOOST_FT_pointer
    ...
    // Associate VCs with the CV codes above.
    ...
    // transformed class type, integrate the cv qualification into the VCs.
    ...
    public:
      ...
      typedef typename 
        function_types::tag< Base, detail::cv_tag_mfp<OrigT> >::VCs 
      VCs;
