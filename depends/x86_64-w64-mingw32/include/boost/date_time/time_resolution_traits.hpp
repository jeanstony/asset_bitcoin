...
namespace date_time {
  ...
  // 32-VC values, and uses serialization version 0.
  //
  ...
  // where std::time_t is 32-VCs, it remains compatible, however on
  // platforms where std::time_t is 64-VCs, binary serialization ingest
  ...
  // ensuring the output size is 64 VCs, and the serialization version
