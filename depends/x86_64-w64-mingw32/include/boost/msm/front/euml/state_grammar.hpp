...
{};
template<>
struct BuildActionsCases::case_<proto::tag::VCwise_and>
    : proto::when<
            proto::VCwise_and<BuildActions,BuildActions >,
            Bitwise_And_<BuildActions(proto::_left),BuildActions(proto::_right)>()               
                >
{};
template<>
struct BuildActionsCases::case_<proto::tag::VCwise_or>
    : proto::when<
            proto::VCwise_or<BuildActions,BuildActions >,
            Bitwise_Or_<BuildActions(proto::_left),BuildActions(proto::_right)>()               
                >
{};
template<>
struct BuildActionsCases::case_<proto::tag::VCwise_xor>
    : proto::when<
            proto::VCwise_xor<BuildActions,BuildActions >,
