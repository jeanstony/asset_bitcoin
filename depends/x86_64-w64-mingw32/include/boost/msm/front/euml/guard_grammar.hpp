...
{};
template<>
struct BuildGuardsCases::case_<proto::tag::VCwise_and>
    : proto::when<
                    proto::VCwise_and<BuildGuards,BuildGuards >,
                    Bitwise_And_<BuildGuards(proto::_left),BuildGuards(proto::_right)>()
                >
{};
template<>
struct BuildGuardsCases::case_<proto::tag::VCwise_or>
    : proto::when<
                    proto::VCwise_or<BuildGuards,BuildGuards >,
...
{};
template<>
struct BuildGuardsCases::case_<proto::tag::VCwise_xor>
    : proto::when<
                    proto::VCwise_xor<BuildGuards,BuildGuards >,
