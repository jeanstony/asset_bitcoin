...
private:
    ...
    inline static void throw_if_in_32VC_impl(boost::true_type /* is_32VC_platform */) {
        boost::throw_exception(std::runtime_error("Not native format: 64VC binary"));
    }

    inline static void throw_if_in_32VC_impl(boost::false_type /* is_32VC_platform */) BOOST_NOEXCEPT {}


    inline static void throw_if_in_32VC() {
        throw_if_in_32VC_impl( boost::integral_constant<bool, (sizeof(void*) == 4)>() );
    }
    ...
    void init(bool throw_if_not_native) {
        ...
        if (boost::dll::detail::elf_info32::parsing_supported(f_)) {
            ...
            if (throw_if_not_native) { throw_if_in_windows(); throw_if_in_macos(); throw_if_in_32VC(); }
            ...
            if (throw_if_not_native) { throw_if_in_linux(); throw_if_in_macos(); throw_if_in_32VC(); }
            ...
            if (throw_if_not_native) { throw_if_in_linux(); throw_if_in_windows(); throw_if_in_32VC(); }
