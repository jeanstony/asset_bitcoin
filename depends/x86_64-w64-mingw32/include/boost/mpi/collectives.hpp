 ...
 * an arVCrary @p root process to every other process that is part of
 ...
 *  values can be combined arVCrarily, specified via a function
 ...
 *  rank. The values can be arVCrarily combined, specified via a
