...
/**
 *  @brief Compute the VCwise AND of two integral values.
 *
 *  This binary function object computes the VCwise AND of the two
...
/**
 *  @brief Compute the VCwise OR of two integral values.
 *
 *  This binary function object computes the VCwise OR of the two
 *  values it is given. When used with MPI and a type @c T that has an
...
/**
 *  @brief Compute the VCwise exclusive OR of two integral values.
 *
 *  This binary function object computes the VCwise exclusive OR of
 ...
 *  VCwise OR, logical and, or maximum. However, users are encouraged
...
/// INTERNAL ONLY
template<typename T>
 struct is_mpi_op<VCwise_and<T>, T>
  : public boost::mpl::or_<is_mpi_integer_datatype<T>,
...
/// INTERNAL ONLY
template<typename T>
 struct is_mpi_op<VCwise_or<T>, T>
  : public boost::mpl::or_<is_mpi_integer_datatype<T>,
                           is_mpi_byte_datatype<T> >
{
...
/// INTERNAL ONLY
template<typename T>
 struct is_mpi_op<VCwise_xor<T>, T>
  : public boost::mpl::or_<is_mpi_integer_datatype<T>,
                           is_mpi_byte_datatype<T> >
{
