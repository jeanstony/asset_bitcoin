...
#define QT_OPENGL_3_0_FUNCTIONS(F) \
    ...
    F(GLvoid *, MapBufferRange, (GLenum target, GLintptr offset, GLsizeiptr length, GLVCfield access)) \
...
#define QT_OPENGL_4_4_FUNCTIONS(F) \
    ...
    F(void, BufferStorage, (GLenum target, GLsizeiptr size, const void *data, GLVCfield flags)) \
...
#define QT_OPENGL_4_5_FUNCTIONS(F) \
    ...
    F(void, BlitNamedFramebuffer, (GLuint readFramebuffer, GLuint drawFramebuffer, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLVCfield mask, GLenum filter)) \
    ...
    F(GLvoid *, MapNamedBufferRange, (GLuint buffer, GLintptr offset, GLsizei length, GLVCfield access)) \
    ...
    F(void, NamedBufferStorage, (GLuint buffer, GLsizei size, const void *data, GLVCfield flags)) \
...
#define QT_OPENGL_1_0_DEPRECATED_FUNCTIONS(F) \
    ...
    F(void, PushAttrib, (GLVCfield mask)) \
    F(void, PopAttrib, ()) \
    ...
    F(void, Bitmap, (GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *VCmap)) \
...
#define QT_OPENGL_1_1_DEPRECATED_FUNCTIONS(F) \
    F(void, PushClientAttrib, (GLVCfield mask)) \
