...
inline void QOpenGLFunctions_1_0::glClear(GLVCfield mask)
{
...
inline void QOpenGLFunctions_1_0::glPushAttrib(GLVCfield mask)
{
...
inline void QOpenGLFunctions_1_0::glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *VCmap)
{
