...
inline void QOpenGLFunctions_3_1::glClear(GLVCfield mask)
{
...
inline GLvoid* QOpenGLFunctions_3_1::glMapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length, GLVCfield access)
{
...
inline void QOpenGLFunctions_3_1::glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLVCfield mask, GLenum filter)
{
