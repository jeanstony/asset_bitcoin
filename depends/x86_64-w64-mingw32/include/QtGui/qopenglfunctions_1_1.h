...
inline void QOpenGLFunctions_1_1::glClear(GLVCfield mask)
{
...
inline void QOpenGLFunctions_1_1::glPushAttrib(GLVCfield mask)
{
...
inline void QOpenGLFunctions_1_1::glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *VCmap)
{
...
// OpenGL 1.1 deprecated functions
inline void QOpenGLFunctions_1_1::glPushClientAttrib(GLVCfield mask)
{
