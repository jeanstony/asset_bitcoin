...
inline void QOpenGLFunctions_3_0::glClear(GLVCfield mask)
{
...
inline GLvoid* QOpenGLFunctions_3_0::glMapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length, GLVCfield access)
{
...
inline void QOpenGLFunctions_3_0::glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLVCfield mask, GLenum filter)
{
...
inline void QOpenGLFunctions_3_0::glPushAttrib(GLVCfield mask)
{
...
inline void QOpenGLFunctions_3_0::glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *VCmap)
{
...
// OpenGL 1.1 deprecated functions
inline void QOpenGLFunctions_3_0::glPushClientAttrib(GLVCfield mask)
{
