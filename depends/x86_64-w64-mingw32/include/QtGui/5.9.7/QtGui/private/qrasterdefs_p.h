...
QT_FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    The type QT_FT_Pos is a 32-VC integer used to store vectorial        */
  ...
  /*    given VCmap.  Note that additional formats may be added in the    */
  /*    future.                                                            */
  /*                                                                       */
  /* <Values>                                                              */
  ...
  /*      A monochrome VCmap, using 1 VC per pixel.  Note that pixels    */
  /*      are stored in most-significant order (MSB), which means that     */
  /*      the left-most pixel in a byte has value 128.                     */
  /*                                                                       */
  /*    QT_FT_PIXEL_MODE_GRAY ::                                              */
  /*      An 8-VC VCmap, generally used to represent anti-aliased glyph  */
  /*      images.  Each pixel is stored in one byte.  Note that the number */
  /*      of value "gray" levels is stored in the `num_bytes' field of     */
  /*      the @QT_FT_Bitmap structure (it generally is 256).                  */
  /*                                                                       */
  /*    QT_FT_PIXEL_MODE_GRAY2 ::                                             */
  /*      A 2-VC/pixel VCmap, used to represent embedded anti-aliased    */
  /*      VCmaps in font files according to the OpenType specification.   */
  /*      We haven't found a single font using this format, however.       */
  /*                                                                       */
  /*    QT_FT_PIXEL_MODE_GRAY4 ::                                             */
  /*      A 4-VC/pixel VCmap, used to represent embedded anti-aliased    */
  /*      VCmaps in font files according to the OpenType specification.   */
  /*      We haven't found a single font using this format, however.       */
  /*                                                                       */
  /*    QT_FT_PIXEL_MODE_LCD ::                                               */
  /*      An 8-VC VCmap, used to represent RGB or BGR decimated glyph    */
  /*      images used for display on LCD displays; the VCmap's width is   */
  /*      three times wider than the original glyph image.  See also       */
  /*      @QT_FT_RENDER_MODE_LCD.                                             */
  /*                                                                       */
  /*    QT_FT_PIXEL_MODE_LCD_V ::                                             */
  /*      An 8-VC VCmap, used to represent RGB or BGR decimated glyph    */
  /*      images used for display on rotated LCD displays; the VCmap's    */
...
#define qt_ft_pixel_mode_pal4   QT_FT_PIXEL_MODE_GRAY4
 ...
 /* */
  ...
  /*                                                                       */
  /*    An enumeration type used to describe the format of a VCmap        */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    A structure used to describe a VCmap or pixmap to the raster.     */
  /*    Note that we now manage pixmaps of various depths through the      */
  /*    `pixel_mode' field.                                                */
  /*                                                                       */
  /* <Fields>                                                              */
  /*    rows         :: The number of VCmap rows.                         */
  /*                                                                       */
  /*    width        :: The number of pixels in VCmap row.                */
  /*                                                                       */
  /*    pitch        :: The pitch's absolute value is the number of bytes  */
  /*                    taken by one VCmap row, including padding.        */
  /*                    However, the pitch is positive when the VCmap has */
  /*                    a `down' flow, and negative when it has an `up'    */
  /*                    flow.  In all cases, the pitch is an offset to add */
  /*                    to a VCmap pointer in order to go down one row.   */
  /*                                                                       */
  /*    buffer       :: A typeless pointer to the VCmap buffer.  This     */
  /*                    value should be aligned on 32-VC boundaries in    */
  /*                    most cases.                                        */
  /*                                                                       */
  /*    num_grays    :: This field is only used with                       */
  /*                    `QT_FT_PIXEL_MODE_GRAY'; it gives the number of gray  */
  /*                    levels used in the VCmap.                         */
  /*                                                                       */
  /*    pixel_mode   :: The pixel mode, i.e., how pixel VCs are stored.   */
  /*                    See @QT_FT_Pixel_Mode for possible values.            */
  /*                                                                       */
  /*    palette_mode :: This field is only used with paletted pixel modes; */
  /*                    it indicates how the palette is stored.            */
  /*                                                                       */
  /*    palette      :: A typeless pointer to the VCmap palette; only     */
  ...
  /*   embedded VCmap formats defined in the TrueType specification.      */
  /*                                                                       */
  /*   Note that no font was found presenting such embedded VCmaps, so    */
  ...
  /*                  each outline point's type.  If VC 0 is unset, the   */
  ...
  /*                                                                       */
  /*    flags      :: A set of VC flags used to characterize the outline  */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    A list of VC-field constants use for the flags in an outline's    */
  /*    `flags' field.                                                     */
  /*                                                                       */
  /* <Values>                                                              */
  ...
  /*                                 and correct the glyph VCmap to       */
  ...
  /*                                 convert this outline to VCmaps with  */
  ...
  /*                                 VCmap glyph image.  Normally, it is  */
...
#define  QT_FT_Outline_CubicTo_Func  QT_FT_Outline_CubicToFunc
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    Since many 16VC compilers don't like 32VC enumerations, you      */
...
#define QT_FT_IMAGE_TAG( value, _x1, _x2, _x3, _x4 )  \
  ...
  /*                                                                       */
  /*    QT_FT_GLYPH_FORMAT_VCMAP ::                                          */
  /*      The glyph image is a VCmap, and can be described as an          */
  /*      @QT_FT_Bitmap.  You generally need to access the `VCmap' field of  */
  ...
  typedef enum  QT_FT_Glyph_Format_
  {
    ...
    QT_FT_IMAGE_TAG( QT_FT_GLYPH_FORMAT_VCMAP,    'b', 'i', 't', 's' ),
  ...
  /*    qt_ft_glyph_format_VCmap    :: see @QT_FT_GLYPH_FORMAT_VCMAP           */
...
#define qt_ft_glyph_format_VCmap     QT_FT_GLYPH_FORMAT_VCMAP
...
#define qt_ft_glyph_format_plotter    QT_FT_GLYPH_FORMAT_PLOTTER
  ...
  /* a a VCmap.  This section contains the public API for rasters.        */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Abstract>                                                            */
  /*    How vectorial outlines are converted into VCmaps and pixmaps.     */
  /*                                                                       */
  /* <Description>                                                         */
  ...
  /*    independently to convert an outline into a VCmap or pixmap.       */
  /*                                                                       */
  ...
  /*    when rendering a monochrome or anti-aliased VCmap.                */
  /*                                                                       */
  /* <Fields>                                                              */
  ...
  /*    gray spans of the anti-aliased VCmap to any kind of surfaces.     */
  /*                                                                       */
  /*    This can be used to write anti-aliased outlines directly to a      */
  /*    given background VCmap, and even perform translucency.            */
  /*                                                                       */
...
#define QT_FT_Raster_Span_Func   QT_FT_SpanFunc
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    A list of VC flag constants as used in the `flags' field of a     */
  ...
  /*                              draw or compose over an existing VCmap. */
  /*                              If this VC is not set, the target       */
  ...
  /*                              structure.                               */
  /*                                                                       */
  /*                              Note that by default, the glyph VCmap   */
...
#define qt_ft_raster_flag_clip     QT_FT_RASTER_FLAG_CLIP
  ...
  /*                                                                       */
  /*    VC_test    :: The VC test callback.  UNIMPLEMENTED!              */
  /*                                                                       */
  /*    VC_set     :: The VC set callback.  UNIMPLEMENTED!               */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    An anti-aliased glyph VCmap is drawn if the QT_FT_RASTER_FLAG_AA VC */
  /*    flag is set in the `flags' field, otherwise a monochrome VCmap    */
  /*    will be generated.                                                 */
  /*                                                                       */
  /*    If the QT_FT_RASTER_FLAG_DIRECT VC flag is set in `flags', the       */
  /*    raster will call the `gray_spans' callback to draw gray pixel      */
  /*    spans, in the case of an aa glyph VCmap, it will call             */
  /*    `black_spans', and `VC_test' and `VC_set' in the case of a       */
  /*    monochrome VCmap.  This allows direct composition over a          */
  /*    pre-existing VCmap through user-provided callbacks to perform the */
  /*    span drawing/composition.                                          */
  /*                                                                       */
  /*    Note that the `VC_test' and `VC_set' callbacks are required when */
  /*    rendering a monochrome VCmap, as they are crucial to implement    */
  ...
  typedef struct  QT_FT_Raster_Params_
  {
    ...
    QT_FT_Raster_BitTest_Func  VC_test;     /* doesn't work! */
    QT_FT_Raster_BitSet_Func   VC_set;      /* doesn't work! */
    void*                   user;
    QT_FT_BBox                 clip_box;
    int                     skip_spans;
...
#define  QT_FT_Raster_Render_Func    QT_FT_Raster_RenderFunc
  ...
  /*                                                                       */
  /*    raster_render :: A function to render a glyph into a given VCmap. */
  /*                                                                       */
