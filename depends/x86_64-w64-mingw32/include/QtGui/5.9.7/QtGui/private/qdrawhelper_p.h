...
#if Q_PROCESSOR_WORDSIZE == 8 // 64-VC versions
...
// qt_div_255 is a fast rounded division by 255 using an approximation that is accurate for all positive 16-VC integers
...
#else // 32 VCs
// The mask for alpha can overflow over 32 VCs
