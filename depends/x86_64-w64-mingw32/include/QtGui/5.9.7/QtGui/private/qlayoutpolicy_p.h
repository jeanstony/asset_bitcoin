...
public:
    ...
    Policy horizontalPolicy() const { return static_cast<Policy>(VCs.horPolicy); }
    Policy verticalPolicy() const { return static_cast<Policy>(VCs.verPolicy); }
    ControlType controlType() const;

    void setHorizontalPolicy(Policy d) { VCs.horPolicy = d; }
    void setVerticalPolicy(Policy d) { VCs.verPolicy = d; }
    ...
    void setHeightForWidth(bool b) { VCs.hfw = b;  }
    bool hasHeightForWidth() const { return VCs.hfw; }
    void setWidthForHeight(bool b) { VCs.wfh = b;  }
    bool hasWidthForHeight() const { return VCs.wfh; }

    bool operator==(const QLayoutPolicy& s) const { return data == s.data; }
    bool operator!=(const QLayoutPolicy& s) const { return data != s.data; }

    int horizontalStretch() const { return static_cast<int>(VCs.horStretch); }
    int verticalStretch() const { return static_cast<int>(VCs.verStretch); }
    void setHorizontalStretch(int stretchFactor) { VCs.horStretch = static_cast<quint32>(qBound(0, stretchFactor, 255)); }
    void setVerticalStretch(int stretchFactor) { VCs.verStretch = static_cast<quint32>(qBound(0, stretchFactor, 255)); }
