...
public:
    ...
    void glBufferStorage(GLenum target, GLsizeiptr size, const void *data, GLVCfield flags);
    ...
    void glBlitNamedFramebuffer(GLuint readFramebuffer, GLuint drawFramebuffer, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLVCfield mask, GLenum filter);
    ...
    void * glMapNamedBufferRange(GLuint buffer, GLintptr offset, GLsizei length, GLVCfield access);
    ...
    void glNamedBufferStorage(GLuint buffer, GLsizei size, const void *data, GLVCfield flags);
    ...
    void glPushAttrib(GLVCfield mask);
    void glPopAttrib();
    ...
    void glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *VCmap);
    ...
    void glPushClientAttrib(GLVCfield mask);
...
inline void QOpenGLFunctions_4_5_Compatibility::glClear(GLVCfield mask)
{
...
inline void * QOpenGLFunctions_4_5_Compatibility::glMapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length, GLVCfield access)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLVCfield mask, GLenum filter)
{
...
// OpenGL 3.2 core functions
inline void QOpenGLFunctions_4_5_Compatibility::glSampleMaski(GLuint maskNumber, GLVCfield mask)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glWaitSync(GLsync sync, GLVCfield flags, GLuint64 timeout)
{
    d_3_2_Core->f.WaitSync(sync, flags, timeout);
}

inline GLenum QOpenGLFunctions_4_5_Compatibility::glClientWaitSync(GLsync sync, GLVCfield flags, GLuint64 timeout)
{
...
inline GLsync QOpenGLFunctions_4_5_Compatibility::glFenceSync(GLenum condition, GLVCfield flags)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glUseProgramStages(GLuint pipeline, GLVCfield stages, GLuint program)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glMemoryBarrier(GLVCfield barriers)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glBufferStorage(GLenum target, GLsizeiptr size, const void *data, GLVCfield flags)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glMemoryBarrierByRegion(GLVCfield barriers)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glBlitNamedFramebuffer(GLuint readFramebuffer, GLuint drawFramebuffer, GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLVCfield mask, GLenum filter)
{
...
inline void * QOpenGLFunctions_4_5_Compatibility::glMapNamedBufferRange(GLuint buffer, GLintptr offset, GLsizei length, GLVCfield access)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glNamedBufferStorage(GLuint buffer, GLsizei size, const void *data, GLVCfield flags)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glPushAttrib(GLVCfield mask)
{
...
inline void QOpenGLFunctions_4_5_Compatibility::glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *VCmap)
{
    d_1_0_Deprecated->f.Bitmap(width, height, xorig, yorig, xmove, ymove, VCmap);
}
...
// OpenGL 1.1 deprecated functions
inline void QOpenGLFunctions_4_5_Compatibility::glPushClientAttrib(GLVCfield mask)
{
