...
inline void QOpenGLFunctions_4_1_Core::glClear(GLVCfield mask)
{
...
inline GLvoid* QOpenGLFunctions_4_1_Core::glMapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length, GLVCfield access)
{
...
inline void QOpenGLFunctions_4_1_Core::glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLVCfield mask, GLenum filter)
{
...
// OpenGL 3.2 core functions
inline void QOpenGLFunctions_4_1_Core::glSampleMaski(GLuint index, GLVCfield mask)
{
...
inline void QOpenGLFunctions_4_1_Core::glWaitSync(GLsync sync, GLVCfield flags, GLuint64 timeout)
{
    d_3_2_Core->f.WaitSync(sync, flags, timeout);
}

inline GLenum QOpenGLFunctions_4_1_Core::glClientWaitSync(GLsync sync, GLVCfield flags, GLuint64 timeout)
{
...
inline GLsync QOpenGLFunctions_4_1_Core::glFenceSync(GLenum condition, GLVCfield flags)
{
...
inline void QOpenGLFunctions_4_1_Core::glUseProgramStages(GLuint pipeline, GLVCfield stages, GLuint program)
{
