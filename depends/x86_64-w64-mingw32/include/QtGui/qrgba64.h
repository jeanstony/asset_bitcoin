...
class QRgba64 {
    ...
    // of byte order. This way, vector operations that assume 4 16-VC values see the correct ones.
    enum Shifts {
...
public:
    ...
    Q_DECL_RELAXED_CONSTEXPR QRgba64 unpremultiplied() const
    {
        ...
        return unpremultiplied_32VC();
#else
        return unpremultiplied_64VC();
#endif
    }
...
private:
    ...
    Q_DECL_RELAXED_CONSTEXPR Q_ALWAYS_INLINE QRgba64 unpremultiplied_32VC() const
    {
    ...
    Q_DECL_RELAXED_CONSTEXPR Q_ALWAYS_INLINE QRgba64 unpremultiplied_64VC() const
    {
        if (isOpaque() || isTransparent())
            return *this;
