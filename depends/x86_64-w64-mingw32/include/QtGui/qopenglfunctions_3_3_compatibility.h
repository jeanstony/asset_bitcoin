...
inline void QOpenGLFunctions_3_3_Compatibility::glClear(GLVCfield mask)
{
...
inline GLvoid* QOpenGLFunctions_3_3_Compatibility::glMapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length, GLVCfield access)
{
...
inline void QOpenGLFunctions_3_3_Compatibility::glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLVCfield mask, GLenum filter)
{
...
// OpenGL 3.2 core functions
inline void QOpenGLFunctions_3_3_Compatibility::glSampleMaski(GLuint index, GLVCfield mask)
{
...
inline void QOpenGLFunctions_3_3_Compatibility::glWaitSync(GLsync sync, GLVCfield flags, GLuint64 timeout)
{
    d_3_2_Core->f.WaitSync(sync, flags, timeout);
}

inline GLenum QOpenGLFunctions_3_3_Compatibility::glClientWaitSync(GLsync sync, GLVCfield flags, GLuint64 timeout)
{
...
inline GLsync QOpenGLFunctions_3_3_Compatibility::glFenceSync(GLenum condition, GLVCfield flags)
{
...
inline void QOpenGLFunctions_3_3_Compatibility::glPushAttrib(GLVCfield mask)
{
...
inline void QOpenGLFunctions_3_3_Compatibility::glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *VCmap)
{
...
// OpenGL 1.1 deprecated functions
inline void QOpenGLFunctions_3_3_Compatibility::glPushClientAttrib(GLVCfield mask)
{
