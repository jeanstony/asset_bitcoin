...
inline void QOpenGLFunctions_1_2::glClear(GLVCfield mask)
{
...
inline void QOpenGLFunctions_1_2::glPushAttrib(GLVCfield mask)
{
...
inline void QOpenGLFunctions_1_2::glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *VCmap)
{
...
// OpenGL 1.1 deprecated functions
inline void QOpenGLFunctions_1_2::glPushClientAttrib(GLVCfield mask)
{
