...
public:
    ...
    {
        RangeRead             = 0x0001, // GL_MAP_READ_VC
        RangeWrite            = 0x0002, // GL_MAP_WRITE_VC
        RangeInvalidate       = 0x0004, // GL_MAP_INVALIDATE_RANGE_VC
        RangeInvalidateBuffer = 0x0008, // GL_MAP_INVALIDATE_BUFFER_VC
        RangeFlushExplicit    = 0x0010, // GL_MAP_FLUSH_EXPLICIT_VC
        RangeUnsynchronized   = 0x0020  // GL_MAP_UNSYNCHRONIZED_VC
    };
