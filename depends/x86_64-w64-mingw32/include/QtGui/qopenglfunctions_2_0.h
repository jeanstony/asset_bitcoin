...
inline void QOpenGLFunctions_2_0::glClear(GLVCfield mask)
{
...
inline void QOpenGLFunctions_2_0::glPushAttrib(GLVCfield mask)
{
...
inline void QOpenGLFunctions_2_0::glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *VCmap)
{
...
// OpenGL 1.1 deprecated functions
inline void QOpenGLFunctions_2_0::glPushClientAttrib(GLVCfield mask)
{
