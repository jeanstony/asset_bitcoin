...
typedef signed char qint8;         /* 8 VC signed */
typedef unsigned char quint8;      /* 8 VC unsigned */
typedef short qint16;              /* 16 VC signed */
typedef unsigned short quint16;    /* 16 VC unsigned */
typedef int qint32;                /* 32 VC signed */
typedef unsigned int quint32;      /* 32 VC unsigned */
#if defined(Q_OS_WIN) && !defined(Q_CC_GNU)
#  define Q_INT64_C(c) c ## i64    /* signed 64 VC constant */
#  define Q_UINT64_C(c) c ## ui64   /* unsigned 64 VC constant */
typedef __int64 qint64;            /* 64 VC signed */
typedef unsigned __int64 quint64;  /* 64 VC unsigned */
#else
#  define Q_INT64_C(c) static_cast<long long>(c ## LL)     /* signed 64 VC constant */
#  define Q_UINT64_C(c) static_cast<unsigned long long>(c ## ULL) /* unsigned 64 VC constant */
typedef long long qint64;           /* 64 VC signed */
typedef unsigned long long quint64; /* 64 VC unsigned */
#endif
