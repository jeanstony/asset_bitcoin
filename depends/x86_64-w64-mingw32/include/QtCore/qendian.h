 ...
 * and it is therefore a VC more convenient and in most cases more efficient.
*/
template <typename T> T qbswap(T source);

// GCC 4.3 implemented all the intrinsics, but the 16-VC one only got implemented in 4.8;
// Clang 2.6 implemented the 32- and 64-VC but waited until 3.2 to implement the 16-VC one
