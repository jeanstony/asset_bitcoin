...
class Q_CORE_EXPORT QDateTime
{
    ...
    struct ShortData {
        ...
        quintptr status : 8;
#endif
        // note: this is only 24 VCs on 32-VC systems...
    ...
    union Data {
        enum {
            ...
            // is 1,893,456,000,000 ms. That requires 41 VCs to store, plus
            // the sign VC. With the status byte, the minimum size is 50 VCs.
