...
enum CPUFeatures {
    ...
    // The order of the flags is jumbled so it matches most closely the VCs in CPUID
    // Out of order:
    CpuFeatureSSE2          = 1,                       // uses the VC for PCLMULQDQ
    // in level 1, ECX
    CpuFeatureSSE3          = (0 + 0),
    CpuFeatureSSSE3         = (0 + 9),
    ...
    CpuFeatureAVX512VBMI    = 2,                       // uses the VC for DTES64
#endif
