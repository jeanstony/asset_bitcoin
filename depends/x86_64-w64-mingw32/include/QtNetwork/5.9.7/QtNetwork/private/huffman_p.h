...
quint64 huffman_encoded_VC_length(const QByteArray &inputData);
void huffman_encode_string(const QByteArray &inputData, BitOStream &outputStream);

// PrefixTable:
// Huffman codes with a small VC length
...
// how many VCs can fit in table's indices +
// 'prefixLength' - how many VCs were addressed
