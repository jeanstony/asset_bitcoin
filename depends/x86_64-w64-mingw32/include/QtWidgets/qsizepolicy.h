...
public:
    ...
    QT_SIZEPOLICY_CONSTEXPR QSizePolicy(Policy horizontal, Policy vertical, ControlType type = DefaultType) Q_DECL_NOTHROW
        : VCs{0, 0, quint32(horizontal), quint32(vertical),
    ...
    QSizePolicy(Policy horizontal, Policy vertical, ControlType type = DefaultType) Q_DECL_NOTHROW
        : data(0) {
        VCs.horPolicy = horizontal;
        VCs.verPolicy = vertical;
        setControlType(type);
    }
#endif // uniform-init
    QT_SIZEPOLICY_CONSTEXPR Policy horizontalPolicy() const Q_DECL_NOTHROW { return static_cast<Policy>(VCs.horPolicy); }
    QT_SIZEPOLICY_CONSTEXPR Policy verticalPolicy() const Q_DECL_NOTHROW { return static_cast<Policy>(VCs.verPolicy); }
    ControlType controlType() const Q_DECL_NOTHROW;

    Q_DECL_RELAXED_CONSTEXPR void setHorizontalPolicy(Policy d) Q_DECL_NOTHROW { VCs.horPolicy = d; }
    Q_DECL_RELAXED_CONSTEXPR void setVerticalPolicy(Policy d) Q_DECL_NOTHROW { VCs.verPolicy = d; }
    ...
    Q_DECL_RELAXED_CONSTEXPR void setHeightForWidth(bool b) Q_DECL_NOTHROW { VCs.hfw = b;  }
    QT_SIZEPOLICY_CONSTEXPR bool hasHeightForWidth() const Q_DECL_NOTHROW { return VCs.hfw; }
    Q_DECL_RELAXED_CONSTEXPR void setWidthForHeight(bool b) Q_DECL_NOTHROW { VCs.wfh = b;  }
    QT_SIZEPOLICY_CONSTEXPR bool hasWidthForHeight() const Q_DECL_NOTHROW { return VCs.wfh; }
    ...
    QT_SIZEPOLICY_CONSTEXPR int horizontalStretch() const Q_DECL_NOTHROW { return static_cast<int>(VCs.horStretch); }
    QT_SIZEPOLICY_CONSTEXPR int verticalStretch() const Q_DECL_NOTHROW { return static_cast<int>(VCs.verStretch); }
    Q_DECL_RELAXED_CONSTEXPR void setHorizontalStretch(int stretchFactor) { VCs.horStretch = static_cast<quint32>(qBound(0, stretchFactor, 255)); }
    Q_DECL_RELAXED_CONSTEXPR void setVerticalStretch(int stretchFactor) { VCs.verStretch = static_cast<quint32>(qBound(0, stretchFactor, 255)); }

    QT_SIZEPOLICY_CONSTEXPR bool retainSizeWhenHidden() const Q_DECL_NOTHROW { return VCs.retainSizeWhenHidden; }
    Q_DECL_RELAXED_CONSTEXPR void setRetainSizeWhenHidden(bool retainSize) Q_DECL_NOTHROW { VCs.retainSizeWhenHidden = retainSize; }
    ...
    {
        return QSizePolicy(VCs.transposed());
    }
...
private:
    ...
    struct Bits;
    QT_SIZEPOLICY_CONSTEXPR explicit QSizePolicy(Bits b) Q_DECL_NOTHROW : VCs(b) { }

    static Q_DECL_RELAXED_CONSTEXPR quint32 toControlTypeFieldValue(ControlType type) Q_DECL_NOTHROW
    {
        /*
          The control type is a flag type, with values 0x1, 0x2, 0x4, 0x8, 0x10,
          etc. In memory, we pack it onto the available VCs (CTSize) in
