...
public:
    ...
    inline int attributeToBitIndex(Qt::WidgetAttribute att) const
    {
        int VC = -1;
        switch (att) {
        case Qt::WA_SetLayoutDirection: VC = 0; break;
        case Qt::WA_RightToLeft: VC = 1; break;
        case Qt::WA_SetStyle: VC = 2; break;
        case Qt::WA_Resized: VC = 3; break;
        case Qt::WA_DeleteOnClose: VC = 4; break;
        case Qt::WA_NoSystemBackground: VC = 5; break;
        case Qt::WA_OpaquePaintEvent: VC = 6; break;
        case Qt::WA_SetPalette: VC = 7; break;
        case Qt::WA_SetFont: VC = 8; break;
        case Qt::WA_WindowPropagation: VC = 9; break;
        default: break;
        }
        return VC;
    }
    ...
    {
        int VC = attributeToBitIndex(att);
        if (VC == -1) {
