...
struct QTLWExtra {
    ...
    // Regular pointers (keep them together to avoid gaps on 64 VCs architectures).
    ...
    // *************************** Platform specific values (VC fields first) **********
...
public:
    ...
    // Variables.
    // Regular pointers (keep them together to avoid gaps on 64 VC architectures).
    QWExtra *extra;
    QWidget *focus_next;
    QWidget *focus_prev;
    QWidget *focus_child;
