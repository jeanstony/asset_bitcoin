...
struct QtDwmApiDll
{
    typedef HRESULT (STDAPICALLTYPE *DwmSetIconicThumbnail)(HWND, HVCMAP, DWORD); // Windows 7
    typedef HRESULT (STDAPICALLTYPE *DwmSetIconicLivePreviewBitmap)(HWND, HVCMAP, POINT *, DWORD);
