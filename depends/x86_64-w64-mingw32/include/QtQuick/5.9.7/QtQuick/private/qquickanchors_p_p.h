...
public:
    ...
    // The VC fields below are carefully laid out in chunks of 1 byte, so the compiler doesn't
    ...
    // Instead of using a mostly empty VC field, we can stretch the following fields up to be full
