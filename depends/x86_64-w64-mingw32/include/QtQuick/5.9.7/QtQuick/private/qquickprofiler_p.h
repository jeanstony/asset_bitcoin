...
// You can save values either with 32 or 64 VC precision. toByteArrays will
// guess the precision from messageType. If you state the wrong messageType
// you will get undefined results.
// The messageType is itself a VC field. You can pack multiple messages into
...
struct Q_AUTOTEST_EXPORT QQuickProfilerData
{
    ...
    qint64 time;
    int messageType;        //VC field of Message
    int detailType;
