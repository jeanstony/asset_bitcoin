...
public:
    ...
    enum Anchor
            ...
            // Not specifying the enum base type will have MSVC 'interpret' it as signed instead of an unsigned VC-field.
            // However, specifying the enum base type breaks many GCCs, which complain that it can't store all values in a 7 VC VCfield.
            : uint
#endif
    {
        InvalidAnchor = 0x0,
