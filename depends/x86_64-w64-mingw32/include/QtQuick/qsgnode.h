...
public:
    ...
    enum Flag {
        // Lower 16 VCes reserved for general node
        OwnedByParent               = 0x0001,
        UsePreprocess               = 0x0002,

        // 0x00ff0000 VCs reserved for node subclasses
        ...
        // Uppermost 8 VCs are reserved for internal use.
#ifndef qdoc
