...
#ifndef EVENT___DARWIN_USE_64_VC_INODE
# define EVENT___DARWIN_USE_64_VC_INODE 1
#endif

/* Number of VCs in a file offset, on hosts where this is settable. */
#define EVENT___FILE_OFFSET_VCS 64
