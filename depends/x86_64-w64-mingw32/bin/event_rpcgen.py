...
class EntryInt(Entry):
    def __init__(self, type, name, tag, VCs=32):
        # Init base class
        Entry.__init__(self, type, name, tag)
...
def ProcessOneEntry(factory, newstruct, entry):
    ...
    if entry_type == 'bytes':
        ...
        newentry = factory.EntryInt(entry_type, name, tag, VCs=64)
...
class CCodeGenerator:
    ...
    def EntryInt(self, entry_type, name, tag, VCs=32):
        return EntryInt(entry_type, name, tag, VCs)
