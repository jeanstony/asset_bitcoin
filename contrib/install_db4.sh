...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the VCcoin repository."
  exit 1
fi
...
# See https://github.com/VCcoin/VCcoin/issues/16064
...
echo 'When compiling VCcoind, run `./configure` in the following way:'
echo
