...
public:
    ...
    void AddCoinAsset(const CoinAsset& ca) override { m_notifications->AddCoinAsset(ca); };
    void RemoveCoinAsset(const CoinAsset& ca) override { m_notifications->RemoveCoinAsset(ca); };
    void NotifyMainAssetFound() override { m_notifications->NotifyMainAssetFound(); };
    void NotifyAssetStatusChanged(const int AssetNo) override { m_notifications->NotifyAssetStatusChanged(AssetNo); };
