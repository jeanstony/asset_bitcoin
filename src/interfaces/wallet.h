...
#ifndef VCCOIN_INTERFACES_WALLET_H
#define VCCOIN_INTERFACES_WALLET_H
...
public:
    ...
    //! Return deVC amount if transaction input belongs to wallet.
    virtual CAmount getDeVC(const CTxIn& txin, isminefilter filter) = 0;
...
#endif // VCCOIN_INTERFACES_WALLET_H
