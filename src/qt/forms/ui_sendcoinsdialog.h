...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        widgetCoinControl->setGeometry(QRect(11, 73, 514, 58));
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 VC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 VC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 VC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 VC"));
        ...
        layoutWidget = new QWidget(frameCoinControl);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(0, 0, 149, 28));
        horizontalLayoutCoinControl1 = new QHBoxLayout(layoutWidget);
        horizontalLayoutCoinControl1->setObjectName(QStringLiteral("horizontalLayoutCoinControl1"));
        horizontalLayoutCoinControl1->setContentsMargins(0, 0, 0, 15);
        labelCoinControlFeatures = new QLabel(layoutWidget);
        ...
        layoutWidget1 = new QWidget(frameCoinControl);
        layoutWidget1->setObjectName(QStringLiteral("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(0, 0, 426, 34));
        horizontalLayoutCoinControl2 = new QHBoxLayout(layoutWidget1);
        ...
        horizontalLayoutCoinControl2->setContentsMargins(0, 0, 0, 10);
        pushButtonCoinControl = new QPushButton(layoutWidget1);
        ...
        labelCoinControlAutomaticallySelected = new QLabel(layoutWidget1);
        ...
        labelCoinControlInsuffFunds = new QLabel(layoutWidget1);
        ...
        layoutWidget2 = new QWidget(frameCoinControl);
        layoutWidget2->setObjectName(QStringLiteral("layoutWidget2"));
        layoutWidget2->setGeometry(QRect(0, 0, 324, 26));
        horizontalLayoutCoinControl4 = new QHBoxLayout(layoutWidget2);
        ...
        horizontalLayoutCoinControl4->setContentsMargins(0, 5, 5, 0);
        checkBoxCoinControlChange = new QCheckBox(layoutWidget2);
        ...
        lineEditCoinControlChange = new QValidatedLineEdit(layoutWidget2);
        ...
        labelCoinControlChangeLabel = new QLabel(layoutWidget2);
        ...
        frame = new QFrame(SendCoinsDialog);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 566, 272));
        ...
        balancelist = new QTreeView(frame);
        balancelist->setObjectName(QStringLiteral("balancelist"));
        QSizePolicy sizePolicy5(QSizePolicy::Fixed, QSizePolicy::Expanding);
        sizePolicy5.setHorizontalStretch(0);
        sizePolicy5.setVerticalStretch(0);
        sizePolicy5.setHeightForWidth(balancelist->sizePolicy().hasHeightForWidth());
        balancelist->setSizePolicy(sizePolicy5);
        balancelist->setMinimumSize(QSize(200, 0));

        horizontalLayout_3->addWidget(balancelist);
        ...
        sizePolicy3.setHeightForWidth(frameFee->sizePolicy().hasHeightForWidth());
        frameFee->setSizePolicy(sizePolicy3);
        ...
        frameFeeSelection->setProperty("OnlyForFee", QVariant(true));
        ...
        customFee = new VccoinAmountField(frameFeeSelection);
        ...
        labelBalance->setText(QStringLiteral("123.456 VC"));
...
#ifndef QT_NO_TOOLTIP
        labelCustomFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for VCcoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
