...
public:
    ...
    QPushButton *openVccoinConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        VCcoinAtStartup = new QCheckBox(tabMain);
        VCcoinAtStartup->setObjectName(QStringLiteral("VCcoinAtStartup"));

        verticalLayout_Main->addWidget(VCcoinAtStartup);
        ...
        openVccoinConfButton = new QPushButton(OptionsDialog);
        openVccoinConfButton->setObjectName(QStringLiteral("openVccoinConfButton"));
        openVccoinConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openVccoinConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        VCcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        VCcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Vccoin client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Vccoin network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Vccoin network through a separate SOCKS5 proxy for Tor hidden services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        openVccoinConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        openVccoinConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
