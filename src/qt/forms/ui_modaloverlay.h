...
"QLabel { color: rgb(40,40,40);  }"));
    ...
    void retranslateUi(ModalOverlay *ModalOverlay)
    {
        ...
        infoText->setText(QApplication::translate("ModalOverlay", "Recent transactions may not yet be visible, and therefore your wallet's balance might be incorrect. This information will be correct once your wallet has finished synchronizing with the VCcoin network, as detailed below.", Q_NULLPTR));
        infoTextStrong->setText(QApplication::translate("ModalOverlay", "Attempting to spend VCcoins that are affected by not-yet-displayed transactions will not be accepted by the network.", Q_NULLPTR));
