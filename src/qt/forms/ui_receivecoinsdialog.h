...
public:
    ...
    void setupUi(QWidget *ReceiveCoinsDialog)
    {
        ...
        reqAmount = new VccoinAmountField(frame2);
        ...
        useLegacyAddress = new QCheckBox(frame2);
        useLegacyAddress->setObjectName(QStringLiteral("useLegacyAddress"));
        sizePolicy2.setHeightForWidth(useLegacyAddress->sizePolicy().hasHeightForWidth());
        useLegacyAddress->setSizePolicy(sizePolicy2);
        useLegacyAddress->setMaximumSize(QSize(1000, 16777215));
        useLegacyAddress->setFocusPolicy(Qt::StrongFocus);

        horizontalLayout_6->addWidget(useLegacyAddress);
        ...
        QWidget::setTabOrder(reqAmount, useLegacyAddress);
        QWidget::setTabOrder(useLegacyAddress, reqMessage);
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the Vccoin network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        reqMessage->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the Vccoin network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        useLegacyAddress->setToolTip(QApplication::translate("ReceiveCoinsDialog", "Native segwit addresses (aka Bech32 or BIP-173) reduce your transaction fees later on and offer better protection against typos, but old wallets don't support them. When checked, an address compatible with older wallets will be created instead.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        useLegacyAddress->setText(QApplication::translate("ReceiveCoinsDialog", "Generate legacy address", Q_NULLPTR));
