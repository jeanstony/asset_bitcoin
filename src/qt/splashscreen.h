...
#ifndef VCCOIN_QT_SPLASHSCREEN_H
#define VCCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Vccoin Core initialization
...
#endif // VCCOIN_QT_SPLASHSCREEN_H
