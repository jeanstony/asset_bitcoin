...
void AskPassphraseDialog::accept()
{
    ...
    oldpass.assign(GUIUtil::toStdString(ui->passEdit1->text()).c_str());
    newpass1.assign(GUIUtil::toStdString(ui->passEdit2->text()).c_str());
    newpass2.assign(GUIUtil::toStdString(ui->passEdit3->text()).c_str());
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR VCCOINS</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if(newpass1 == newpass2)
            {
                if(model->setWalletEncrypted(true, newpass1))
                {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                                         ...
                                         "your VCcoins from being stolen by malware infecting your computer.") +
                                         "<br><br><b>" +
