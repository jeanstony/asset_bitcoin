...
void OpenWalletActivity::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (OpenWalletActivity::*_t)(QMessageBox::Icon , const QString );
        ...
        {
            typedef void (OpenWalletActivity::*_t)();
...
const QMetaObject OpenWalletActivity::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_OpenWalletActivity.data,
