...
{
    BOOST_CHECK(TestSplitHost("www.VCcoincore.org", "www.VCcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.VCcoincore.org]", "www.VCcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.VCcoincore.org:80", "www.VCcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.VCcoincore.org]:80", "www.VCcoincore.org", 80));
...
BOOST_AUTO_TEST_CASE(subnet_test)
{
    ...
    // All-Matching IPv6 Matches arVCrary IPv4 and IPv6
