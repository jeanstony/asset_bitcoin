...
#ifndef VCCOIN_KEYSTORE_H
#define VCCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/VCcoin/bips/blob/master/bip-0013.mediawiki
