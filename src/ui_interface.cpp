// Copyright (c) 2010-2018 The Vccoin Core developers
...
struct UISignals {
    ...
    boost::signals2::signal<CClientUIInterface::AddCoinAssetSig> AddCoinAsset;
    boost::signals2::signal<CClientUIInterface::RemoveCoinAssetSig> RemoveCoinAsset;
    boost::signals2::signal<CClientUIInterface::NotifyMainAssetFoundSig> NotifyMainAssetFound;
    boost::signals2::signal<CClientUIInterface::NotifyAssetStatusChangedSig> NotifyAssetStatusChanged;
};
...
ADD_SIGNALS_IMPL_WRAPPER(AddCoinAsset);
ADD_SIGNALS_IMPL_WRAPPER(RemoveCoinAsset);
ADD_SIGNALS_IMPL_WRAPPER(NotifyMainAssetFound);
ADD_SIGNALS_IMPL_WRAPPER(NotifyAssetStatusChanged);
...
void CClientUIInterface::AddCoinAsset(const CoinAsset& ca) { return g_ui_signals.AddCoinAsset(ca); }
void CClientUIInterface::RemoveCoinAsset(const CoinAsset& ca) { return g_ui_signals.RemoveCoinAsset(ca); }
void CClientUIInterface::NotifyMainAssetFound() { return g_ui_signals.NotifyMainAssetFound(); }
void CClientUIInterface::NotifyAssetStatusChanged(const int AssetNo) { return g_ui_signals.NotifyAssetStatusChanged(AssetNo); }
