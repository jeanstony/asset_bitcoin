...
#ifndef VCCOIN_SCRIPT_STANDARD_H
#define VCCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a VCcoin address
 */
...
/**
 * Generate a Vccoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // VCCOIN_SCRIPT_STANDARD_H
