...
#ifndef VCCOIN_UI_INTERFACE_H
#define VCCOIN_UI_INTERFACE_H
...
#define ADD_SIGNALS_DECL_WRAPPER(signal_name, rtype, ...) \
    ...
    ADD_SIGNALS_DECL_WRAPPER(AddCoinAsset, void, const CoinAsset&);
    ADD_SIGNALS_DECL_WRAPPER(RemoveCoinAsset, void, const CoinAsset&);

    ADD_SIGNALS_DECL_WRAPPER(NotifyMainAssetFound, void, void);
    ADD_SIGNALS_DECL_WRAPPER(NotifyAssetStatusChanged, void, const int);
