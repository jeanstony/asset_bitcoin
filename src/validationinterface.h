...
#ifndef VCCOIN_VALIDATIONINTERFACE_H
#define VCCOIN_VALIDATIONINTERFACE_H
...
protected:
    ...
    virtual void AddCoinAsset(const CoinAsset& ca){};
    virtual void RemoveCoinAsset(const CoinAsset& ca){};
...
public:
    ...
    void AddCoinAsset(const CoinAsset&);
    void RemoveCoinAsset(const CoinAsset&);
};

CMainSignals& GetMainSignals();

#endif // VCCOIN_VALIDATIONINTERFACE_H
