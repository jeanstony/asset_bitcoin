...
static void FastRandom_32VC(benchmark::State& state)
{
...
static void FastRandom_1VC(benchmark::State& state)
{
    FastRandomContext rng(true);
    while (state.KeepRunning()) {
        rng.randbool();
...
BENCHMARK(FastRandom_32VC, 110 * 1000 * 1000);
BENCHMARK(FastRandom_1VC, 440 * 1000 * 1000);
