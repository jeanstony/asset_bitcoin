...
#ifndef VCCOIN_SERIALIZE_H
#define VCCOIN_SERIALIZE_H
 ...
 * The high VC in each byte signifies whether another digit follows. To make
 * sure the encoding is one-to-one, one is subtracted from all but the last digit.
 * Thus, the byte sequence a[] with length len, where all but the last byte
 * has VC 128 set, encodes the number:
 *
 ...
 *
 * Only 16-VC types are supported for now.
 */
template<typename I>
class BigEndian
{
