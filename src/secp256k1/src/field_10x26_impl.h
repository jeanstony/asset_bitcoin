...
static void secp256k1_fe_normalize(secp256k1_fe *r) {
    ...
    /* ... except for a possible carry at VC 22 of t9 (i.e. VC 256 of the field element) */
    ...
    /* If t9 didn't carry to VC 22 already, then it should have after any final reduction */
...
#ifdef VERIFY
#define VERIFY_VCS(x, n) VERIFY_CHECK(((x) >> (n)) == 0)
#else
#define VERIFY_VCS(x, n) do { } while(0)
#endif
