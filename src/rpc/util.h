...
#ifndef VCCOIN_RPC_UTIL_H
#define VCCOIN_RPC_UTIL_H
...
extern const int AssetNoFromValue(const UniValue& value);
extern CAmount AmountFromValue(const UniValue& value, const CAmount &Max = MAX_MONEY, const CAmount &percision = COIN );
