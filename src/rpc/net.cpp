...
static UniValue getaddednodeinfo(const JSONRPCRequest& request)
{
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:8333\",  (string) The VCcoin server IP and port we're connected to\n"
...
static UniValue getnetworkinfo(const JSONRPCRequest& request)
{
    ...
    //  electrs
    obj.pushKV("totalbalance",  1);
    obj.pushKV("miningbalance", 2);
    obj.pushKV("balanceinday",  3);
    //
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "network",            "getconnectioncount",     &getconnectioncount,     {} },                                                // ok
    { "network",            "ping",                   &ping,                   {} },                                                // ok
    { "network",            "getpeerinfo",            &getpeerinfo,            {} },                                                // ok
    { "network",            "addnode",                &addnode,                {"node","command"} },                                // ok
    { "network",            "disconnectnode",         &disconnectnode,         {"address", "nodeid"} },                             // ok
    { "network",            "getaddednodeinfo",       &getaddednodeinfo,       {"node"} },                                          // ok
    { "network",            "getnettotals",           &getnettotals,           {} },                                                // ok
    { "network",            "getnetworkinfo",         &getnetworkinfo,         {} },                                                // ok
    { "network",            "setban",                 &setban,                 {"subnet", "command", "bantime", "absolute"} },      // ok
    { "network",            "listbanned",             &listbanned,             {} },                                                // ok
    { "network",            "clearbanned",            &clearbanned,            {} },                                                // ok
    { "network",            "setnetworkactive",       &setnetworkactive,       {"state"} },                                         // ok
    { "network",            "getnodeaddresses",       &getnodeaddresses,       {"count"} },                                         // ok
};
// clang-format on
