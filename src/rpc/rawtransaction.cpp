...
{
    // Call into TxToUniv() in VCcoin-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in VCcoin-common, so we query them here and push the
...
UniValue decodepsbt(const JSONRPCRequest& request)
{
    ...
    return retobj;
            ...
            RPCHelpMan{"decodepsbt",
                "\nReturn a JSON object representing the serialized, base64-encoded partially signed Vccoin transaction.\n",
                {
            ...
            "          \"hex\" : \"hex\",            (string) The hex\n"
            "          \"type\" : \"pubkeyhash\",    (string) The type, eg 'pubkeyhash'\n"
            "          \"address\" : \"address\"     (string) Vccoin address if there is one\n"
            "        }\n"
            "      },\n"
...
UniValue combinepsbt(const JSONRPCRequest& request)
{
    ...
    return retobj;
            ...
            RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed Vccoin transactions into one transaction.\n"
...
{ //  category              name                            actor (function)            argNames
  //  --------------------- ------------------------        -----------------------     ----------
    { "rawtransactions",    "getrawtransaction",            &getrawtransaction,         {"txid","verbose","blockhash"} },                       // ok
    { "rawtransactions",    "createrawtransaction",         &createrawtransaction,      {"inputs","outputs","locktime","replaceable"} },        // not yet supportted 
    { "rawtransactions",    "decoderawtransaction",         &decoderawtransaction,      {"hexstring","iswitness"} },                            // ok
    { "rawtransactions",    "decodescript",                 &decodescript,              {"hexstring"} },                                        // ok
    { "rawtransactions",    "sendrawtransaction",           &sendrawtransaction,        {"hexstring","allowhighfees|maxfeerate"} },             // not yet supportted
    { "rawtransactions",    "combinerawtransaction",        &combinerawtransaction,     {"txs"} },                                              // not yet supportted
    { "rawtransactions",    "signrawtransactionwithkey",    &signrawtransactionwithkey, {"hexstring","privkeys","prevtxs","sighashtype"} },     // not yet supportted
    { "rawtransactions",    "testmempoolaccept",            &testmempoolaccept,         {"rawtxs","allowhighfees|maxfeerate"} },                // not yet supportted
    { "rawtransactions",    "decodepsbt",                   &decodepsbt,                {"psbt"} },                                             // not yet supportted
    { "rawtransactions",    "combinepsbt",                  &combinepsbt,               {"txs"} },                                              // not yet supportted
    { "rawtransactions",    "finalizepsbt",                 &finalizepsbt,              {"psbt", "extract"} },                                  // not yet supportted
    { "rawtransactions",    "createpsbt",                   &createpsbt,                {"inputs","outputs","locktime","replaceable"} },        // not yet supportted
    { "rawtransactions",    "converttopsbt",                &converttopsbt,             {"hexstring","permitsigdata","iswitness"} },            // not yet supportted
    { "rawtransactions",    "utxoupdatepsbt",               &utxoupdatepsbt,            {"psbt", "descriptors"} },                              // not yet supportted
    { "rawtransactions",    "joinpsbts",                    &joinpsbts,                 {"txs"} },                                              // not yet supportted
    { "rawtransactions",    "analyzepsbt",                  &analyzepsbt,               {"psbt"} },                                             // not yet supportted

    { "blockchain",         "gettxoutproof",                &gettxoutproof,             {"txids", "blockhash"} },                               // ok
    { "blockchain",         "verifytxoutproof",             &verifytxoutproof,          {"proof"} },                                            // ok
};
// clang-format on
