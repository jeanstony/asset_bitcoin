...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The VCcoin address to validate"},
                },
                RPCResult{
            "{\n"
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The VCcoin address to use for the signature."},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "control",            "getmemoryinfo",          &getmemoryinfo,          {"mode"} },                                  // ok
    { "control",            "logging",                &logging,                {"include", "exclude"}},                     // ok
    { "util",               "validateaddress",        &validateaddress,        {"address"} },                               // ok
    { "util",               "createmultisig",         &createmultisig,         {"nrequired","keys","address_type"} },       // ok
    { "util",               "deriveaddresses",        &deriveaddresses,        {"descriptor", "range"} },                   // ok
    { "util",               "getdescriptorinfo",      &getdescriptorinfo,      {"descriptor"} },                            // ok
    { "util",               "verifymessage",          &verifymessage,          {"address","signature","message"} },         // ok
    { "util",               "signmessagewithprivkey", &signmessagewithprivkey, {"privkey","message"} },                     // ok
