...
#ifndef VCCOIN_WALLET_WALLETDB_H
#define VCCOIN_WALLET_WALLETDB_H
...
public:
    explicit WalletBatch(WalletDatabase& database, const int AssetNo, const char* pszMode = "r+", bool _fFlushOnClose = true) : m_batch(database, AssetNo, pszMode, _fFlushOnClose),
                                                                                                                                m_database(database)
    {
    }
...
#endif // VCCOIN_WALLET_WALLETDB_H
