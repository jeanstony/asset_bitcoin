/* src/config/VCcoin-config.h.  Generated from VCcoin-config.h.in by configure.  */
/* src/config/VCcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VCCOIN_CONFIG_H

#define VCCOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Vccoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Vccoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/VCcoin/VCcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Vccoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Vccoin Core 0.18.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "VCcoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://VCcoincore.org/"
